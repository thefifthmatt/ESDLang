...
def t510770_x6():
    ...
    if not GetEventStatus(75100250):
        """State 11"""
        # talk:87000000:"Hark! They brought thee here, did they not?"
        ...
        if GetTalkListEntryResult() == 1:
            ...
            """State 7,13"""
            # talk:87000200:"Yes, yes, of course. How wouldst one such as thee do service to the gods?"
        ...
        if not GetEventStatus(75100251):
            """State 14"""
            # talk:87000300:"If it is the dark soul thou desirest..."
            ...
            if not GetEventStatus(75100252):
                ...
                """State 16"""
                # talk:87000500:"Now, yarely to Filianore's church at the base of the cliff, to rouse the sleeping Princess."
