...
def t380291_x7():
    ...
    Label('L1')
    # talk:29001520:" "
    assert t380291_x13(text3=29001520, z2=73800121, flag3=0, mode3=1)
    Goto('L0')
    """State 8"""
    Label('L2')
    # talk:29001620:" "
    assert t380291_x13(text3=29001620, z2=73800122, flag3=0, mode3=1)
    Goto('L0')
...
def t380291_x9():
    ...
    while True:
        """State 5"""
        call = t380291_x10(actionbutton1=6000, flag4=1355, flag5=6000, flag6=6000, flag7=6000, flag8=6000)
        if call.Done():
            """State 3"""
            call = t380291_x0()
            if call.Done():
...
def t380291_x10(actionbutton1=6000, flag4=1355, flag5=6000, flag6=6000, flag7=6000, flag8=6000):
    """State 0"""
    while True:
        """State 1"""
