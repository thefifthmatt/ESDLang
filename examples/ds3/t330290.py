...
def t330290_x0(actionbutton1=6000, flag4=1355, flag5=1357, flag6=6000, flag7=6000, flag8=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t330290_x16():
    ...
    Label('L1')
    # talk:29001500:" "
    assert t330290_x3(text3=29001500, z2=73300171, flag3=0, mode3=1)
    Goto('L0')
    """State 8"""
    Label('L2')
    # talk:29001600:" "
    assert t330290_x3(text3=29001600, z2=73300172, flag3=0, mode3=1)
    Goto('L0')
...
def t330290_x19():
    ...
    while True:
        """State 6"""
        Label('L0')
        call = t330290_x0(actionbutton1=6000, flag4=1355, flag5=1357, flag6=6000, flag7=6000, flag8=6000)
        if call.Done():
            """State 3"""
            call = t330290_x6()
            if call.Done():
