...
def t301020_x4(gesture1=1, z5=9007, flag3=6051):
    """State 0,1"""
...
def t301020_x6(goods1=375, val1=99, z2=18, z3=25, action5=13000020, action6=13000030, z1=12000000, action7=13000010,
               action8=13000000, lot2=4208, lot3=4207, flag2=73010952, flag3=6051, gesture1=1, z5=9007):
    """State 0,1,11"""
    ...
    """State 31"""
    Label('L5')
    assert t301020_x5(action4=action5)
    Goto('L2')
...
def t301020_x9(lot1=4200, goods1=375, lot2=4208, lot3=4207, action1=15000400, action2=15000410, action3=12000020,
               ...
               val1=99, z2=18, z3=25, flag1=6001, z4=73010951, flag2=73010952, flag3=6051, gesture1=1,
               z5=9007):
    """State 0,10"""
    ...
    assert GetCurrentStateElapsedTime() > 1
    """State 16"""
    assert t301020_x4(gesture1=gesture1, z5=z5, flag3=flag3)
    """State 17"""
...
def t301020_x11(lot1=4200, goods1=375, lot2=4208, lot3=4207, action1=15000400, action2=15000410, action3=12000020,
                ...
                action8=13000000, val1=99, z2=18, z3=25, flag1=6001, z4=73010951, flag2=73010952, actionbutton1=6010,
                flag3=6051, gesture1=1, z5=9007, flag4=73010953):
    """State 0"""
