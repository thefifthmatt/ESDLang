...
def t511001_x1():
    ...
    if CompareBonfireLevel(5, 0) == 1:
        ...
        """State 3,16"""
        call = t511001_x9(actionbutton1=6100, flag1=6001, flag2=6000)
        if call.Done():
            """State 7"""
    ...
    while True:
        """State 15"""
        call = t511001_x9(actionbutton1=6101, flag1=6001, flag2=6000)
        if call.Done():
            break
...
def t511001_x5():
    ...
    """State 21"""
    assert t511001_x8(gesture1=17, z1=9019, flag3=6067)
    """State 17"""
    MainBonfireMenuFlag()
    while True:
        """State 1"""
...
def t511001_x8(gesture1=17, z1=9019, flag3=6067):
    """State 0,1"""
...
def t511001_x9(actionbutton1=_, flag1=6001, flag2=6000):
    """State 0"""
    while True:
        """State 1"""
