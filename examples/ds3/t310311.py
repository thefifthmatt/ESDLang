...
def t310311_x0(actionbutton1=6000, flag10=1395, flag11=6000, flag12=6000, flag13=6000, flag14=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t310311_x7(gesture1=_, z5=_, flag6=_):
    """State 0,1"""
...
def t310311_x22(text1=31000700, text2=31000710, text3=31000740, z1=73100363, z2=73100364, z3=73100365,
    ...
    """State 9"""
    assert t310311_x7(gesture1=33, z5=9034, flag6=6083)
    """State 5"""
    SetEventState(z3, 1)
    """State 11"""
    return 0
...
def t310311_x23():
    ...
    if not GetEventStatus(73100366):
        ...
        """State 6"""
        assert t310311_x7(gesture1=32, z5=9033, flag6=6082)
    """State 7"""
    return 0
...
def t310311_x25():
    ...
    while True:
        """State 6"""
        call = t310311_x0(actionbutton1=6000, flag10=1395, flag11=6000, flag12=6000, flag13=6000, flag14=6000)
        if call.Done():
            """State 4"""
            call = t310311_x8()
            if call.Done():
