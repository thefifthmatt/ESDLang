...
def t510750_x18(text2=85000300, flag6=75000251, flag12=0, mode2=1):
    ...
    assert t510750_x16() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
    # talk:85000300:"One was a wayfaring knight, on an endless, forbidden search."
...
def t510750_x20():
    """State 0,1"""
    # talk:85000000:"Many of us are by the fire forsaken.", talk:85000300:"One was a wayfaring knight, on an endless, forbidden search."
