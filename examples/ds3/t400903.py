...
def t400903_x1(actionbutton1=6000, flag5=1121, flag6=6000, flag7=6000, flag8=6000, flag9=6000, flag10=6000,
...
def t400903_x15():
    ...
    """State 6"""
    Label('L2')
    call = t400903_x5(text5=90008000, z2=9001, flag3=0)
    if call.Done():
        Goto('L0')
    elif GetDistanceToPlayer() > 12:
        Goto('L1')
...
def t400903_x17():
    ...
    while True:
        """State 7"""
        call = t400903_x1(actionbutton1=6000, flag5=1121, flag6=6000, flag7=6000, flag8=6000, flag9=6000,
