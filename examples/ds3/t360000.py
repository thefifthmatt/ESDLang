...
def t360000_x1(gesture1=17, z1=9019, flag3=6067):
    """State 0,1"""
...
def t360000_x2(actionbutton1=_, flag1=6001, flag2=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t360000_x5():
    ...
    if CompareBonfireLevel(5, 0) == 1:
        ...
        """State 3,15"""
        call = t360000_x2(actionbutton1=6100, flag1=6001, flag2=6000)
        if call.Done():
            """State 7"""
            ...
            pass
    """State 14"""
    assert t360000_x2(actionbutton1=6101, flag1=6001, flag2=6000)
    """State 5"""
...
def t360000_x9():
    ...
    """State 21"""
    assert t360000_x1(gesture1=17, z1=9019, flag3=6067)
    """State 17"""
    MainBonfireMenuFlag()
    while True:
        """State 1"""
