...
def t340001_x2(actionbutton1=_, flag1=6001, flag2=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t340001_x5():
    ...
    if CompareBonfireLevel(5, 0) == 1:
        ...
        """State 3,13"""
        call = t340001_x2(actionbutton1=6100, flag1=6001, flag2=6000)
        if call.Done():
            """State 7"""
            ...
            pass
    """State 12"""
    assert t340001_x2(actionbutton1=6101, flag1=6001, flag2=6000)
    """State 5"""
