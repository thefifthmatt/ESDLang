...
def t330360_x0(actionbutton1=6000, flag2=1495, flag3=6000, flag4=6000, flag5=6000, flag6=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t330360_x16():
    ...
    while True:
        """State 5"""
        call = t330360_x0(actionbutton1=6000, flag2=1495, flag3=6000, flag4=6000, flag5=6000, flag6=6000)
        if call.Done():
            """State 3"""
            call = t330360_x5()
            if call.Done():
