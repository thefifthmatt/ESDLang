...
def t450590_x0(actionbutton1=6690, flag4=1795, flag5=6000, flag6=6000, flag7=6000, flag8=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t450590_x6():
    ...
    if not GetEventStatus(74500351):
        ...
        if not GetEventStatus(74500352):
            """State 4"""
            # talk:69000300:"Ahh, ahh, yes, of course."
            assert t450590_x4(text2=69000300, z2=74500352, flag2=0, mode2=1)
        else:
            """State 5"""
            # talk:69000400:"Quick! Go along, find one for yourself."
...
def t450590_x11():
    ...
    if GetEventStatus(74500381) == 1 and not GetEventStatus(74500353) and GetDistanceToPlayer() > 5.5:
        """State 3"""
        # talk:69000000:"My very own home, now..."
...
def t450590_x17(z1=-1):
    ...
    while True:
        """State 5"""
        call = t450590_x0(actionbutton1=6690, flag4=1795, flag5=6000, flag6=6000, flag7=6000, flag8=6000)
        if call.Done():
            """State 3"""
            call = t450590_x6()
            if call.Done():
