...
def t500760_x6():
    ...
    if not GetEventStatus(75000151):
        ...
        if not GetEventStatus(75000150):
            """State 14"""
            # talk:86000000:"Oh, your head's square on your shoulders, is it?"
            assert t500760_x5(text4=86000000, flag4=0, mode1=1)
        else:
            """State 8"""
            # talk:86000010:"I've nothing for you, not a smithereen. I just like to stand here, and take in the view."
        ...
        if GetTalkListEntryResult() == 1:
            """State 9"""
            # talk:86000100:"Well, that came out of nowhere."
            ...
            """State 13"""
            # talk:86000800:"Keep your marbles intact, love."
            assert t500760_x4(text5=86000800, z2=75000150, flag5=0, mode2=1)
        else:
            pass
    else:
        """State 12"""
        # talk:86000200:"Strange little lad, you are."
...
def t500760_x16():
    ...
    if GetEventStatus(75000154) == 1:
        """State 3"""
        # talk:86001000:"Don't run off and die, love."
...
def t500760_x20():
    ...
    if GetEventStatus(75000154) == 1:
        ...
        if not GetEventStatus(75000152):
            """State 5"""
            # talk:86000300:"At the close of the Age of Fire, all lands meet at the end of the earth."
            assert t500760_x4(text5=86000300, z2=75000152, flag5=0, mode2=1)
        else:
            """State 6"""
            # talk:86000400:"Oh, if you just can't stop yourself, at least hear this."
