...
def t450530_x0(actionbutton1=6630, flag4=1675, flag5=6000, flag6=6000, flag7=6000, flag8=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t450530_x4(text2=63000000, z2=74500150, flag2=0, mode2=1):
    ...
    assert t450530_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
    # talk:63000000:"I believe...I feel the scent of ash upon thee."
    ...
    if GetEventStatus(74500181) == 1:
        ...
        if not GetEventStatus(74500150):
            ...
            if not GetEventStatus(74500152):
                """State 10"""
                # talk:63000100:"Tis good. When this is done, may I return."
                assert t450530_x5(text1=63000100, flag1=0, mode1=1)
                """State 7"""
                SetEventState(74500152, 1)
            else:
                """State 11"""
                # talk:63000200:"Tis good. I'll head off to paint."
...
def t450530_x16(z1=-1):
    ...
    while True:
        """State 5"""
        call = t450530_x0(actionbutton1=6630, flag4=1675, flag5=6000, flag6=6000, flag7=6000, flag8=6000)
        if call.Done():
            """State 3"""
            call = t450530_x6()
            if call.Done():
