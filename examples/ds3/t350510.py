...
def t350510_x5():
    ...
    if not GetEventStatus(73500302):
        ...
        if GetEventStatus(73500305) == 1:
            """State 20"""
            # talk:61001200:"Dear me, why would you do such a thing?"
            assert t350510_x4(text1=61001200, flag1=0, mode1=1)
        else:
            """State 19"""
            # talk:61000100:"Wait, you've..."
        ...
        if not GetEventStatus(73500303):
            ...
            if GetEventStatus(73500305) == 1:
                """State 22"""
                # talk:61001300:"Dear me, why would you do such a thing?"
                assert t350510_x4(text1=61001300, flag1=0, mode1=1)
            else:
                """State 21"""
                # talk:61000200:"Ohh, ohh...don't mind me, didn't mean to fall apart."
                assert t350510_x4(text1=61000200, flag1=0, mode1=1)
        else:
            """State 16"""
            if GetEventStatus(73500305) == 1:
                """State 24"""
                # talk:61001400:"Dear me, why would you do such a thing?"
                assert t350510_x4(text1=61001400, flag1=0, mode1=1)
            else:
                """State 23"""
                # talk:61000500:"Ahh, you again, I knew it."
        ...
        if GetTalkListEntryResult() == 1:
            ...
            """State 9,25"""
            # talk:61000400:"Oh. Are you certain of that?"
...
def t350510_x10():
    ...
    if GetEventStatus(73500305) == 1:
        """State 3"""
        # talk:61001500:"Fire for Ariandel... Fire for Ariandel..."
        assert t350510_x4(text1=61001500, flag1=0, mode1=1)
    else:
        """State 2"""
        # talk:61000000:"Ahh, merciful goddess, mother of the Forlorn, who have no place to call their own..."
...
def t350510_x17():
    ...
    if not GetEventStatus(73500302):
        """State 2"""
        # talk:61001000:"Ahh, fire for Ariandel..."
        assert t350510_x4(text1=61001000, flag1=0, mode1=1)
    else:
        """State 3"""
        # talk:61001100:"If you truly are Ash, you will seek fire..."
