...
def t400904_x0(actionbutton1=6000, flag4=1140, flag5=6000, flag6=6000, flag7=6000, flag8=6000, flag9=6000,
...
def t400904_x11():
    ...
    """State 6"""
    Label('L2')
    call = t400904_x4(text2=90009000, z1=74009100, flag2=0)
    if call.Done():
        Goto('L0')
    elif GetDistanceToPlayer() > 12:
        Goto('L1')
...
def t400904_x12():
    ...
    while True:
        """State 7"""
        call = t400904_x0(actionbutton1=6000, flag4=1140, flag5=6000, flag6=6000, flag7=6000, flag8=6000,
