...
def t370401_x0(actionbutton1=6000, flag3=1575, flag4=6000, flag5=6000, flag6=6000, flag7=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t370401_x15():
    ...
    while True:
        """State 6"""
        call = t370401_x0(actionbutton1=6000, flag3=1575, flag4=6000, flag5=6000, flag6=6000, flag7=6000)
        if call.Done():
            """State 4"""
            call = t370401_x5()
            if call.Done():
