...
def t400905_x0(actionbutton1=6000, flag4=1160, flag5=6000, flag6=6000, flag7=6000, flag8=6000, flag9=6000,
...
def t400905_x12():
    ...
    """State 9"""
    Label('L2')
    call = t400905_x4(text2=90010000, z1=74009060, flag2=0)
    if call.Done():
        Goto('L0')
    elif GetDistanceToPlayer() > 12:
        Goto('L1')
...
def t400905_x13():
    ...
    while True:
        """State 7"""
        call = t400905_x0(actionbutton1=6000, flag4=1160, flag5=6000, flag6=6000, flag7=6000, flag8=6000,
