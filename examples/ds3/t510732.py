...
def t510732_x9(flag1=75100220, flag2=75100221, z1=75100221, z2=75100221, flag3=1810):
    ...
    while True:
        """State 5"""
        call = t510732_x20(actionbutton1=6830, flag9=1815, flag10=6000, flag11=6000, flag12=6000, flag13=6000)
        if call.Done():
            """State 3"""
...
def t510732_x14():
    ...
    if not GetEventStatus(75000100):
        ...
        assert t510732_x24(text4=83000000, z5=75000100, flag7=0, mode2=1)
    else:
        """State 2"""
        if not GetEventStatus(75000101):
            """State 4"""
            # talk:83000100:"Ohh, in all honesty there's something I should tell you..."
            assert t510732_x24(text4=83000100, z5=75000101, flag7=0, mode2=1)
        else:
            """State 5"""
...
def t510732_x15():
    ...
    if GetEventStatus(15000703) == 1:
        ...
        if not GetEventStatus(50006621):
            ...
            assert t510732_x24(text4=83000700, z5=75000104, flag7=0, mode2=1)
            """State 16"""
        ...
        if GetEventStatus(55000450) == 1:
            ...
            assert t510732_x24(text4=83000650, z5=75000104, flag7=0, mode2=1)
        else:
            """State 3"""
            if not GetEventStatus(75000102):
                """State 8"""
                # talk:83000300:"Oh, I know who you are."
                assert t510732_x24(text4=83000300, z5=75000102, flag7=0, mode2=1)
            else:
                """State 4"""
                if not GetEventStatus(75000103):
                    """State 9"""
                    # talk:83000400:"Ah, don't mind me. You needn't worry yourself with this nonsense."
                    assert t510732_x24(text4=83000400, z5=75000103, flag7=0, mode2=1)
                else:
                    """State 10"""
...
def t510732_x16():
    ...
    if not GetEventStatus(50006622):
        ...
        assert t510732_x24(text4=83000970, z5=75100200, flag7=1, mode2=1)
        """State 11"""
        assert t510732_x27(gesture1=33, z3=9034, flag4=6083)
    else:
        """State 2"""
        if not GetEventStatus(75100200):
            ...
            if not GetEventStatus(75100201):
                ...
                assert t510732_x24(text4=83001000, z5=75100201, flag7=0, mode2=1)
            else:
                """State 9"""
...
def t510732_x18():
    ...
    if DoesSelfHaveSpEffect(159) == 1:
        """State 5"""
        assert t510732_x27(gesture1=27, z3=9028, flag4=6077)
    else:
        pass
    """State 1"""
    if not GetEventStatus(75100207):
        ...
        assert t510732_x24(text4=83001900, z5=75100207, flag7=0, mode2=1)
    else:
        """State 4"""
...
def t510732_x19(text1=_, z4=_):
    ...
    if GetTalkListEntryResult() == 1:
        ...
        assert t510732_x24(text4=83001600, z5=75100205, flag7=0, mode2=1)
        """State 5"""
        Label('L0')
        SetEventState(z4, 1)
...
def t510732_x20(actionbutton1=6830, flag9=1815, flag10=6000, flag11=6000, flag12=6000, flag13=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t510732_x24(text4=_, z5=_, flag7=_, mode2=1):
    """State 0,5"""
    assert t510732_x22() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
...
def t510732_x27(gesture1=_, z3=_, flag4=_):
    """State 0,1"""
