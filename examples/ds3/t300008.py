...
def t300008_x2(actionbutton2=6101, flag3=6001, flag4=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t300008_x4(actionbutton1=6100, flag1=6001, flag2=6000):
    """State 0"""
    while True:
        """State 1"""
        assert (not GetOneLineHelpStatus() and not IsTalkingToSomeoneElse() and not IsClientPlayer()
...
def t300008_x6():
    ...
    if CompareBonfireLevel(5, 0) == 1:
        ...
        """State 3,12"""
        call = t300008_x4(actionbutton1=6100, flag1=6001, flag2=6000)
        if call.Done():
            """State 7"""
            ...
            pass
    """State 11"""
    assert t300008_x2(actionbutton2=6101, flag3=6001, flag4=6000)
    """State 5"""
