...
def t450520_x0(actionbutton1=6000, flag2=1655, flag3=6000, flag4=6000, flag5=6000, flag6=6000):
    """State 0"""
    while True:
        """State 1"""
    ...
    if GetEventStatus(74500251) == 1:
        ...
        if not GetEventStatus(74500101):
            ...
            if (((GetEventStatus(1041) == 1 and GetEventStatus(1055) == 1) or GetEventStatus(1042) ==
                ...
                """State 11"""
                # talk:62000600:"Lady Friede has spoken, has she not?"
                assert t450520_x3(text1=62000600, flag1=0, mode1=1)
            else:
                """State 12"""
                # talk:62000200:"Lady Friede has spoken, has she not?"
            ...
            """State 13"""
            # talk:62000300:"There is one thing you should know."
        ...
        if not GetEventStatus(74500100):
            ...
            """State 10"""
            # talk:62000100:"What's keeping you? Go on, right inside."
...
def t450520_x13():
    ...
    if (((GetEventStatus(1041) == 1 and GetEventStatus(1055) == 1) or GetEventStatus(1042) == 1 or GetEventStatus(1045)
        ...
        """State 1,5"""
        # talk:62000700:"Why you miserable, mad Hollow."
        assert t450520_x3(text1=62000700, flag1=0, mode1=1)
    else:
        """State 3,6"""
        # talk:62000400:"Why you miserable, mad Hollow."
...
def t450520_x14(z1=-1):
    ...
    while True:
        """State 5"""
        call = t450520_x0(actionbutton1=6000, flag2=1655, flag3=6000, flag4=6000, flag5=6000, flag6=6000)
        if call.Done():
            """State 3"""
            call = t450520_x4()
            if call.Done():
...
def t450520_x15():
    """State 0,1"""
    # talk:62001100:"Forgive me, my Lady..."
