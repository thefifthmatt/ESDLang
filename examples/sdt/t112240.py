...
def t112240_1001():
    ...
    assert t112240_x4(text1=24260200, flag14=1, mode11=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()
...
def t112240_1102():
    ...
    while True:
        ...
        if f120() - f121() == 1 and not GetEventStatus(71120205):
            ...
            call = t112240_x3(text2=24260000, z2=71120200, flag15=1, mode12=1)
            if call.Done():
                continue
            ...
            """State 5,9"""
            # talk:24260600:"   "
            call = t112240_x3(text2=24260600, z2=71120213, flag15=1, mode12=1)
            if call.Done():
                continue
                ...
                Label('L0')
                # talk:24260300:"Do it!"
                assert t112240_x3(text2=24260300, z2=71120210, flag15=1, mode12=1)
                continue
        elif DoesSelfHaveSpEffect(30009) == 1:
            """State 6"""
            Goto('L0')
        ...
        """State 8"""
        # talk:24260100:"   "
        assert t112240_x3(text2=24260100, z2=71120205, flag15=1, mode12=1)
    """Unused"""
    """State 1"""
    def WhilePaused():
        c1_119(0)
...
def t112240_1103():
    """State 0,2"""
    # talk:24260700:"   "
    assert t112240_x4(text1=24260700, flag14=1, mode11=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()
...
def t112240_x0(actionbutton1=-1, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000, actionbutton2=0,
               flag5=6000, val6=1000000, val7=1000000, val8=1000000, val9=1000000, val10=1000000):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t112240_x26(actionbutton1=actionbutton1, flag6=flag6, flag10=flag10, flag11=flag11, flag12=flag12,
...
def t112240_x3(text2=_, z2=_, flag15=1, mode12=1):
    """State 0,7"""
...
def t112240_x4(text1=_, flag14=1, mode11=1):
    """State 0,6"""
    assert t112240_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag14:
...
def t112240_x5(flag1=1299, flag2=11125861, flag3=6000, val1=5, val2=60, val3=65, val4=60, val5=65, flag4=6001,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t112240_x6(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag4=flag4, actionbutton1=actionbutton1,
...
def t112240_x6(val1=5, val2=60, val3=65, val4=60, val5=65, flag4=6001, actionbutton1=-1, flag5=6000,
    ...
    while True:
        """State 4"""
        call = t112240_x23(actionbutton1=actionbutton1, flag5=flag5, flag6=flag6, val6=val6, val7=val7,
...
def t112240_x15():
    """State 0,1"""
    assert t112240_x17(z1=1101, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t112240_x16(mode2=1, mode4=0):
    ...
    if f116(10000) == 1:
        ...
        assert t112240_x17(z1=1000, mode7=0, mode8=0, mode9=0, mode10=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t112240_x17(z1=_, mode7=0, mode8=0, mode9=0, mode10=0):
    """State 0,4"""
    if f118(z1) == 1:
        """State 2"""
...
def t112240_x18():
    """State 0,1"""
    call = t112240_x17(z1=1103, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert t112240_x1()
    elif call.Get() == 0:
...
def t112240_x19():
    """State 0,2"""
    call = t112240_x17(z1=1102, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t112240_x20():
    """State 0,1"""
    assert t112240_x17(z1=1001, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t112240_x22():
    """State 0,1"""
    assert t112240_x17(z1=1100, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t112240_x23(actionbutton1=-1, flag5=6000, flag6=6001, val6=1000000, val7=1000000, val8=1000000, val9=1000000,
                val10=1000000):
    """State 0,1"""
    call = t112240_x17(z1=2000, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert (t112240_x0(actionbutton1=actionbutton1, flag6=flag6, flag10=6000, flag11=6000, flag12=6000,
...
def t112240_x25():
    """State 0,1"""
    assert t112240_x17(z1=1002, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t112240_x26(actionbutton1=-1, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000, actionbutton2=0,
                flag5=6000):
    """State 0"""
    while Loop('mainloop'):
        """State 1"""
