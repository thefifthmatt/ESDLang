...
def t100180_1():
    ...
    t100180_x7(flag5=1199, flag6=1195, flag7=1196, val1=5, val2=10, val3=12, val4=10, val5=12, flag8=6001,
               actionbutton1=7001801, flag9=6000, flag10=6001, flag11=6000, flag12=6000, mode1=1, val6=1000000,
...
def t100180_1000():
    ...
    if not GetEventStatus(71000200):
        ...
        assert t100180_x4(text6=18100000, z2=71000200, flag19=0, mode12=1)
        """State 7"""
        assert t100180_x6(lot1=61800)
    else:
        """State 3,6"""
        # talk:18100100:"Listen... without a Snap Seed, you cannot overcome that illusion technique."
        assert t100180_x5(text5=18100100, flag18=0, mode11=1)
    """State 4"""
    def WhilePaused():
        c1_119(0)
    Quit()
...
def t100180_1103():
    ...
    assert t100180_x5(text5=18030000, flag18=1, mode11=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()

def t100180_x0(actionbutton1=7001801, flag10=6001, flag14=6000, flag15=6000, flag16=6000, flag17=6000,
               actionbutton2=0, flag9=6000, val6=1000000, val7=1000000, val8=1000000, val9=1000000, val10=1000000):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t100180_x28(actionbutton1=actionbutton1, flag10=flag10, flag14=flag14, flag15=flag15,
...
def t100180_x3(text1=_, flag1=_, flag20=1, mode13=1):
    """State 0,7"""
...
def t100180_x4(text6=18100000, z2=71000200, flag19=0, mode12=1):
    """State 0,7"""
    assert t100180_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 5"""
    if not flag19:
...
def t100180_x5(text5=_, flag18=_, mode11=1):
    """State 0,6"""
    assert t100180_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag18:
...
def t100180_x7(flag5=1199, flag6=1195, flag7=1196, val1=5, val2=10, val3=12, val4=10, val5=12, flag8=6001,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t100180_x8(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag8=flag8, actionbutton1=actionbutton1,
...
def t100180_x8(val1=5, val2=10, val3=12, val4=10, val5=12, flag8=6001, actionbutton1=7001801, flag9=6000,
    ...
    while True:
        """State 4"""
        call = t100180_x25(actionbutton1=actionbutton1, flag9=flag9, flag10=flag10, val6=val6, val7=val7,
...
def t100180_x17():
    """State 0,1"""
    assert t100180_x19(z1=1101, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t100180_x18(mode2=1, mode4=0):
    ...
    if f116(10000) == 1:
        ...
        assert t100180_x19(z1=1000, mode7=0, mode8=0, mode9=0, mode10=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t100180_x19(z1=_, mode7=0, mode8=0, mode9=0, mode10=0):
    """State 0,4"""
    if f118(z1) == 1:
        """State 2"""
...
def t100180_x20():
    """State 0,1"""
    call = t100180_x19(z1=1103, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert t100180_x1()
    elif call.Get() == 0:
...
def t100180_x21():
    """State 0,2"""
    call = t100180_x19(z1=1102, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t100180_x22():
    """State 0,1"""
    assert t100180_x19(z1=1001, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t100180_x24():
    """State 0,1"""
    assert t100180_x19(z1=1100, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t100180_x25(actionbutton1=7001801, flag9=6000, flag10=6001, val6=1000000, val7=1000000, val8=1000000,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t100180_x19(z1=2000, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert (t100180_x0(actionbutton1=actionbutton1, flag10=flag10, flag14=6000, flag15=6000, flag16=6000,
...
def t100180_x27():
    """State 0,1"""
    assert t100180_x19(z1=1002, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t100180_x28(actionbutton1=7001801, flag10=6001, flag14=6000, flag15=6000, flag16=6000, flag17=6000,
...
def t100180_x29(text1=18030100, flag1=71000246, text2=18030200, flag2=71000247, text3=-1, flag3=71000248,
    ...
    if not text1 == -1 and not GetEventStatus(flag1):
        """State 4"""
        assert t100180_x3(text1=text1, flag1=flag1, flag20=1, mode13=1)
    elif not text2 == -1 and not GetEventStatus(flag2):
        """State 5"""
        assert t100180_x3(text1=text2, flag1=flag2, flag20=1, mode13=1)
    elif not text3 == -1 and not GetEventStatus(flag3):
        """State 6"""
        assert t100180_x3(text1=text3, flag1=flag3, flag20=1, mode13=1)
    else:
        """State 7"""
        assert t100180_x3(text1=text4, flag1=flag4, flag20=1, mode13=1)
    """State 8"""
    return 0
