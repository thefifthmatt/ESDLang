...
def t150280_1():
    ...
    t150280_x7(flag5=1419, flag6=1415, flag7=1416, val1=5, val2=10, val3=12, val4=10, val5=12, flag8=6001,
               actionbutton1=7002800, flag9=6000, flag10=6001, flag11=6000, flag12=6000, mode1=1, val6=1000000,
...
def t150280_1103():
    ...
    assert t150280_x5(text5=28030400, flag18=1, mode11=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()

def t150280_x0(actionbutton1=7002800, flag10=6001, flag14=6000, flag15=6000, flag16=6000, flag17=6000,
               actionbutton2=0, flag9=6000, val6=1000000, val7=1000000, val8=1000000, val9=1000000, val10=1000000):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t150280_x28(actionbutton1=actionbutton1, flag10=flag10, flag14=flag14, flag15=flag15,
...
def t150280_x3(text1=_, flag1=_, flag20=1, mode13=1):
    """State 0,7"""
...
def t150280_x4(text6=_, z2=_, flag19=0, mode12=1):
    """State 0,7"""
    assert t150280_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 5"""
    if not flag19:
...
def t150280_x5(text5=_, flag18=_, mode11=1):
    """State 0,6"""
    assert t150280_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag18:
...
def t150280_x7(flag5=1419, flag6=1415, flag7=1416, val1=5, val2=10, val3=12, val4=10, val5=12, flag8=6001,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t150280_x8(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag8=flag8, actionbutton1=actionbutton1,
...
def t150280_x8(val1=5, val2=10, val3=12, val4=10, val5=12, flag8=6001, actionbutton1=7002800, flag9=6000,
    ...
    while True:
        """State 4"""
        call = t150280_x25(actionbutton1=actionbutton1, flag9=flag9, flag10=flag10, val6=val6, val7=val7,
...
def t150280_x17():
    """State 0,1"""
    assert t150280_x19(z1=1101, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t150280_x18(mode2=0, mode4=0):
    ...
    if f116(10000) == 1:
        ...
        assert t150280_x19(z1=1000, mode7=0, mode8=0, mode9=0, mode10=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t150280_x19(z1=_, mode7=0, mode8=0, mode9=0, mode10=0):
    """State 0,4"""
    if f118(z1) == 1:
        """State 2"""
...
def t150280_x20():
    """State 0,1"""
    call = t150280_x19(z1=1103, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert t150280_x1()
    elif call.Get() == 0:
...
def t150280_x21():
    """State 0,2"""
    call = t150280_x19(z1=1102, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t150280_x22():
    """State 0,1"""
    assert t150280_x19(z1=1001, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t150280_x24():
    """State 0,1"""
    assert t150280_x19(z1=1100, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t150280_x25(actionbutton1=7002800, flag9=6000, flag10=6001, val6=1000000, val7=1000000, val8=1000000,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t150280_x19(z1=2000, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert (t150280_x0(actionbutton1=actionbutton1, flag10=flag10, flag14=6000, flag15=6000, flag16=6000,
...
def t150280_x27():
    """State 0,1"""
    assert t150280_x19(z1=1002, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t150280_x28(actionbutton1=7002800, flag10=6001, flag14=6000, flag15=6000, flag16=6000, flag17=6000,
...
def t150280_x29(text1=28030000, flag1=71500146, text2=28030100, flag2=71500147, text3=28030200, flag3=71500148,
    ...
    if not text1 == -1 and not GetEventStatus(flag1):
        """State 4"""
        assert t150280_x3(text1=text1, flag1=flag1, flag20=1, mode13=1)
    elif not text2 == -1 and not GetEventStatus(flag2):
        """State 5"""
        assert t150280_x3(text1=text2, flag1=flag2, flag20=1, mode13=1)
    elif not text3 == -1 and not GetEventStatus(flag3):
        """State 6"""
        assert t150280_x3(text1=text3, flag1=flag3, flag20=1, mode13=1)
    else:
        """State 7"""
        assert t150280_x3(text1=text4, flag1=flag4, flag20=1, mode13=1)
    """State 8"""
    return 0
...
def t150280_x30(goods1=9070):
    ...
    if GetEventStatus(71500113) == 1:
        ...
        if GetEventStatus(50006280) == 1:
            ...
            assert t150280_x4(text6=28010250, z2=71500102, flag19=0, mode12=1)
            """State 29"""
            ...
            # talk:28010200:"Hello..."
            def WhilePaused():
                c5_120(GetCurrentStateElapsedTime() > 1, 1, 0, 9, 9, 9, 9, 9, 9, 9)
            assert t150280_x5(text5=28010200, flag18=0, mode11=1)
            """State 43"""
            def WhilePaused():
                c1_120(1, 0, 9, 9, 9, 9, 9, 9, 9)
        ...
        assert t150280_x5(text5=28010300, flag18=0, mode11=1)
        """State 30"""
        ...
        def WhilePaused():
            c1_120(1, 9, 9, 9, 9, 9, 9, 9, 9)
        assert t150280_x4(text6=28010000, z2=71500100, flag19=0, mode12=1)
        """State 12"""
        ...
        def WhilePaused():
            c1_120(1, 9, 9, 9, 9, 9, 9, 9, 9)
        assert t150280_x5(text5=28010100, flag18=0, mode11=1)
        """State 11"""
        ...
        if not GetEventStatus(71500100):
            ...
            def WhilePaused():
                c1_120(1, 9, 9, 9, 9, 9, 9, 9, 9)
            assert t150280_x5(text5=28000700, flag18=0, mode11=1)
            """State 3"""
            ClearTalkListData()
            """State 4"""
            ...
            if not GetEventStatus(71500101):
                ...
                def WhilePaused():
                    c1_120(1, 9, 9, 9, 9, 9, 9, 9, 9)
                assert t150280_x4(text6=28000800, z2=71500101, flag19=0, mode12=1)
            else:
                """State 15"""
                if not GetEventStatus(71500102):
                    ...
                    if ComparePlayerInventoryNumber(3, goods1, 4, 1, 0) == 1:
                        ...
                        def WhilePaused():
                            c1_120(1, 9, 9, 9, 9, 9, 9, 9, 9)
                        assert t150280_x5(text5=28001000, flag18=0, mode11=1)
                        """State 19"""
                        ClearTalkListData()
                        """State 20"""
                        ...
                        def WhilePaused():
                            c1_120(1, 9, 9, 9, 9, 9, 9, 9, 9)
                        assert t150280_x5(text5=28000900, flag18=0, mode11=1)
                else:
                    """State 44"""
                    # talk:28001100:"(Gulping)"
                    assert t150280_x5(text5=28001100, flag18=0, mode11=1)
    """State 45"""
    return 0
    """Unused"""
    """State 33"""
