...
def t110240_1():
    ...
    t110240_x6(flag1=1679, flag2=1675, flag3=1676, val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001,
               actionbutton1=7002400, flag5=6000, flag6=6001, flag7=6000, flag8=6000, mode2=1, val6=1000000,
               val7=1543090, val8=1000000, mode3=1, mode4=1, mode5=0, val9=1000000, val10=1000000, mode6=0,
               flag9=6000, mode7=0)
    Quit()
    ...
    if call.Get() == 1:
        ...
        if not GetEventStatus(71100501):
            ...
            if not GetEventStatus(71100500):
                ...
                assert t110240_x4(text1=24100000, flag14=0, mode12=1)
            else:
                """State 5,19"""
                # talk:24100100:"What'll it be, Sekiro?"
                assert t110240_x4(text1=24100100, flag14=0, mode12=1)
            """State 17"""
            ...
            if not GetEventStatus(71100509):
                ...
                assert t110240_x4(text1=24110052, flag14=0, mode12=1)
            else:
                """State 7"""
                if not GetEventStatus(71100505):
                    ...
                    if not GetEventStatus(50006244):
                        ...
                        assert t110240_x4(text1=24100200, flag14=0, mode12=1)
                        """State 22"""
                    ...
                    assert t110240_x3(text2=24100250, z2=71100505, flag15=0, mode13=1)
                else:
                    """State 9,23"""
                    # talk:24100300:"About the ways of the Ashina blade..."
                    assert t110240_x4(text1=24100300, flag14=0, mode12=1)
    elif call.Done():
        """State 14"""
        pass
    """State 1"""
...
def t110240_2000():
    """State 0,2"""
    assert (t110240_x0(actionbutton1=7002401, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
            actionbutton2=0, flag5=6000, val6=1000000, val7=1543090, val8=-1, val9=-1, val10=-1))
    """State 3"""
    assert t110240_x29()
    """State 1"""
    def WhilePaused():
...
def t110240_x0(actionbutton1=_, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000, actionbutton2=0,
               flag5=6000, val6=1000000, val7=1543090, val8=_, val9=_, val10=_):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t110240_x27(actionbutton1=actionbutton1, flag6=flag6, flag10=flag10, flag11=flag11, flag12=flag12,
...
def t110240_x3(text2=_, z2=_, flag15=0, mode13=1):
    """State 0,7"""
...
def t110240_x4(text1=_, flag14=0, mode12=1):
    """State 0,6"""
    assert t110240_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag14:
...
def t110240_x6(flag1=1679, flag2=1675, flag3=1676, val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t110240_x7(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag4=flag4, actionbutton1=actionbutton1,
...
def t110240_x7(val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001, actionbutton1=7002400, flag5=6000,
               flag6=6001, flag7=6000, flag8=6000, mode2=1, val6=1000000, val7=1543090, val8=1000000,
               mode3=1, mode4=1, mode5=0, val9=1000000, val10=1000000, mode6=0, mode7=0):
    """State 0"""
    while True:
        """State 4"""
        call = t110240_x24(actionbutton1=actionbutton1, flag5=flag5, flag6=flag6, val6=val6, val7=val7,
...
def t110240_x16():
    """State 0,1"""
    assert t110240_x18(z1=1101, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0
...
def t110240_x17(mode3=1, mode5=0):
    ...
    if f116(10000) == 1:
        ...
        assert t110240_x18(z1=1000, mode8=0, mode9=0, mode10=0, mode11=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t110240_x18(z1=_, mode8=0, mode9=0, mode10=0, mode11=0):
    """State 0,4"""
    if f118(z1) == 1:
        """State 2"""
...
def t110240_x19():
    """State 0,1"""
    call = t110240_x18(z1=1103, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """State 2"""
        assert t110240_x1()
    elif call.Get() == 0:
...
def t110240_x20():
    """State 0,2"""
    call = t110240_x18(z1=1102, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t110240_x21():
    """State 0,1"""
    assert t110240_x18(z1=1001, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0
...
def t110240_x23():
    """State 0,1"""
    assert t110240_x18(z1=1100, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0

def t110240_x24(actionbutton1=7002400, flag5=6000, flag6=6001, val6=1000000, val7=1543090, val8=1000000,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t110240_x18(z1=2000, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """State 2"""
        assert (t110240_x0(actionbutton1=actionbutton1, flag6=flag6, flag10=6000, flag11=6000, flag12=6000,
...
def t110240_x26():
    """State 0,1"""
    assert t110240_x18(z1=1002, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0

def t110240_x27(actionbutton1=_, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000, actionbutton2=0,
                flag5=6000):
    """State 0"""
    while Loop('mainloop'):
        """State 1"""
...
def t110240_x28(mode1=_):
    ...
    if not mode1 == 1:
        ...
        if GetTalkListEntryResult() == 2:
            ...
            """State 19"""
            # talk:24110100:"No."
            assert t110240_x3(text2=24110100, z2=71100500, flag15=0, mode13=1)
            ...
            if not GetEventStatus(50006242):
                ...
                assert t110240_x4(text1=24110000, flag14=0, mode12=1)
                """State 18"""
            ...
            assert t110240_x3(text2=24110050, z2=71100501, flag15=0, mode13=1)
