...
def t100170_1():
    ...
    t100170_x6(flag1=1239, flag2=1235, flag3=1236, val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001,
               actionbutton1=7001701, flag5=6000, flag6=6001, flag7=6000, flag8=6000, mode1=1, val6=1000000,
...
def t100170_1000():
    ...
    if not GetEventStatus(71000150):
        ...
        assert t100170_x4(text5=17100200, z2=71000150, flag18=0, mode12=1)
    else:
        """State 3,7"""
        # talk:17100300:"Hey, good sir. Keep your eyes peeled out there."
        assert t100170_x5(text4=17100300, flag17=0, mode11=1)
    """State 4"""
    def WhilePaused():
        c1_119(0)
    Quit()
...
def t100170_1001():
    ...
    assert t100170_x5(text4=17130100, flag17=1, mode11=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()
...
def t100170_1102():
    ...
    if not GetEventStatus(71000198):
        ...
        assert t100170_x3(text1=17130000, flag14=71000198, flag19=1, mode13=1)
        """State 1"""
        def WhilePaused():
            c1_119(0)
        Quit()
...
def t100170_1103():
    ...
    assert t100170_x5(text4=17130200, flag17=1, mode11=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()
...
def t100170_2000():
    """State 0,4"""
    call = t100170_x0(actionbutton1=7001701, flag6=6001, flag10=6001, flag11=6001, flag12=6001, flag13=6001,
...
def t100170_x0(actionbutton1=7001701, flag6=6001, flag10=_, flag11=_, flag12=_, flag13=_, actionbutton2=0,
               flag5=6000, val6=1000000, val7=1000000, val8=1000000, val9=1000000, val10=1000000):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t100170_x28(actionbutton1=actionbutton1, flag6=flag6, flag10=flag10, flag11=flag11, flag12=flag12,
...
def t100170_x3(text1=_, flag14=_, flag19=1, mode13=1):
    """State 0,7"""
...
def t100170_x4(text5=17100200, z2=71000150, flag18=0, mode12=1):
    """State 0,7"""
    assert t100170_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 5"""
    if not flag18:
...
def t100170_x5(text4=_, flag17=_, mode11=1):
    """State 0,6"""
    assert t100170_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag17:
...
def t100170_x6(flag1=1239, flag2=1235, flag3=1236, val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t100170_x7(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag4=flag4, actionbutton1=actionbutton1,
...
def t100170_x7(val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001, actionbutton1=7001701, flag5=6000,
    ...
    while True:
        """State 4"""
        call = t100170_x24(actionbutton1=actionbutton1, flag5=flag5, flag6=flag6, val6=val6, val7=val7,
...
def t100170_x16():
    """State 0,1"""
    assert t100170_x18(z1=1101, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t100170_x17(mode2=1, mode4=0):
    ...
    if f116(10000) == 1:
        ...
        assert t100170_x18(z1=1000, mode7=0, mode8=0, mode9=0, mode10=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t100170_x18(z1=_, mode7=0, mode8=0, mode9=0, mode10=0):
    """State 0,4"""
    if f118(z1) == 1:
        """State 2"""
...
def t100170_x19():
    """State 0,1"""
    call = t100170_x18(z1=1103, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert t100170_x1()
    elif call.Get() == 0:
...
def t100170_x20():
    """State 0,2"""
    call = t100170_x18(z1=1102, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t100170_x21():
    """State 0,1"""
    assert t100170_x18(z1=1001, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t100170_x23():
    """State 0,1"""
    assert t100170_x18(z1=1100, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t100170_x24(actionbutton1=7001701, flag5=6000, flag6=6001, val6=1000000, val7=1000000, val8=1000000,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t100170_x18(z1=2000, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert (t100170_x0(actionbutton1=actionbutton1, flag6=flag6, flag10=6000, flag11=6000, flag12=6000,
...
def t100170_x25(text1=17030800, flag14=71000195, text2=17030900, flag15=71000196, text3=17031000, flag16=71000197,
    ...
    if not text1 == -1 and not GetEventStatus(flag14):
        """State 3"""
        assert t100170_x3(text1=text1, flag14=flag14, flag19=1, mode13=1)
    elif not text2 == -1 and not GetEventStatus(flag15):
        """State 4"""
        assert t100170_x3(text1=text2, flag14=flag15, flag19=1, mode13=1)
    elif not text3 == -1 and not GetEventStatus(flag16):
        """State 5"""
        assert t100170_x3(text1=text3, flag14=flag16, flag19=1, mode13=1)
    else:
        """State 2"""
        ...
        """State 6"""
        assert t100170_x5(text4=text4, flag17=1, mode11=1)
    """State 7"""
    return 0
...
def t100170_x27():
    """State 0,1"""
    assert t100170_x18(z1=1002, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t100170_x28(actionbutton1=7001701, flag6=6001, flag10=_, flag11=_, flag12=_, flag13=_, actionbutton2=0,
                flag5=6000):
    """State 0"""
    while Loop('mainloop'):
        """State 1"""
