...
def t250250_1():
    ...
    t250250_x7(flag1=1619, flag2=1615, flag3=1616, val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001,
               actionbutton1=7002500, flag5=1616, flag6=6001, flag7=6000, flag8=6000, mode1=1, val6=1000000,
...
def t250250_1001():
    ...
    if GetEventStatus(1600) == 1:
        ...
        assert t250250_x5(text4=25030500, flag17=1, mode11=1)
    else:
        """State 4"""
        assert t250250_x1()
    """State 1"""
...
def t250250_1102():
    ...
    """State 3,4"""
    # talk:25030400:"Ungh...!"
    assert t250250_x4(text5=25030400, z2=72500045, flag18=1, mode12=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()
...
def t250250_1103():
    ...
    assert t250250_x5(text4=25030600, flag17=1, mode11=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()
...
def t250250_2000():
    """State 0,3"""
    assert (t250250_x0(actionbutton1=7002500, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
            actionbutton2=0, flag5=6000, val6=1000000, val7=1000000, val8=1000000, val9=1000000, val10=1000000))
    """State 2"""
    SetEventStateIf(not DoesSelfHaveSpEffect(5450), 72500004, 1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()

def t250250_x0(actionbutton1=7002500, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
               actionbutton2=0, flag5=_, val6=1000000, val7=1000000, val8=1000000, val9=1000000, val10=1000000):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t250250_x29(actionbutton1=actionbutton1, flag6=flag6, flag10=flag10, flag11=flag11, flag12=flag12,
...
def t250250_x3(text1=_, flag14=_, flag19=1, mode13=1):
    """State 0,7"""
...
def t250250_x4(text5=25030400, z2=72500045, flag18=1, mode12=1):
    """State 0,7"""
    assert t250250_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 5"""
    if not flag18:
...
def t250250_x5(text4=_, flag17=_, mode11=1):
    """State 0,6"""
    assert t250250_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag17:
...
def t250250_x7(flag1=1619, flag2=1615, flag3=1616, val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t250250_x8(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag4=flag4, actionbutton1=actionbutton1,
...
def t250250_x8(val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001, actionbutton1=7002500, flag5=1616,
    ...
    while True:
        """State 4"""
        call = t250250_x25(actionbutton1=actionbutton1, flag5=flag5, flag6=flag6, val6=val6, val7=val7,
...
def t250250_x17():
    """State 0,1"""
    assert t250250_x19(z1=1101, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t250250_x18(mode2=1, mode4=0):
    ...
    if f116(10000) == 1:
        ...
        assert t250250_x19(z1=1000, mode7=0, mode8=0, mode9=0, mode10=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t250250_x19(z1=_, mode7=0, mode8=0, mode9=0, mode10=0):
    """State 0,4"""
    if f118(z1) == 1:
        """State 2"""
...
def t250250_x20():
    """State 0,1"""
    call = t250250_x19(z1=1103, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert t250250_x1()
    elif call.Get() == 0:
...
def t250250_x21():
    """State 0,2"""
    call = t250250_x19(z1=1102, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t250250_x22():
    """State 0,1"""
    assert t250250_x19(z1=1001, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t250250_x24():
    """State 0,1"""
    assert t250250_x19(z1=1100, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t250250_x25(actionbutton1=7002500, flag5=1616, flag6=6001, val6=1000000, val7=1000000, val8=1000000,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t250250_x19(z1=2000, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert (t250250_x0(actionbutton1=actionbutton1, flag6=flag6, flag10=6000, flag11=6000, flag12=6000,
...
def t250250_x26(text1=25030000, flag14=72500047, text2=25030100, flag15=72500048, text3=25030200, flag16=72500049,
    ...
    if not text1 == -1 and not GetEventStatus(flag14):
        """State 3"""
        assert t250250_x3(text1=text1, flag14=flag14, flag19=1, mode13=1)
    elif not text2 == -1 and not GetEventStatus(flag15):
        """State 4"""
        assert t250250_x3(text1=text2, flag14=flag15, flag19=1, mode13=1)
    elif not text3 == -1 and not GetEventStatus(flag16):
        """State 5"""
        assert t250250_x3(text1=text3, flag14=flag16, flag19=1, mode13=1)
    else:
        """State 2"""
        ...
        """State 6"""
        assert t250250_x5(text4=text4, flag17=1, mode11=1)
    """State 7"""
    return 0
...
def t250250_x28():
    """State 0,1"""
    assert t250250_x19(z1=1002, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t250250_x29(actionbutton1=7002500, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
...
def t250250_x30(goods1=9071):
    ...
    if GetEventStatus(72500001) == 1:
        ...
        assert t250250_x5(text4=25010000, flag17=0, mode11=1)
        """State 13"""
        ...
        if not GetEventStatus(72500002):
            ...
            assert t250250_x5(text4=25000400, flag17=0, mode11=1)
            """State 6"""
            MainBonfireMenuFlag()
            """State 7"""
            ClearTalkListData()
            ...
            assert t250250_x5(text4=25010003, flag17=0, mode11=1)
    """State 26"""
    return 0
...
def t250250_x31():
    ...
    if not GetEventStatus(72500000):
        ...
        if not GetEventStatus(72500043):
            """State 15,23"""
            # talk:25000000:"This..."
            assert t250250_x5(text4=25000000, flag17=0, mode11=1)
            """State 9"""
            SetEventState(72500000, 1)
        else:
            """State 16,24"""
            # talk:25000050:"This..."
            call = t250250_x5(text4=25000050, flag17=0, mode11=1)
        ...
        if GetEventStatus(72500044) == 1 and not GetEventStatus(50006251):
            ...
            assert t250250_x5(text4=25000200, flag17=0, mode11=1)
            """State 21"""
            assert t250250_x6(lot1=62510)
        else:
            """State 3"""
            if GetEventStatus(72500043) == 1 and not GetEventStatus(50006250):
                ...
                if GetEventStatus(72500044) == 1 or GetEventStatus(9370) == 1:
                    ...
                    assert t250250_x5(text4=25000300, flag17=0, mode11=1)
                else:
                    """State 14,17"""
                    # talk:25000100:"Master..."
                    assert t250250_x5(text4=25000100, flag17=0, mode11=1)
    """State 27"""
    return 0
