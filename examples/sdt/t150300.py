...
def t150300_1():
    ...
    t150300_x7(flag9=1439, flag10=1435, flag11=1436, val1=5, val2=10, val3=12, val4=10, val5=12, flag12=6001,
               actionbutton1=7003000, flag13=71500163, flag14=6001, flag15=6000, flag16=6000, mode1=1,
               val6=1000000, val7=1000000, val8=1000000, mode2=0, mode3=1, mode4=0, val9=1000000, val10=1000000,
...
def t150300_1001():
    ...
    if GetEventStatus(11500690) == 1:
        ...
        assert t150300_x5(text5=30130100, flag22=1, mode11=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()
...
def t150300_1102():
    ...
    while True:
        ...
        if GetEventStatus(11500690) == 1:
            ...
            """State 3,5"""
            # talk:30130000:"I see..."
            assert t150300_x3(text1=30130000, flag1=71500194, flag24=1, mode13=1)
    while True:
        """State 4"""
...
def t150300_1103():
    ...
    if GetEventStatus(71500153) == 1:
        ...
        if True:
            """State 5"""
            # talk:30130200:"Ahh..."
            assert t150300_x5(text5=30130200, flag22=1, mode11=1)
...
def t150300_2000():
    ...
    if call.Done():
        ...
        """State 3"""
        assert (t150300_x0(actionbutton1=7003040, flag14=6001, flag18=6000, flag19=6000, flag20=6000,
...
def t150300_x0(actionbutton1=_, flag14=6001, flag18=6000, flag19=6000, flag20=6000, flag21=6000, actionbutton2=0,
               flag13=_, val6=1000000, val7=1000000, val8=1000000, val9=_, val10=_):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t150300_x28(actionbutton1=actionbutton1, flag14=flag14, flag18=flag18, flag19=flag19,
...
def t150300_x3(text1=_, flag1=_, flag24=_, mode13=1):
    """State 0,7"""
...
def t150300_x4(text14=_, z6=_, flag23=0, mode12=1):
    """State 0,7"""
    assert t150300_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 5"""
    if not flag23:
...
def t150300_x5(text5=_, flag22=_, mode11=1):
    """State 0,6"""
    assert t150300_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag22:
...
def t150300_x7(flag9=1439, flag10=1435, flag11=1436, val1=5, val2=10, val3=12, val4=10, val5=12, flag12=6001,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t150300_x8(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag12=flag12, actionbutton1=actionbutton1,
...
def t150300_x8(val1=5, val2=10, val3=12, val4=10, val5=12, flag12=6001, actionbutton1=7003000, flag13=71500163,
    ...
    while True:
        """State 4"""
        call = t150300_x25(actionbutton1=actionbutton1, flag13=flag13, flag14=flag14, val6=val6, val7=val7,
...
def t150300_x17():
    """State 0,1"""
    assert t150300_x19(z5=1101, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t150300_x18(mode2=0, mode4=0):
    ...
    if f116(10000) == 1:
        ...
        assert t150300_x19(z5=1000, mode7=0, mode8=0, mode9=0, mode10=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t150300_x19(z5=_, mode7=0, mode8=0, mode9=0, mode10=0):
    """State 0,4"""
    if f118(z5) == 1:
        """State 2"""
...
def t150300_x20():
    """State 0,1"""
    call = t150300_x19(z5=1103, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert t150300_x1()
    elif call.Get() == 0:
...
def t150300_x21():
    """State 0,2"""
    call = t150300_x19(z5=1102, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t150300_x22():
    """State 0,1"""
    assert t150300_x19(z5=1001, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t150300_x24():
    """State 0,1"""
    assert t150300_x19(z5=1100, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t150300_x25(actionbutton1=7003000, flag13=71500163, flag14=6001, val6=1000000, val7=1000000, val8=1000000,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t150300_x19(z5=2000, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert (t150300_x0(actionbutton1=actionbutton1, flag14=flag14, flag18=6000, flag19=6000, flag20=6000,
...
def t150300_x27():
    """State 0,1"""
    assert t150300_x19(z5=1002, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t150300_x28(actionbutton1=_, flag14=6001, flag18=6000, flag19=6000, flag20=6000, flag21=6000, actionbutton2=0,
                flag13=_):
    """State 0"""
    while Loop('mainloop'):
        """State 1"""
...
def t150300_x29(text5=30900000, text6=30900100, text7=30900150, text8=30910050, text9=30910200, text10=30910210,
    ...
    if GetEventStatus(flag7) == 1:
        ...
        if not GetEventStatus(50006990):
            ...
            Label('L0')
            """State 57"""
            assert t150300_x5(text5=text9, flag22=0, mode11=1)
            """State 48"""
            ...
            Label('L1')
            """State 63"""
            assert t150300_x5(text5=text10, flag22=0, mode11=1)
            """State 23"""
                ...
                if GetEventStatus(flag5) == 1:
                    ...
                    if not GetEventStatus(flag6):
                        ...
                        if not GetEventStatus(70004000):
                            """State 3,55"""
                            assert t150300_x5(text5=text5, flag22=0, mode11=1)
                        else:
                            """State 4,56"""
                            assert t150300_x5(text5=text6, flag22=0, mode11=1)
                    else:
                        """State 52,64"""
                        assert t150300_x5(text5=text7, flag22=0, mode11=1)
                    """State 51"""
    ...
    """State 59"""
    Label('L12')
    assert t150300_x5(text5=text12, flag22=0, mode11=1)
    Goto('L6')
    """State 60"""
    Label('L13')
    assert t150300_x5(text5=text11, flag22=0, mode11=1)
    Goto('L9')
    """State 61"""
    Label('L14')
    assert t150300_x5(text5=text8, flag22=0, mode11=1)
    Goto('L4')
    """State 62"""
    Label('L15')
    assert t150300_x5(text5=text13, flag22=0, mode11=1)
    Goto('L11')
...
def t150300_x30(text1=30030000, flag1=71300003, text2=30030100, flag2=71300004, text3=_, flag3=71300005,
    ...
    if not text1 == -1 and not GetEventStatus(flag1):
        """State 4"""
        assert t150300_x3(text1=text1, flag1=flag1, flag24=1, mode13=1)
    elif not text2 == -1 and not GetEventStatus(flag2):
        """State 5"""
        assert t150300_x3(text1=text2, flag1=flag2, flag24=1, mode13=1)
    elif not text3 == -1 and not GetEventStatus(flag3):
        """State 6"""
        assert t150300_x3(text1=text3, flag1=flag3, flag24=1, mode13=1)
    else:
        """State 7"""
        assert t150300_x3(text1=text4, flag1=flag4, flag24=1, mode13=1)
    """State 8"""
    return 0
...
def t150300_x31():
    ...
    if GetEventStatus(11500690) == 1:
        """State 39"""
        # talk:30000500:"Why..."
        assert t150300_x4(text14=30000500, z6=71300008, flag23=0, mode12=1)
    else:
        """State 11"""
        if GetEventStatus(71500161) == 1:
            ...
            if call.Get() == 0:
                ...
                if not GetEventStatus(71500150):
                    ...
                    def WhilePaused():
                        c1_120(1, 10, 9, 9, 9, 9, 9, 9, 9)
                    assert t150300_x5(text5=30100000, flag22=0, mode11=1)
                    """State 3"""
                    ClearTalkListData()
                    """State 4"""
                    ...
                    if GetTalkListEntryResult() == 1:
                        ...
                        def WhilePaused():
                            c1_120(1, 10, 9, 9, 9, 9, 9, 9, 9)
                        assert t150300_x4(text14=30110000, z6=71500150, flag23=0, mode12=1)
                        """State 13"""
                        ...
                        def WhilePaused():
                            c1_120(1, 10, 9, 9, 9, 9, 9, 9, 9)
                        assert t150300_x5(text5=30110100, flag22=0, mode11=1)
                        """State 12"""
                    ...
                    if not GetEventStatus(71500192):
                        ...
                        assert t150300_x5(text5=30100100, flag22=0, mode11=1)
                        """State 16"""
                        ClearTalkListData()
                        """State 34"""
                        call = t150300_x33()
                        ...
                        if GetTalkListEntryResult() == 1:
                            ...
                            def WhilePaused():
                                c1_120(1, 10, 9, 9, 9, 9, 9, 9, 9)
                            assert t150300_x5(text5=30110300, flag22=0, mode11=1)
                            """State 27"""
                        ...
                        def WhilePaused():
                            c1_120(1, 0, 9, 9, 9, 9, 9, 9, 9)
                        assert t150300_x5(text5=30100200, flag22=0, mode11=1)
                        Goto('L4')
        ...
        def WhilePaused():
            c1_120(1, 10, 9, 9, 9, 9, 9, 9, 9)
        assert t150300_x4(text14=30110200, z6=71500192, flag23=0, mode12=1)
        """State 28"""
        SetEventState(71500161, 0)
    """State 40"""
    Label('L4')
...
def t150300_x32():
    ...
    if not GetEventStatus(11500690):
        ...
        if not GetEventStatus(71500152):
            ...
            def WhilePaused():
                c1_120(1, 10, 9, 9, 9, 9, 9, 9, 9)
            assert t150300_x4(text14=30100300, z6=71500152, flag23=0, mode12=1)
        else:
            """State 6"""
            # talk:30100400:"Ahh..."
            def WhilePaused():
                c1_120(1, 10, 9, 9, 9, 9, 9, 9, 9)
            assert t150300_x5(text5=30100400, flag22=0, mode11=1)
    else:
        """State 4"""
        if not GetEventStatus(50006300):
            ...
            def WhilePaused():
                c1_120(1, 0, 9, 9, 9, 9, 9, 9, 9)
            assert t150300_x5(text5=30100500, flag22=0, mode11=1)
            """State 8"""
            def WhilePaused():
                c1_120(1, 0, 9, 9, 9, 9, 9, 9, 9)
        ...
        def WhilePaused():
            c1_117(1102000, -1)
            c1_120(1, 10, 9, 9, 9, 9, 9, 9, 9)
        assert t150300_x3(text1=30100520, flag1=71500153, flag24=0, mode13=1)
    """State 10"""
    return 0
...
def t150300_x34():
    """State 0,1"""
    Label('L0')
    call = t150300_x0(actionbutton1=7003030, flag14=6001, flag18=6000, flag19=6000, flag20=6000, flag21=6000,
    ...
    if call.Done():
        ...
        """State 3"""
        Label('L1')
        call = t150300_x0(actionbutton1=7003050, flag14=6001, flag18=6000, flag19=6000, flag20=6000,
                          flag21=6000, actionbutton2=0, flag13=6000, val6=1000000, val7=1000000, val8=1000000,
                          val9=-1, val10=-1)
        if call.Done():
            pass
            ...
            """State 2"""
            Label('L2')
            call = t150300_x0(actionbutton1=7003031, flag14=6001, flag18=6000, flag19=6000, flag20=6000,
