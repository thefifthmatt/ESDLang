...
def t110260_1():
    ...
    t110260_x7(flag9=1459, flag10=1455, flag11=1456, val1=5, val2=10, val3=12, val4=10, val5=12, flag12=6001,
               actionbutton1=7002610, flag13=6000, flag14=6001, flag15=6000, flag16=6000, mode1=1, val6=1000000,
               val7=1000000, val8=1000000, mode2=1, mode3=1, mode4=1, val9=1000000, val10=1000000, mode5=0,
               flag17=6000, mode6=0)
    Quit()
...
def t110260_1000():
    ...
    if ((GetEventStatus(1219) == 1 or GetEventStatus(1215) == 1 or GetEventStatus(1216) == 1) and GetEventStatus(70002025)
        ...
        def WhilePaused():
            c1_117(1110801, -1)
        assert t110260_x5(text5=26900900, flag22=0, mode11=1)
    else:
        """State 4"""
...
def t110260_1103():
    ...
    assert t110260_x5(text5=26030800, flag22=1, mode11=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()

def t110260_x0(actionbutton1=7002610, flag14=6001, flag18=6000, flag19=6000, flag20=6000, flag21=6000,
               actionbutton2=0, flag13=6000, val6=1000000, val7=1000000, val8=1000000, val9=1000000,
               val10=1000000):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t110260_x28(actionbutton1=actionbutton1, flag14=flag14, flag18=flag18, flag19=flag19,
...
def t110260_x3(text1=_, flag1=_, flag24=1, mode13=1):
    """State 0,7"""
...
def t110260_x4(text14=26001300, z6=71100350, flag23=0, mode12=1):
    """State 0,7"""
    assert t110260_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 5"""
    if not flag23:
...
def t110260_x5(text5=_, flag22=_, mode11=1):
    """State 0,6"""
    assert t110260_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag22:
...
def t110260_x7(flag9=1459, flag10=1455, flag11=1456, val1=5, val2=10, val3=12, val4=10, val5=12, flag12=6001,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t110260_x8(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag12=flag12, actionbutton1=actionbutton1,
...
def t110260_x8(val1=5, val2=10, val3=12, val4=10, val5=12, flag12=6001, actionbutton1=7002610, flag13=6000,
               flag14=6001, flag15=6000, flag16=6000, mode1=1, val6=1000000, val7=1000000, val8=1000000,
               mode2=1, mode3=1, mode4=1, val9=1000000, val10=1000000, mode5=0, mode6=0):
    """State 0"""
    while True:
        """State 4"""
        call = t110260_x25(actionbutton1=actionbutton1, flag13=flag13, flag14=flag14, val6=val6, val7=val7,
...
def t110260_x17():
    """State 0,1"""
    assert t110260_x19(z5=1101, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t110260_x18(mode2=1, mode4=1):
    ...
    if f116(10000) == 1:
        ...
        assert t110260_x19(z5=1000, mode7=0, mode8=0, mode9=0, mode10=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t110260_x19(z5=_, mode7=0, mode8=0, mode9=0, mode10=0):
    """State 0,4"""
    if f118(z5) == 1:
        """State 2"""
...
def t110260_x20():
    """State 0,1"""
    call = t110260_x19(z5=1103, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert t110260_x1()
    elif call.Get() == 0:
...
def t110260_x21():
    """State 0,2"""
    call = t110260_x19(z5=1102, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t110260_x22():
    """State 0,1"""
    assert t110260_x19(z5=1001, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t110260_x24():
    """State 0,1"""
    assert t110260_x19(z5=1100, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t110260_x25(actionbutton1=7002610, flag13=6000, flag14=6001, val6=1000000, val7=1000000, val8=1000000,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t110260_x19(z5=2000, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert (t110260_x0(actionbutton1=actionbutton1, flag14=flag14, flag18=6000, flag19=6000, flag20=6000,
...
def t110260_x27():
    """State 0,1"""
    assert t110260_x19(z5=1002, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t110260_x28(actionbutton1=7002610, flag14=6001, flag18=6000, flag19=6000, flag20=6000, flag21=6000,
...
def t110260_x29(text5=26900200, text6=26900300, text7=26900350, text8=26910050, text9=26910300, text10=26910310,
    ...
    if GetEventStatus(flag7) == 1:
        ...
        if not GetEventStatus(50006990):
            ...
            Label('L0')
            """State 57"""
            assert t110260_x5(text5=text9, flag22=0, mode11=1)
            """State 48"""
            ...
            Label('L1')
            """State 63"""
            assert t110260_x5(text5=text10, flag22=0, mode11=1)
            """State 23"""
                ...
                if GetEventStatus(flag5) == 1:
                    ...
                    if not GetEventStatus(flag6):
                        ...
                        if not GetEventStatus(70004000):
                            """State 3,55"""
                            assert t110260_x5(text5=text5, flag22=0, mode11=1)
                        else:
                            """State 4,56"""
                            assert t110260_x5(text5=text6, flag22=0, mode11=1)
                    else:
                        """State 52,64"""
                        assert t110260_x5(text5=text7, flag22=0, mode11=1)
                    """State 51"""
    ...
    """State 59"""
    Label('L12')
    assert t110260_x5(text5=text12, flag22=0, mode11=1)
    Goto('L6')
    """State 60"""
    Label('L13')
    assert t110260_x5(text5=text11, flag22=0, mode11=1)
    Goto('L9')
    """State 61"""
    Label('L14')
    assert t110260_x5(text5=text8, flag22=0, mode11=1)
    Goto('L4')
    """State 62"""
    Label('L15')
    assert t110260_x5(text5=text13, flag22=0, mode11=1)
    Goto('L11')
...
def t110260_x30(text1=26030000, flag1=72009040, text2=26030100, flag2=72009041, text3=_, flag3=72009042,
    ...
    if not text1 == -1 and not GetEventStatus(flag1):
        """State 4"""
        assert t110260_x3(text1=text1, flag1=flag1, flag24=1, mode13=1)
    elif not text2 == -1 and not GetEventStatus(flag2):
        """State 5"""
        assert t110260_x3(text1=text2, flag1=flag2, flag24=1, mode13=1)
    elif not text3 == -1 and not GetEventStatus(flag3):
        """State 6"""
        assert t110260_x3(text1=text3, flag1=flag3, flag24=1, mode13=1)
    else:
        """State 7"""
        assert t110260_x3(text1=text4, flag1=flag4, flag24=1, mode13=1)
    """State 8"""
    return 0
...
def t110260_x31():
    ...
    if not GetEventStatus(71100350):
        """State 2,9"""
        # talk:26001300:"Ohh, Mr. Shinobi"
        assert t110260_x4(text14=26001300, z6=71100350, flag23=0, mode12=1)
    else:
        """State 3"""
        if GetEventStatus(70002015) == 1:
            """State 4,10"""
            # talk:26900600:"Mr Shinobi, we have a huge problem..."
            assert t110260_x5(text5=26900600, flag22=0, mode11=1)
        else:
            """State 5,14"""
            # talk:26001400:"Anayama is a good man."
            assert t110260_x5(text5=26001400, flag22=0, mode11=1)
    """State 15"""
    Label('L0')
    return 0
    """Unused"""
    """State 6"""
    if not GetEventStatus(50006261):
        Goto('L4')
    else:
        Goto('L5')
    """State 7"""
    Label('L1')
    SetEventState(71100380, 0)
    Goto('L3')
    """State 8"""
    Label('L2')
    SetEventState(71100380, 0)
    ...
    """State 11"""
    Label('L3')
    assert t110260_x6(lot1=62610)
    Goto('L0')
    """State 12"""
    Label('L4')
    # talk:26900700:"Take a look, come on. Anayama, see?"
    assert t110260_x5(text5=26900700, flag22=0, mode11=1)
    Goto('L1')
    """State 13"""
    Label('L5')
    # talk:26900750:"Take a look, come on. Anayama, see?"
    assert t110260_x5(text5=26900750, flag22=0, mode11=1)
    Goto('L2')
