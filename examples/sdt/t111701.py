...
def t111701_1():
    ...
    t111701_x5(flag1=70009149, flag2=70009145, flag3=70009146, val1=5, val2=10, val3=12, val4=10, val5=12,
               flag4=6001, actionbutton1=7007050, flag5=6000, flag6=6001, flag7=6001, flag8=6000, mode1=1,
               val6=1000000, val7=1000000, val8=1000000, mode2=1, mode3=1, mode4=0, val9=1000000, val10=1000000,
               mode5=0, flag9=71119017, mode6=0)
    Quit()
...
def t111701_1100():
    ...
    assert t111701_x3(text2=70100100, z2=71119019, flag15=1, mode12=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()
...
def t111701_2000():
    ...
    while True:
        """State 2"""
        call = t111701_x0(actionbutton1=7007050, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
...
def t111701_x0(actionbutton1=7007050, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
               actionbutton2=0, flag5=6000, val6=1000000, val7=1000000, val8=1000000, val9=1000000, val10=1000000):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t111701_x26(actionbutton1=actionbutton1, flag6=flag6, flag10=flag10, flag11=flag11, flag12=flag12,
...
def t111701_x3(text2=70100100, z2=71119019, flag15=1, mode12=1):
    """State 0,7"""
...
def t111701_x4(text1=_, flag14=0, mode11=1):
    """State 0,6"""
    assert t111701_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag14:
...
def t111701_x5(flag1=70009149, flag2=70009145, flag3=70009146, val1=5, val2=10, val3=12, val4=10, val5=12,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t111701_x6(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag4=flag4, actionbutton1=actionbutton1,
...
def t111701_x6(val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001, actionbutton1=7007050, flag5=6000,
    ...
    while True:
        """State 4"""
        call = t111701_x23(actionbutton1=actionbutton1, flag5=flag5, flag6=flag6, val6=val6, val7=val7,
...
def t111701_x15():
    """State 0,1"""
    assert t111701_x17(z1=1101, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t111701_x16(mode2=1, mode4=0):
    ...
    if f116(10000) == 1:
        ...
        assert t111701_x17(z1=1000, mode7=0, mode8=0, mode9=0, mode10=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t111701_x17(z1=_, mode7=0, mode8=0, mode9=0, mode10=0):
    """State 0,4"""
    if f118(z1) == 1:
        """State 2"""
...
def t111701_x18():
    """State 0,1"""
    call = t111701_x17(z1=1103, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert t111701_x1()
    elif call.Get() == 0:
...
def t111701_x19():
    """State 0,2"""
    call = t111701_x17(z1=1102, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t111701_x20():
    """State 0,1"""
    assert t111701_x17(z1=1001, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t111701_x22():
    """State 0,1"""
    assert t111701_x17(z1=1100, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t111701_x23(actionbutton1=7007050, flag5=6000, flag6=6001, val6=1000000, val7=1000000, val8=1000000,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t111701_x17(z1=2000, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert (t111701_x0(actionbutton1=actionbutton1, flag6=flag6, flag10=6000, flag11=6000, flag12=6000,
...
def t111701_x25():
    """State 0,1"""
    assert t111701_x17(z1=1002, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t111701_x26(actionbutton1=7007050, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
...
def t111701_x27():
    ...
    if GetEventStatus(71119015) == 1:
        ...
        def ExitPause():
            SetEventStateIf(not f116(-1) == 1101002, 71119017, 0)
        assert t111701_x4(text1=70102000, flag14=0, mode11=1)
        """State 11"""
        ...
        def ExitPause():
            SetEventStateIf(not f116(-1) == 1101002, 71119017, 0)
        assert t111701_x4(text1=70102100, flag14=0, mode11=1)
        """State 12"""
        SetEventState(71119016, 0)
    else:
        """State 13"""
        # talk:70100000:"(Groan...)"
        assert t111701_x4(text1=70100000, flag14=0, mode11=1)
        """State 2"""
        MainBonfireMenuFlag()
        ClearTalkListData()
        """State 3"""
...
def t111701_x28():
    """State 0,1"""
    # talk:70100100:"... You... you're a shinobi, right...?"
    call = t111701_x3(text2=70100100, z2=71119019, flag15=1, mode12=1)
    if call.Done():
        pass
