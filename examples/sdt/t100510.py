...
def t100510_1():
    ...
    t100510_x4(flag1=1799, flag2=1795, flag3=1796, val1=12, val2=10, val3=12, val4=10, val5=12, flag4=6001,
               actionbutton1=7007999, flag5=6000, flag6=6001, flag7=6000, flag8=6000, mode1=1, val6=1000000,
...
def t100510_1000():
    ...
    assert t100510_x3(text1=70020000, z2=71000460, flag14=0, mode11=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()

def t100510_x0(actionbutton1=7007999, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
               actionbutton2=0, flag5=6000, val6=1000000, val7=1000000, val8=1000000, val9=1000000, val10=1000000):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t100510_x25(actionbutton1=actionbutton1, flag6=flag6, flag10=flag10, flag11=flag11, flag12=flag12,
...
def t100510_x3(text1=70020000, z2=71000460, flag14=0, mode11=1):
    """State 0,7"""
...
def t100510_x4(flag1=1799, flag2=1795, flag3=1796, val1=12, val2=10, val3=12, val4=10, val5=12, flag4=6001,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t100510_x5(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag4=flag4, actionbutton1=actionbutton1,
...
def t100510_x5(val1=12, val2=10, val3=12, val4=10, val5=12, flag4=6001, actionbutton1=7007999, flag5=6000,
    ...
    while True:
        """State 4"""
        call = t100510_x22(actionbutton1=actionbutton1, flag5=flag5, flag6=flag6, val6=val6, val7=val7,
...
def t100510_x14():
    """State 0,1"""
    assert t100510_x16(z1=1101, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t100510_x15(mode2=1, mode4=0):
    ...
    if f116(10000) == 1:
        ...
        assert t100510_x16(z1=1000, mode7=0, mode8=0, mode9=0, mode10=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t100510_x16(z1=_, mode7=0, mode8=0, mode9=0, mode10=0):
    """State 0,4"""
    if f118(z1) == 1:
        """State 2"""
...
def t100510_x17():
    """State 0,1"""
    call = t100510_x16(z1=1103, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert t100510_x1()
    elif call.Get() == 0:
...
def t100510_x18():
    """State 0,2"""
    call = t100510_x16(z1=1102, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t100510_x19():
    """State 0,1"""
    assert t100510_x16(z1=1001, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t100510_x21():
    """State 0,1"""
    assert t100510_x16(z1=1100, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t100510_x22(actionbutton1=7007999, flag5=6000, flag6=6001, val6=1000000, val7=1000000, val8=1000000,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t100510_x16(z1=2000, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert (t100510_x0(actionbutton1=actionbutton1, flag6=flag6, flag10=6000, flag11=6000, flag12=6000,
...
def t100510_x24():
    """State 0,1"""
    assert t100510_x16(z1=1002, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t100510_x25(actionbutton1=7007999, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
