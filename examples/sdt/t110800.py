...
def t110800_1():
    ...
    t110800_x7(flag1=6000, flag2=6000, flag3=6000, val1=12, val2=10, val3=12, val4=10, val5=12, flag4=6001,
               actionbutton1=7008000, flag5=6000, flag6=6001, flag7=6000, flag8=6000, mode1=1, val6=1000000,
...
def t110800_x1(actionbutton1=7008000, flag6=6001, flag9=6000, flag10=6000, flag11=6000, flag12=6000,
               actionbutton2=0, flag5=6000, val6=1000000, val7=1000000, val8=1000000, val9=1000000, val10=1000000):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t110800_x31(actionbutton1=actionbutton1, flag6=flag6, flag9=flag9, flag10=flag10, flag11=flag11,
...
def t110800_x4(text4=-1, flag18=-1, flag21=0, mode13=1):
    """State 0,7"""
...
def t110800_x5(text1=-1, flag20=0, mode12=1):
    """State 0,6"""
    assert t110800_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag20:
...
def t110800_x7(flag1=6000, flag2=6000, flag3=6000, val1=12, val2=10, val3=12, val4=10, val5=12, flag4=6001,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t110800_x8(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag4=flag4, actionbutton1=actionbutton1,
...
def t110800_x8(val1=12, val2=10, val3=12, val4=10, val5=12, flag4=6001, actionbutton1=7008000, flag5=6000,
    ...
    while True:
        """State 4"""
        call = t110800_x25(actionbutton1=actionbutton1, flag5=flag5, flag6=flag6, val6=val6, val7=val7,
...
def t110800_x17():
    """State 0,1"""
    assert t110800_x19(z2=1101, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0
...
def t110800_x18(mode2=1, mode4=0):
    ...
    assert t110800_x19(z2=1000, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 5"""
    return 0

def t110800_x19(z2=_, mode8=0, mode9=0, mode10=0, mode11=0):
    """State 0,4"""
    if f118(z2) == 1:
        """State 2"""
        assert GetCurrentStateElapsedFrames() > 1
...
def t110800_x20():
    """State 0,1"""
    call = t110800_x19(z2=1103, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """State 2"""
        assert t110800_x2()
    elif call.Get() == 0:
...
def t110800_x21():
    """State 0,2"""
    call = t110800_x19(z2=1102, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t110800_x22():
    """State 0,1"""
    assert t110800_x19(z2=1001, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0
...
def t110800_x24():
    """State 0,1"""
    assert t110800_x19(z2=1100, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0

def t110800_x25(actionbutton1=7008000, flag5=6000, flag6=6001, val6=1000000, val7=1000000, val8=1000000,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t110800_x19(z2=2000, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """State 2"""
        assert (t110800_x1(actionbutton1=actionbutton1, flag6=flag6, flag9=6000, flag10=6000, flag11=6000,
...
def t110800_x26(shop1=1100000, shop2=1100099, flag13=-1, flag14=-1, text1=-1, flag15=-1, flag16=-1, text2=-1,
    ...
    if GetEventStatus(flag15) == 1 and not GetEventStatus(flag18) and mode6 == 1:
        """State 18,26"""
        assert t110800_x29(text1=text1, text4=text4, lot1=69900, flag15=flag15, flag18=flag18, mode7=1)
        while True:
            """State 1"""
            Label('L0')
            ClearTalkListData()
            ...
            if GetTalkListEntryResult() == 1:
                ...
                if GetGenericDialogButtonResult() == 1:
                    ...
                    """State 15,24"""
                    assert t110800_x5(text1=text3, flag20=0, mode12=1)
        ...
        Goto('L0')
    """State 20,23"""
    assert t110800_x4(text4=text2, flag18=flag17, flag21=0, mode13=1)
    Goto('L0')
...
def t110800_x28():
    """State 0,1"""
    assert t110800_x19(z2=1002, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0

def t110800_x29(text1=-1, text4=-1, lot1=69900, flag15=-1, flag18=-1, mode7=_):
    """State 0,3"""
    if not mode7:
        """State 4,8"""
        assert t110800_x5(text1=text1, flag20=0, mode12=1)
        """State 2"""
        ...
        if GetEventStatus(flag15) == 1 and not GetEventStatus(flag18):
            ...
            return 1
    """State 1,9"""
    assert t110800_x4(text4=text4, flag18=flag18, flag21=0, mode13=1)
    """State 11"""
    return 0
...
def t110800_x31(actionbutton1=7008000, flag6=6001, flag9=6000, flag10=6000, flag11=6000, flag12=6000,
