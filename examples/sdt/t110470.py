...
def t110470_1103():
    ...
    assert t110470_x6(text5=47030400, flag24=1, mode13=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()
...
def t110470_x1(actionbutton1=7008000, flag16=6001, flag20=6000, flag21=6000, flag22=6000, flag23=6000,
               actionbutton2=0, flag15=6000, val6=1000000, val7=1000000, val8=1000000, val9=1000000,
               val10=1000000):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t110470_x30(actionbutton1=actionbutton1, flag16=flag16, flag20=flag20, flag21=flag21,
...
def t110470_x4(text1=_, flag1=_, flag26=1, mode15=1):
    """State 0,7"""
...
def t110470_x5(text15=_, z10=_, flag25=0, mode14=1):
    """State 0,7"""
    assert t110470_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 5"""
    if not flag25:
...
def t110470_x6(text5=_, flag24=_, mode13=1):
    """State 0,6"""
    assert t110470_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag24:
...
def t110470_x8(flag11=1939, flag12=1935, flag13=1936, val1=12, val2=10, val3=12, val4=10, val5=12, flag14=6001,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t110470_x9(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag14=flag14, actionbutton1=actionbutton1,
...
def t110470_x9(val1=12, val2=10, val3=12, val4=10, val5=12, flag14=6001, actionbutton1=7008000, flag15=6000,
    ...
    while True:
        """State 4"""
        call = t110470_x26(actionbutton1=actionbutton1, flag15=flag15, flag16=flag16, val6=val6, val7=val7,
...
def t110470_x18():
    """State 0,1"""
    assert t110470_x20(z9=1101, mode9=0, mode10=0, mode11=0, mode12=0)
    """State 2"""
    return 0
...
def t110470_x19(mode4=1, mode6=0):
    ...
    if f116(10000) == 1:
        ...
        assert t110470_x20(z9=1000, mode9=0, mode10=0, mode11=0, mode12=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t110470_x20(z9=_, mode9=0, mode10=0, mode11=0, mode12=0):
    """State 0,4"""
    if f118(z9) == 1:
        """State 2"""
...
def t110470_x21():
    """State 0,1"""
    call = t110470_x20(z9=1103, mode9=0, mode10=0, mode11=0, mode12=0)
    if call.Get() == 1:
        """State 2"""
        assert t110470_x2()
    elif call.Get() == 0:
...
def t110470_x22():
    """State 0,2"""
    call = t110470_x20(z9=1102, mode9=0, mode10=0, mode11=0, mode12=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t110470_x23():
    """State 0,1"""
    assert t110470_x20(z9=1001, mode9=0, mode10=0, mode11=0, mode12=0)
    """State 2"""
    return 0
...
def t110470_x25():
    """State 0,1"""
    assert t110470_x20(z9=1100, mode9=0, mode10=0, mode11=0, mode12=0)
    """State 2"""
    return 0

def t110470_x26(actionbutton1=7008000, flag15=6000, flag16=6001, val6=1000000, val7=1000000, val8=1000000,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t110470_x20(z9=2000, mode9=0, mode10=0, mode11=0, mode12=0)
    if call.Get() == 1:
        """State 2"""
        assert (t110470_x1(actionbutton1=actionbutton1, flag16=flag16, flag20=6000, flag21=6000, flag22=6000,
...
def t110470_x28():
    """State 0,1"""
    assert t110470_x20(z9=1002, mode9=0, mode10=0, mode11=0, mode12=0)
    """State 2"""
    return 0
...
def t110470_x30(actionbutton1=7008000, flag16=6001, flag20=6000, flag21=6000, flag22=6000, flag23=6000,
...
def t110470_x31(text10=47900000, text11=47900010, text12=47900050, text13=47900150, text14=47900550,
    ...
    if not GetEventStatus(flag10):
        ...
        if not GetEventStatus(70004000):
            """State 3,13"""
            assert t110470_x6(text5=text10, flag24=0, mode13=1)
        else:
            """State 4,14"""
            assert t110470_x6(text5=text11, flag24=0, mode13=1)
    else:
        """State 11,5,17"""
        assert t110470_x6(text5=text12, flag24=0, mode13=1)
    """State 12"""
    Label('L0')
    ...
    """State 15"""
    Label('L3')
    assert t110470_x6(text5=text13, flag24=0, mode13=1)
    Goto('L0')
    """State 16"""
    Label('L4')
    assert t110470_x6(text5=text14, flag24=0, mode13=1)
    Goto('L2')
    """State 19"""
    Label('L5')
    return 1
...
def t110470_x33(text8=47900400, text9=47900410, flag6=71100882, mode2=_):
    ...
    if mode2 == 1:
        ...
        """State 2,7"""
        assert t110470_x6(text5=text8, flag24=0, mode13=1)
        """State 4"""
        SetEventState(flag6, 1)
        """State 8"""
        assert t110470_x7(lot1=69900)
    """State 5,9"""
    assert t110470_x6(text5=text9, flag24=0, mode13=1)
    """State 6"""
...
def t110470_x34(text6=47900200, text7=47900100, z1=71100881, z2=71100880, z3=71100883, mode1=_, z4=9526):
    ...
    if ComparePlayerInventoryNumber(3, 9550, 0, 0, 0) == 1:
        ...
        if call.Get() == 0:
            ...
            SetEventState(z2, 1)
            """State 4,15"""
            assert t110470_x6(text5=text7, flag24=0, mode13=1)
            """State 10"""
            SetEventState(z2, 0)
        elif call.Done():
            """State 11"""
            SetEventState(z1, 1)
            """State 12,16"""
            assert t110470_x6(text5=text6, flag24=0, mode13=1)
            """State 13"""
            SetEventState(z1, 0)
    """State 17"""
    return 0
...
def t110470_x35(text5=47900300, flag5=70002080):
    ...
    if GetEventStatus(flag5) == 1:
        """State 3,4"""
        assert t110470_x6(text5=text5, flag24=0, mode13=1)
        """State 5"""
        return 0
    else:
        """State 2,6"""
...
def t110470_x36(text1=47030000, flag1=71100895, text2=_, flag2=71100896, text3=_, flag3=71100897, text4=_,
    ...
    if not text1 == -1 and not GetEventStatus(flag1):
        """State 4"""
        assert t110470_x4(text1=text1, flag1=flag1, flag26=1, mode15=1)
    elif not text2 == -1 and not GetEventStatus(flag2):
        """State 5"""
        assert t110470_x4(text1=text2, flag1=flag2, flag26=1, mode15=1)
    elif not text3 == -1 and not GetEventStatus(flag3):
        """State 6"""
        assert t110470_x4(text1=text3, flag1=flag3, flag26=1, mode15=1)
    else:
        """State 7"""
        assert t110470_x4(text1=text4, flag1=flag4, flag26=1, mode15=1)
    """State 8"""
    return 0
...
def t110470_x37():
    ...
    if GetEventStatus(71100855) == 1:
        ...
        assert t110470_x5(text15=47110000, z10=71100853, flag25=0, mode14=1)
        """State 27"""
        ...
        """State 29"""
        # talk:47110100:"..."
        assert t110470_x5(text15=47110100, z10=71100854, flag25=0, mode14=1)
        """State 26"""
        ...
        if not GetEventStatus(71100861):
            ...
            if not GetEventStatus(71100850):
                ...
                assert t110470_x6(text5=47100100, flag24=0, mode13=1)
                """State 4"""
                ClearTalkListData()
                """State 5"""
                # action:14047000:"Yes"
                ...
                assert t110470_x6(text5=47100000, flag24=0, mode13=1)
                Goto('L2')
        else:
            """State 14,20"""
            if GetEventStatus(8302) == 1:
                ...
                if not GetEventStatus(71100863):
                    ...
                    assert t110470_x5(text15=47100300, z10=71100863, flag25=0, mode14=1)
                else:
                    """State 24,38"""
                    # talk:47100400:"Any more business with me, friend?"
                    assert t110470_x6(text5=47100400, flag24=0, mode13=1)
            else:
                """State 21,36"""
                # talk:47100200:"Hey there, friend."
                assert t110470_x6(text5=47100200, flag24=0, mode13=1)
    """State 39"""
    Label('L4')
    return 0
    """Unused"""
    ...
    if True:
        pass
    elif GetEventStatus(50006471) == 1:
        Goto('L5')
    """State 16"""
    Goto('L8')
    """State 17"""
    ...
    """State 32"""
    Label('L8')
    # talk:47900500:"Hey, friend! I've been waiting for you."
    assert t110470_x6(text5=47900500, flag24=0, mode13=1)
    Goto('L6')
    """State 33"""
    Label('L9')
    # talk:47900550:"Hey, friend! I've been waiting for you."
    assert t110470_x6(text5=47900550, flag24=0, mode13=1)
    Goto('L7')
    """State 34"""
    Label('L10')
    assert t110470_x7(lot1=64710)
    """State 35"""
    # talk:47900510:"Of course, I've got plenty of other tidbits lined up."
    assert t110470_x6(text5=47900510, flag24=0, mode13=1)
    Goto('L4')
...
def t110470_x38():
    ...
    assert (t110470_x34(text6=47900200, text7=47900100, z1=71100881, z2=71100880, z3=71100883, mode1=0,
            z4=9526))
    Goto('L0')
...
def t110470_x39():
    ...
    assert t110470_x6(text5=47110600, flag24=0, mode13=1)
    """State 2"""
    return 0
...
def t110470_x40():
    ...
    if GetEventStatus(71100871) == 1 and not GetEventStatus(71100864):
        ...
        assert t110470_x5(text15=47110400, z10=71100864, flag25=0, mode14=1)
    else:
        """State 3"""
        if not GetEventStatus(71100862):
            """State 5,9"""
            # talk:47110200:"Ah, so you're looking for goods instead of info, huh?"
            assert t110470_x5(text15=47110200, z10=71100862, flag25=0, mode14=1)
        else:
            """State 6"""
            if GetEventStatus(8302) == 1:
                """State 7,11"""
                # talk:47110500:"Oh, if you're looking for the Sculptor, he's gone."
                assert t110470_x5(text15=47110500, z10=71100870, flag25=0, mode14=1)
            else:
                """State 4,10"""
                # talk:47110300:"Hey, friend.\nIf you're going to Ashina Castle, be careful."
                assert t110470_x6(text5=47110300, flag24=0, mode13=1)
    """State 12"""
    return 0
