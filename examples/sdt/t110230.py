...
def t110230_1():
    ...
    t110230_x30(flag1=1279, flag2=1275, flag3=1276, val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001,
                actionbutton1=7002301, flag5=6000, flag6=6001, flag7=6000, flag8=6000, mode1=1, val6=1000000,
...
def t110230_1000():
    ...
    assert (t110230_x0(goods1=9010, goods2=2503, z1=1100, goods3=9560, goods4=3000, goods5=4400, z2=9550,
            goods6=9011, goods7=2502, mode7=0))
    """State 2"""
    def WhilePaused():
        c1_119(0)
    Quit()
...
def t110230_2000():
    """State 0,3"""
    assert (t110230_x23(actionbutton1=7002301, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
    ...
    if GetEventStatus(71100448) == 1 and mode7 == 1:
        ...
        if call.Get() == 1:
            ...
            if not GetEventStatus(71110179) and GetEventStatus(71100401) == 1:
                ...
                assert t110230_x27(text1=23101100, flag41=0, mode24=1)
                """State 151"""
                ...
                assert t110230_x26(text2=23001900, flag17=71110168, flag43=0, mode26=1)
                Goto('L0')
        elif call.Done():
            pass
        ...
        if not GetEventStatus(71110152):
            ...
            if call.Get() == 1:
                ...
                def WhilePaused():
                    c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10, 0, 9, 9, 9, 9, 9, 9)
                assert t110230_x26(text2=23100800, flag17=71110152, flag43=0, mode26=1)
                """State 53"""
            ...
            if call.Get() == 1:
                ...
                def WhilePaused():
                    c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10, 0, 9, 9, 9, 9, 9, 9)
                assert t110230_x27(text1=23100900, flag41=0, mode24=1)
                Goto('L0')
            elif call.Done():
                pass
        ...
        if call.Get() == 1:
            ...
            def WhilePaused():
                c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10, 0, 9, 9, 9, 9, 9, 9)
            assert t110230_x26(text2=23102200, flag17=71110156, flag43=0, mode26=1)
            Goto('L0')
        elif call.Done():
            pass
    else:
        ...
        if GetEventStatus(1260) == 1:
            ...
            if call.Get() == 1:
                ...
                if not GetEventStatus(71110150):
                    ...
                    def WhilePaused():
                        c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10, 0, 9, 9, 9, 9, 9, 9)
                    assert t110230_x26(text2=23100300, flag17=71110150, flag43=0, mode26=1)
                    Goto('L0')
                else:
                    """State 116"""
                    ...
                    if call.Get() == 1:
                        ...
                        if ((GetEventStatus(71120425) == 1 or GetEventStatus(71120429) == 1 or GetEventStatus(71120428)
                            ...
                            """State 119"""
                            # talk:23003200:"...I saw..."
                            assert t110230_x26(text2=23003200, flag17=71110157, flag43=0, mode26=1)
                        else:
                            """State 76"""
                            if not GetEventStatus(71110181) and GetEventStatus(8250) == 1:
                                """State 77,136"""
                                # talk:23110500:"........."
                                assert t110230_x26(text2=23110500, flag17=71110181, flag43=0, mode26=1)
                            else:
                                """State 6"""
                                if DoesPlayerHaveSpEffect(400) == 1:
                                    ...
                                    def WhilePaused():
                                        c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10, 0, 9, 9, 9, 9, 9, 9)
                                    assert t110230_x27(text1=23101000, flag41=0, mode24=1)
                                    Goto('L0')
                                else:
                                    """State 8,89"""
                                    ...
                                    def WhilePaused():
                                        c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10, 0, 9, 9, 9, 9, 9, 9)
                                    assert t110230_x27(text1=23100400, flag41=0, mode24=1)
                                    Goto('L0')
                    elif call.Done():
                        pass
            elif call.Done():
            ...
            if call.Get() == 1:
                ...
                if call.Get() == 1:
                    ...
                    if not GetEventStatus(71110158) and not GetEventStatus(71110189):
                        ...
                        def WhilePaused():
                            c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10, 0, 9, 9, 9, 9, 9, 9)
                        assert t110230_x27(text1=23101700, flag41=0, mode24=1)
                        Goto('L0')
                        ...
                        def WhilePaused():
                            c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10, 0, 9, 9, 9, 9, 9, 9)
                        assert t110230_x27(text1=23101802, flag41=0, mode24=1)
                        Goto('L0')
                    else:
                        """State 10"""
                        if not GetEventStatus(71110155) and GetEventStatus(9317) == 1:
                            ...
                            def WhilePaused():
                                c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10, 0, 9, 9, 9, 9, 9, 9)
                            assert t110230_x27(text1=23102100, flag41=0, mode24=1)
                            """State 15"""
                            ...
                            if (ComparePlayerInventoryNumber(3, goods6, 2, 0, 0) == 1 and not GetEventStatus(71110154)
                                ...
                                def WhilePaused():
                                    c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10, 0, 9, 9, 9, 9, 9, 9)
                                assert t110230_x27(text1=23102000, flag41=0, mode24=1)
                                Goto('L0')
                            else:
                                """State 12"""
                                # goods:9011:Father's Bell Charm
                                if (ComparePlayerInventoryNumber(3, goods6, 2, 0, 0) == 1 and not GetEventStatus(71110153)
                                    ...
                                    def WhilePaused():
                                        c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10, 0, 9, 9, 9, 9, 9, 9)
                                    assert t110230_x27(text1=23101900, flag41=0, mode24=1)
                                    Goto('L0')
                                else:
                                    """State 114"""
                                    ...
                                    def WhilePaused():
                                        c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10, 0, 9, 9, 9, 9, 9, 9)
                                    assert t110230_x27(text1=23101600, flag41=0, mode24=1)
                                    Goto('L0')
                elif call.Done():
                    pass
            elif call.Done():
            ...
            """State 16,132"""
            call = t110230_x15(mode23=1, flag39=71110703, flag40=71110704, z6=23100300)
            if call.Get() == 1:
                """State 18"""
                    ...
                    if not GetEventStatus(71110059):
                        ...
                        if GetEventStatus(1281) == 1:
                            ...
                            if not GetEventStatus(51110760):
                                ...
                                def ExitPause():
                                    c1_120(2, 10, 0, 9, 9, 9, 9, 9, 9)
                                assert t110230_x15(mode23=0, flag39=71110703, flag40=71110704, z6=23100300)
                            else:
                                """State 24"""
                                if not GetEventStatus(71110162):
                                    """State 25,95"""
                                    # talk:23000700:"So... Lord Isshin wasn't in his watchtower?"
                                    assert t110230_x26(text2=23000700, flag17=71110162, flag43=0, mode26=1)
                                else:
                                    """State 26,96"""
                                    # talk:23000800:"Lord Isshin was not in his watchtower."
                                    assert t110230_x27(text1=23000800, flag41=0, mode24=1)
            elif call.Done():
                pass
            ...
            if not GetEventStatus(71110164):
                """State 29,100"""
                # talk:23001700:"........."
                assert t110230_x26(text2=23001700, flag17=71110164, flag43=0, mode26=1)
            else:
                """State 30,101"""
                # talk:23001800:"Back then..."
                assert t110230_x27(text1=23001800, flag41=0, mode24=1)
                                    ...
                                    if not GetEventStatus(71110167):
                                        ...
                                        if ComparePlayerInventoryNumber(3, goods2, 2, 0, 0) == 1:
                                            ...
                                            def WhilePaused():
                                                c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10, 0,
                                                       9, 9, 9, 9, 9, 9)
                                            assert t110230_x27(text1=23002150, flag41=0, mode24=1)
                                        else:
                                            """State 35,115"""
                                            ...
                                            def WhilePaused():
                                                c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10, 0,
                                                       9, 9, 9, 9, 9, 9)
                                            assert t110230_x27(text1=23002100, flag41=0, mode24=1)
                                        """State 52"""
                                        ...
                                        if ((ComparePlayerInventoryNumber(0, 211000, 2, 0, 0) == 1 or
                                            ...
                                            def WhilePaused():
                                                c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10, 0,
                                                       9, 9, 9, 9, 9, 9)
                                            assert t110230_x27(text1=23002200, flag41=0, mode24=1)
                                            Goto('L0')
                            """State 38,39,105"""
                            # talk:23002400:"Master Wolf...", talk:23002450:"What is...?"
                            def WhilePaused():
                ...
                if call.Get() == 0:
                    ...
                    if not GetEventStatus(71110163):
                        ...
                        if not GetEventStatus(8301):
                            ...
                            def WhilePaused():
                                c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10, 0, 9, 9, 9, 9, 9, 9)
                            assert t110230_x26(text2=23000900, flag17=71110163, flag43=0, mode26=1)
                            Goto('L0')
                        else:
                            """State 141"""
                            ...
                            def WhilePaused():
                                c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10, 0, 9, 9, 9, 9, 9, 9)
                            assert t110230_x26(text2=23000901, flag17=71110163, flag43=0, mode26=1)
                            Goto('L0')
                    else:
                        """State 118"""
                        # goods:9010:Young Lord's Bell Charm
                        ...
                        if call.Get() == 1:
                            ...
                            if not GetEventStatus(71110079) and GetEventStatus(71110087) == 1:
                                ...
                                if not GetEventStatus(71110085):
                                    ...
                                    def WhilePaused():
                                        c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10, 0, 9, 9, 9, 9, 9, 9)
                                    assert t110230_x26(text2=23001000, flag17=71110085, flag43=0, mode26=1)
                                    Goto('L0')
                                else:
                                    """State 50,112"""
                                    ...
                                    def WhilePaused():
                                        c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10, 0, 9, 9, 9, 9, 9, 9)
                                    assert t110230_x27(text1=23001100, flag41=0, mode24=1)
                                    Goto('L0')
                            else:
                                """State 51"""
                                if (GetEventStatus(71100402) == 1 and GetEventStatus(9308) == 1 and GetEventStatus(71110715)
                                    ...
                                    if GetEventStatus(71110165) == 1:
                                        ...
                                        def WhilePaused():
                                            c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10, 0, 9, 9,
                                                   9, 9, 9, 9)
                                        assert t110230_x27(text1=23001500, flag41=0, mode24=1)
                                        Goto('L0')
                                    else:
                                        """State 72,127"""
                                        def WhilePaused():
                                            c1_120(2, 10, 0, 9, 9, 9, 9, 9, 9)
                                        assert t110230_x16(goods7=goods7, flag34=71100444, mode20=0)
                                else:
                                    """State 63"""
                                            ...
                                            if GetEventStatus(71100402) == 1:
                                                ...
                                                def WhilePaused():
                                                    c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10,
                                                           0, 9, 9, 9, 9, 9, 9)
                                                assert t110230_x27(text1=23010706, flag41=0, mode24=1)
                                                Goto('L0')
                                            else:
                                                """State 69,126"""
                                                def WhilePaused():
                                                    c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10,
                                                           0, 9, 9, 9, 9, 9, 9)
                                                assert t110230_x17(mode22=0, flag37=71100442, flag38=71100443)
                                        else:
                                            """State 65,124"""
                                            def WhilePaused():
                                                c1_120(2, 10, 0, 9, 9, 9, 9, 9, 9)
                                            assert t110230_x18(mode21=0, flag35=71100440, flag36=71100441)
                                    else:
                                        """State 57"""
                                        if GetEventStatus(71110084) == 1 and not GetEventStatus(71110078):
                                            ...
                                            if GetEventStatus(71110086) == 1:
                                                ...
                                                def WhilePaused():
                                                    c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10,
                                                           0, 9, 9, 9, 9, 9, 9)
                                                assert t110230_x27(text1=23002900, flag41=0, mode24=1)
                                                Goto('L0')
                                            else:
                                                """State 59"""
                                            ...
                                            if ((GetEventStatus(71120425) == 1 or GetEventStatus(71120429)
                                                ...
                                                def WhilePaused():
                                                    c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10,
                                                           0, 9, 9, 9, 9, 9, 9)
                                                assert t110230_x27(text1=23101500, flag41=0, mode24=1)
                                                Goto('L0')
                        elif call.Done():
                            pass
                elif call.Done():
...
def t110230_x1(goods8=9010, goods2=2503, z1=1100, goods3=9560, goods4=3000, goods5=4400, z2=9550):
    ...
    while True:
        ...
        if GetTalkListEntryResult() == 10:
            ...
            """State 7,17"""
            assert t110230_x4(goods4=goods4, goods5=goods5, z5=30, mode19=0)
            ...
            """State 8,19"""
            assert t110230_x6(mode25=0, flag42=71100435, goods3=goods3)
        elif GetTalkListEntryResult() == 5:
            """State 12,18"""
            assert t110230_x5(mode8=0, flag14=71100432, flag15=71100433)
    ...
    while True:
        ...
        if not GetEventStatus(1272):
            ...
            if GetTalkListEntryResult() == 50:
                ...
                def WhilePaused():
                    c1_117(1740000, -1)
                assert t110230_x11(mode13=0, flag24=71100420, flag25=71110190)
            elif GetTalkListEntryResult() == 51:
                """State 5,17"""
                def WhilePaused():
                    c1_117(1740000, -1)
                assert t110230_x12(mode12=0, flag22=71100421, flag23=71110191)
            elif GetTalkListEntryResult() == 52:
                """State 6,18"""
                def WhilePaused():
                    c1_117(1740000, -1)
                assert t110230_x13(mode11=0, flag20=71110192, flag21=71100422)
            elif GetTalkListEntryResult() == 53:
                """State 7,19"""
                def WhilePaused():
                    c1_117(1740000, -1)
                assert t110230_x14(mode10=0, flag18=71110193, flag19=71100423)
            elif not (CheckSpecificPersonMenuIsOpen(-1, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0)):
                """State 8"""
                break
            """State 21"""
            ...
            assert t110230_x27(text1=23002700, flag41=0, mode24=1)
            break
    """State 22"""
    return 0
...
def t110230_x3():
    ...
    assert t110230_x26(text2=23110000, flag17=71110185, flag43=0, mode26=1)
    """State 2"""
    return 0

def t110230_x4(goods4=3000, goods5=4400, z5=30, mode19=_):
    """State 0,15"""
    if not mode19:
        """State 16,1"""
            ...
            if ComparePlayerInventoryNumber(3, goods5, 4, 1, 0) == 1:
                ...
                if call.Done() and GetGenericDialogButtonResult() == 1:
                    ...
                    if not GetEventStatus(71110186):
                        ...
                        assert t110230_x27(text1=23110100, flag41=0, mode24=1)
                    else:
                        """State 12"""
                        pass
                    """State 7"""
                    ...
                    if not GetEventStatus(71110186):
                        ...
                        assert t110230_x26(text2=23110150, flag17=71110186, flag43=0, mode26=1)
                        """State 18"""
                        Label('L1')
...
def t110230_x5(mode8=_, flag14=71100432, flag15=71100433):
    """State 0,1"""
    if not mode8:
        """State 2,13"""
        if not GetEventStatus(71110158):
            ...
            assert t110230_x27(text1=23111400, flag41=0, mode24=1)
        else:
            """State 17"""
            # talk:23101800:"So in order for the Purification to be possible..."
            assert t110230_x27(text1=23101800, flag41=0, mode24=1)
        """State 4"""
        ClearTalkListData()
        """State 5"""
        ...
        if GetTalkListEntryResult() == 1:
            ...
            """State 16"""
            # talk:23111500:"........."
            assert t110230_x26(text2=23111500, flag17=71110158, flag43=0, mode26=1)
        elif not (CheckSpecificPersonMenuIsOpen(-1, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0)):
            """State 12"""
            pass
    else:
...
def t110230_x6(mode25=_, flag42=71100435, goods3=9560):
    """State 0,1"""
    if not mode25:
        """State 2,4"""
    ...
    assert t110230_x26(text2=23111000, flag17=71100400, flag43=0, mode26=1)
    """State 7"""
...
def t110230_x7():
    ...
    if not GetEventStatus(71110180):
        ...
        assert t110230_x26(text2=23110200, flag17=71110180, flag43=0, mode26=1)
    else:
        """State 10"""
        if not GetEventStatus(71110173):
            """State 11,26"""
            # talk:23110300:"So... it's not a birthmark..."
            assert t110230_x26(text2=23110300, flag17=71110173, flag43=0, mode26=1)
        else:
            """State 12"""
            if not GetEventStatus(71110720):
                """State 27"""
                # talk:23110400:"I still don't understand the particulars, but... "
                assert t110230_x26(text2=23110400, flag17=71110720, flag43=0, mode26=1)
            else:
                """State 13"""
                if GetEventStatus(8250) == 1 and not GetEventStatus(71110721):
                    """State 28"""
                    # talk:23110600:"This power... it comes from Lord Kuro's..."
                    assert t110230_x26(text2=23110600, flag17=71110721, flag43=0, mode26=1)
                else:
                    """State 6"""
                    if GetEventStatus(70003299) == 1 and not GetEventStatus(71110722) and not GetEventStatus(71110152):
                        ...
                        assert t110230_x26(text2=23110800, flag17=71110722, flag43=0, mode26=1)
                    else:
                        """State 5"""
                        if GetEventStatus(71110152) == 1 and not GetEventStatus(71110723) and not GetEventStatus(71100400):
                            ...
                            assert t110230_x26(text2=23110900, flag17=71110723, flag43=0, mode26=1)
                        else:
                            """State 4"""
                            if (GetEventStatus(71100400) == 1 and not GetEventStatus(71110724) and not
                                ...
                                assert t110230_x26(text2=23111100, flag17=71110724, flag43=0, mode26=1)
                            else:
                                """State 3"""
                                if GetEventStatus(71100401) == 1 and not GetEventStatus(71110725):
                                    ...
                                    assert t110230_x26(text2=23111300, flag17=71110725, flag43=0, mode26=1)
                                else:
                                    """State 21"""
                                    if GetEventStatus(71100402) == 1 and not GetEventStatus(71110726):
                                        ...
                                        if GetEventStatus(71110189) == 1:
                                            ...
                                            assert t110230_x27(text1=23112300, flag41=0, mode24=1)
                                        elif GetEventStatus(71100402) == 1:
                                            """State 8,24"""
                                            # talk:23112200:"Lord Kuro is..."
                                            assert t110230_x27(text1=23112200, flag41=0, mode24=1)
                                        elif GetEventStatus(9303) == 1:
                                            """State 9,25"""
                                            # talk:23112400:"Master Wolf..."
                                            assert t110230_x27(text1=23112400, flag41=0, mode24=1)
                                        elif GetEventStatus(71100401) == 1:
                                            """State 17,36"""
                                            # talk:23111300:"There was a Dragonrot epidemic in Ashina once before."
                                            assert t110230_x27(text1=23111300, flag41=0, mode24=1)
                                        elif GetEventStatus(71100400) == 1:
                                            """State 16,37"""
                                            # talk:23111100:"I can now continue my research on the Dragonrot with the blood sample you gave me. "
                                            assert t110230_x27(text1=23111100, flag41=0, mode24=1)
                                        elif GetEventStatus(71110152) == 1:
                                            """State 15,38"""
                                            # talk:23110900:"For my research..."
                                            assert t110230_x27(text1=23110900, flag41=0, mode24=1)
                                        elif GetEventStatus(70003299) == 1:
                                            """State 14,39"""
                                            # talk:23110800:"There must be a way to treat the Dragonrot."
                                            assert t110230_x27(text1=23110800, flag41=0, mode24=1)
                                        elif GetEventStatus(8250) == 1:
                                            """State 19,33"""
                                            # talk:23110600:"This power... it comes from Lord Kuro's..."
                                            assert t110230_x27(text1=23110600, flag41=0, mode24=1)
                                        else:
                                            """State 20,34"""
                                            # talk:23110400:"I still don't understand the particulars, but... "
                                            assert t110230_x27(text1=23110400, flag41=0, mode24=1)
    """State 40"""
    return 0
...
def t110230_x8():
    ...
    assert t110230_x26(text2=23010600, flag17=71110179, flag43=0, mode26=1)
    """State 3"""
    assert t110230_x28(lot1=62320)
    """State 1"""
    SetEventState(70004002, 1)
...
def t110230_x9():
    ...
    if not GetEventStatus(71110188):
        ...
        if ((ComparePlayerInventoryNumber(0, 211000, 2, 0, 0) == 1 or ComparePlayerInventoryNumber(0,
            ...
            assert t110230_x26(text2=23002500, flag17=71110188, flag43=0, mode26=1)
    else:
        """State 2,6"""
        # talk:23002600:"The item that Lord Isshin entrusted me with..."
        assert t110230_x27(text1=23002600, flag41=0, mode24=1)
    """State 8"""
    return 0
...
def t110230_x10(goods8=9010, goods2=2503):
    ...
    if GetEventStatus(1272) == 1:
        ...
        if GetEventStatus(11120110) == 1:
            ...
            assert t110230_x27(text1=23120100, flag41=0, mode24=1)
        else:
            """State 14"""
            # goods:2503:Aromatic Flower
            if ComparePlayerInventoryNumber(3, 2503, 2, 0, 0) == 1:
                ...
                assert t110230_x27(text1=23020100, flag41=0, mode24=1)
            else:
                """State 24"""
                # talk:23020000:"Please, go to Lord Kuro."
                assert t110230_x27(text1=23020000, flag41=0, mode24=1)
    else:
        """State 12,5"""
        if GetEventStatus(70002000) == 1 and not GetEventStatus(50006234):
            ...
            if (not GetEventStatus(132) and ComparePlayerInventoryNumber(3, goods8, 2, 0, 0) == 1 and
                ...
                if GetEventStatus(71100155) == 1:
                    ...
                    assert t110230_x27(text1=23120300, flag41=0, mode24=1)
                else:
                    """State 4,18"""
                    # talk:23120350:"Oh...?  Did I hear the ringing of a chime?"
                    assert t110230_x27(text1=23120350, flag41=0, mode24=1)
            else:
                """State 7"""
                if GetEventStatus(71100402) == 1:
                    """State 8,20"""
                    # talk:23120500:"Goodbye... Master Wolf."
                    assert t110230_x27(text1=23120500, flag41=0, mode24=1)
                elif GetEventStatus(9303) == 1:
                    """State 9,21"""
                    # talk:23120400:"Goodbye."
                    assert t110230_x27(text1=23120400, flag41=0, mode24=1)
                else:
                    """State 10,22"""
                    # talk:23120000:"Goodbye."
                    assert t110230_x27(text1=23120000, flag41=0, mode24=1)
    """State 26"""
    return 0

def t110230_x11(mode13=_, flag24=71100420, flag25=71110190):
    """State 0,3"""
    if not mode13:
        """State 5,15"""
        ...
        if call.Get() == 0:
            ...
            if not GetEventStatus(9303):
                ...
                if ComparePlayerInventoryNumber(3, 9100, 2, 0, 0) == 1:
                    ...
                    """State 13"""
                    # goods:9100:Ashina Sake
                    assert t110230_x54(goods9=9100, goods10=9100, mode14=1)
                    """State 14"""
                    Label('L0')
                    # talk:23111800:"I brought sake."
                    assert t110230_x27(text1=23111800, flag41=0, mode24=1)
                    """State 2"""
            ...
            assert t110230_x27(text1=23111700, flag41=0, mode24=1)
        elif call.Done():
            """State 9"""
            pass
    else:
...
def t110230_x12(mode12=_, flag22=71100421, flag23=71110191):
    """State 0,3"""
    if not mode12:
        """State 5,12"""
        ...
        if call.Get() == 0:
            ...
            assert t110230_x54(goods9=9101, goods10=9105, mode14=1)
            """State 11"""
            Label('L0')
            # talk:23111900:"Here, for you."
            assert t110230_x27(text1=23111900, flag41=0, mode24=1)
            """State 2"""
...
def t110230_x13(mode11=_, flag20=71110192, flag21=71100422):
    """State 0,3"""
    if not mode11:
        """State 5,12"""
        ...
        if call.Get() == 0:
            ...
            assert t110230_x54(goods9=9102, goods10=9102, mode14=1)
            """State 11"""
            Label('L0')
            # talk:23112000:"Here."
            assert t110230_x27(text1=23112000, flag41=0, mode24=1)
            """State 2"""
...
def t110230_x14(mode10=_, flag18=71110193, flag19=71100423):
    """State 0,3"""
    if not mode10:
        """State 5,12"""
        ...
        if call.Get() == 0:
            ...
            assert t110230_x54(goods9=9103, goods10=9103, mode14=1)
            """State 11"""
            Label('L0')
            # talk:23112100:"Have some sake."
            assert t110230_x27(text1=23112100, flag41=0, mode24=1)
            """State 2"""
...
def t110230_x15(mode23=_, flag39=71110703, flag40=71110704, z6=23100300):
    """State 0,1"""
    if not mode23:
        """State 3,6"""
        MainBonfireMenuFlag()
        ...
        if GetTalkListEntryResult() == 1:
            ...
            if GetEventStatus(71100505) == 1:
                ...
                assert t110230_x27(text1=23010000, flag41=0, mode24=1)
                """State 15"""
                Label('L1')
                ...
                assert t110230_x27(text1=23010010, flag41=0, mode24=1)
                Goto('L1')
        elif GetTalkListEntryResult() == 2:
            """State 10,13"""
            Label('L2')
            ...
            if GetEventStatus(71100505) == 1:
                ...
                assert t110230_x27(text1=23010100, flag41=0, mode24=1)
                Goto('L1')
            else:
                """State 19,23"""
                # talk:23010150:"Understood."
                assert t110230_x27(text1=23010150, flag41=0, mode24=1)
                Goto('L1')
        elif not (CheckSpecificPersonMenuIsOpen(-1, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0)):
            """State 11"""
            pass
...
def t110230_x16(goods7=2502, flag34=71100444, mode20=_):
    """State 0,3"""
    if not mode20:
        """State 4,18"""
        # talk:23001400:"Master Wolf..."
        assert t110230_x27(text1=23001400, flag41=0, mode24=1)
        """State 2"""
    ...
    if not GetEventStatus(71110085):
        ...
        if ComparePlayerInventoryNumber(3, goods7, 2, 0, 0) == 1:
            ...
            assert t110230_x27(text1=23001410, flag41=0, mode24=1)
            """State 16"""
            SetEventState(71110169, 1)
        else:
            """State 12,21"""
            # talk:23001460:"Purification?"
            assert t110230_x27(text1=23001460, flag41=0, mode24=1)
        """State 15"""
        ...
        if ComparePlayerInventoryNumber(3, goods7, 2, 0, 0) == 1:
            ...
            assert t110230_x27(text1=23009000, flag41=0, mode24=1)
            """State 17"""
            SetEventState(71110169, 1)
        else:
            """State 14,23"""
            # talk:23009050:"Purification?"
            assert t110230_x27(text1=23009050, flag41=0, mode24=1)
    """State 8"""
...
def t110230_x17(mode22=_, flag37=71100442, flag38=71100443):
    """State 0,1"""
    if not mode22:
        """State 3,18"""
        # talk:23001300:"Are you sure the Divine Heir knows..."
        assert t110230_x27(text1=23001300, flag41=0, mode24=1)
        """State 6"""
        MainBonfireMenuFlag()
        """State 5"""
        ClearTalkListData()
        ...
        if GetTalkListEntryResult() == 1:
            ...
            assert t110230_x27(text1=23010400, flag41=0, mode24=1)
            """State 15"""
            ...
            """State 17"""
            # talk:23010500:"........."
            assert t110230_x27(text1=23010500, flag41=0, mode24=1)
        elif not (CheckSpecificPersonMenuIsOpen(-1, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0)):
            """State 11,21"""
            return 2
    else:
...
def t110230_x18(mode21=_, flag35=71100440, flag36=71100441):
    """State 0,1"""
    if not mode21:
        """State 3,19"""
        # talk:23003100:""I must do, what must be done...""
        assert t110230_x27(text1=23003100, flag41=0, mode24=1)
        """State 6"""
        MainBonfireMenuFlag()
        """State 5"""
        ClearTalkListData()
        ...
        if GetTalkListEntryResult() == 1:
            ...
            assert t110230_x27(text1=23010700, flag41=0, mode24=1)
            """State 15"""
            SetEventState(71100402, 1)
        elif GetTalkListEntryResult() == 2:
            """State 10,13"""
            ...
            assert t110230_x27(text1=23010800, flag41=0, mode24=1)
        elif not (CheckSpecificPersonMenuIsOpen(-1, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0)):
            """State 11,22"""
            return 2
    else:
...
def t110230_x19(goods8=9010, goods2=2503, z1=1100, goods3=9560, goods4=3000, goods5=4400, z2=9550, goods6=9011,
    ...
    if call.Get() == 1:
        ...
        if not GetEventStatus(71110177) and GetEventStatus(70003299) == 1:
            ...
            def WhilePaused():
                c5_120(GetCurrentStateElapsedTime() > 0.5, 2, 10, 0, 9, 9, 9, 9, 9, 9)
            assert t110230_x27(text1=23100700, flag41=0, mode24=1)
            """State 9"""
            ...
            if GetEventStatus(62) == 1 and not GetEventStatus(71110176) and not GetEventStatus(70003299):
                """State 13"""
                # talk:23100600:"Hmm...?"
                assert t110230_x26(text2=23100600, flag17=71110176, flag43=0, mode26=1)
            else:
                """State 2"""
                if not GetEventStatus(71110179) and GetEventStatus(71100401) == 1:
                    """State 3,17"""
                    ...
                    if not GetEventStatus(71110174) and GetEventStatus(71100147) == 1:
                        ...
                        if not GetEventStatus(71100575):
                            ...
                            assert t110230_x26(text2=23101490, flag17=71110174, flag43=0, mode26=1)
                            """State 20"""
...
def t110230_x20(goods1=9010, goods2=2503, z1=1100, goods3=9560, goods4=3000, goods5=4400, z2=9550):
    ...
    if (not GetEventStatus(1272) and not GetEventStatus(1265) and not GetEventStatus(1261) and not GetEventStatus(1268)
        ...
        """State 10"""
        call = t110230_x11(mode13=1, flag24=71100420, flag25=71110190)
        def WhilePaused():
            c1_117(1740000, -1)
        if call.Get() == 1:
            """State 11"""
            call = t110230_x12(mode12=1, flag22=71100421, flag23=71110191)
            def WhilePaused():
                c1_117(1740000, -1)
            if call.Get() == 1:
                """State 12"""
                call = t110230_x13(mode11=1, flag20=71110192, flag21=71100422)
                def WhilePaused():
                    c1_117(1740000, -1)
                if call.Get() == 1:
                    """State 13"""
                    call = t110230_x14(mode10=1, flag18=71110193, flag19=71100423)
                    def WhilePaused():
                        c1_117(1740000, -1)
                    if call.Get() == 1:
                        """State 3"""
                        ...
                        if GetEventStatus(1268) == 1:
                            ...
                            if call.Get() == 1:
                                """State 8"""
                                call = t110230_x5(mode8=1, flag14=71100432, flag15=71100433)
                                if call.Get() == 1:
                                    pass
                                elif call.Done():
                                    Goto('L1')
                            ...
                            pass
                        """State 5,7"""
                        call = t110230_x4(goods4=goods4, goods5=goods5, z5=30, mode19=1)
                        if call.Get() == 1:
                            """State 9"""
                            call = t110230_x6(mode25=1, flag42=71100435, goods3=goods3)
                            if call.Get() == 1:
                                """State 16"""
                                return 1
                            elif call.Done():
...
def t110230_x21(goods7=2502):
    """State 0,1"""
    call = t110230_x16(goods7=goods7, flag34=71100444, mode20=1)
    if call.Get() == 1:
        """State 2"""
        # talk:23002820:"There is something I'd like to ask...", talk:23002880:"This was written by Lord Takeru?"
        ...
        if call.Get() == 1:
            ...
            if call.Get() == 1:
                """State 4"""
                call = t110230_x18(mode21=1, flag35=71100440, flag36=71100441)
                if call.Get() == 1:
                    """State 5"""
                    call = t110230_x17(mode22=1, flag37=71100442, flag38=71100443)
                    if call.Get() == 1:
                        """State 6"""
                        return 0
                    elif call.Done():
...
def t110230_x23(actionbutton1=7002301, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
                actionbutton2=0, flag5=6000, val6=1000000, val7=1000000, val8=1000000, val9=1000000,
                val10=1000000):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t110230_x56(actionbutton1=actionbutton1, flag6=flag6, flag10=flag10, flag11=flag11, flag12=flag12,
...
def t110230_x26(text2=_, flag17=_, flag43=0, mode26=1):
    """State 0,7"""
...
def t110230_x27(text1=_, flag41=0, mode24=1):
    """State 0,6"""
    assert t110230_x25() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag41:
...
def t110230_x30(flag1=1279, flag2=1275, flag3=1276, val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t110230_x31(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag4=flag4, actionbutton1=actionbutton1,
...
def t110230_x31(val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001, actionbutton1=7002301, flag5=6000,
    ...
    while True:
        """State 4"""
        call = t110230_x48(actionbutton1=actionbutton1, flag5=flag5, flag6=flag6, val6=val6, val7=val7,
...
def t110230_x40():
    """State 0,1"""
    assert t110230_x42(z4=1101, mode15=0, mode16=0, mode17=0, mode18=0)
    """State 2"""
    return 0
...
def t110230_x41(mode2=0, mode4=1):
    ...
    if f116(10000) == 1:
        ...
        assert t110230_x42(z4=1000, mode15=0, mode16=0, mode17=0, mode18=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t110230_x42(z4=_, mode15=0, mode16=0, mode17=0, mode18=0):
    """State 0,4"""
    if f118(z4) == 1:
        """State 2"""
        assert GetCurrentStateElapsedFrames() > 1
...
def t110230_x43():
    """State 0,1"""
    call = t110230_x42(z4=1103, mode15=0, mode16=0, mode17=0, mode18=0)
    if call.Get() == 1:
        """State 2"""
        assert t110230_x24()
    elif call.Get() == 0:
...
def t110230_x44():
    """State 0,2"""
    call = t110230_x42(z4=1102, mode15=0, mode16=0, mode17=0, mode18=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t110230_x45():
    """State 0,1"""
    assert t110230_x42(z4=1001, mode15=0, mode16=0, mode17=0, mode18=0)
    """State 2"""
    return 0
...
def t110230_x47():
    """State 0,1"""
    assert t110230_x42(z4=1100, mode15=0, mode16=0, mode17=0, mode18=0)
    """State 2"""
    return 0

def t110230_x48(actionbutton1=7002301, flag5=6000, flag6=6001, val6=1000000, val7=1000000, val8=1000000,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t110230_x42(z4=2000, mode15=0, mode16=0, mode17=0, mode18=0)
    if call.Get() == 1:
        """State 2"""
        assert (t110230_x23(actionbutton1=actionbutton1, flag6=flag6, flag10=6000, flag11=6000, flag12=6000,
...
def t110230_x50():
    """State 0,1"""
    assert t110230_x42(z4=1002, mode15=0, mode16=0, mode17=0, mode18=0)
    """State 2"""
    return 0
...
def t110230_x54(goods9=_, goods10=_, mode14=1):
    """State 0,2"""
    if mode14 == 1:
        """State 3"""
        Label('L0')
...
def t110230_x55(text1=_, text2=_, lot1=_, flag16=_, flag17=_, mode9=_):
    """State 0,3"""
    if not mode9:
        """State 4,8"""
        assert t110230_x27(text1=text1, flag41=0, mode24=1)
        """State 2"""
        ...
        if GetEventStatus(flag16) == 1 and not GetEventStatus(flag17):
            ...
            return 1
    """State 1,9"""
    assert t110230_x26(text2=text2, flag17=flag17, flag43=0, mode26=1)
    """State 11"""
    return 0

def t110230_x56(actionbutton1=7002301, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
