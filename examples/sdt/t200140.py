...
def t200140_1():
    ...
    t200140_x7(flag9=1399, flag10=1395, flag11=1396, val1=5, val2=10, val3=12, val4=10, val5=12, flag12=6001,
               actionbutton1=7001401, flag13=6000, flag14=6001, flag15=6000, flag16=6000, mode1=1, val6=1000000,
...
def t200140_1001():
    ...
    assert t200140_x5(text5=14160500, flag22=1, mode11=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()
...
def t200140_1102():
    ...
    if not GetEventStatus(71110343):
        ...
        assert t200140_x4(text14=14160400, z6=71110343, flag23=1, mode12=1)
    else:
        """State 4"""
        pass
    """State 1"""
...
def t200140_1103():
    ...
    assert t200140_x5(text5=14160600, flag22=1, mode11=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()
...
def t200140_2000():
    ...
    while True:
        """State 4"""
        call = t200140_x0(actionbutton1=7001401, flag14=6001, flag18=6000, flag19=6000, flag20=6000,
        ...
        Quit()
    """State 3"""
    SetEventStateIf(not GetEventStatus(70002045), 72000207, 1)
    Goto('L0')

def t200140_x0(actionbutton1=7001401, flag14=6001, flag18=6000, flag19=6000, flag20=6000, flag21=6000,
               actionbutton2=0, flag13=6000, val6=1000000, val7=1000000, val8=1000000, val9=1000000,
               val10=1000000):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t200140_x28(actionbutton1=actionbutton1, flag14=flag14, flag18=flag18, flag19=flag19,
...
def t200140_x3(text1=_, flag1=_, flag24=1, mode13=1):
    """State 0,7"""
...
def t200140_x4(text14=_, z6=_, flag23=_, mode12=1):
    """State 0,7"""
    assert t200140_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 5"""
    if not flag23:
...
def t200140_x5(text5=_, flag22=_, mode11=1):
    """State 0,6"""
    assert t200140_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag22:
...
def t200140_x7(flag9=1399, flag10=1395, flag11=1396, val1=5, val2=10, val3=12, val4=10, val5=12, flag12=6001,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t200140_x8(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag12=flag12, actionbutton1=actionbutton1,
...
def t200140_x8(val1=5, val2=10, val3=12, val4=10, val5=12, flag12=6001, actionbutton1=7001401, flag13=6000,
    ...
    while True:
        """State 4"""
        call = t200140_x25(actionbutton1=actionbutton1, flag13=flag13, flag14=flag14, val6=val6, val7=val7,
...
def t200140_x17():
    """State 0,1"""
    assert t200140_x19(z5=1101, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t200140_x18(mode2=1, mode4=0):
    ...
    if f116(10000) == 1:
        ...
        assert t200140_x19(z5=1000, mode7=0, mode8=0, mode9=0, mode10=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t200140_x19(z5=_, mode7=0, mode8=0, mode9=0, mode10=0):
    """State 0,4"""
    if f118(z5) == 1:
        """State 2"""
...
def t200140_x20():
    """State 0,1"""
    call = t200140_x19(z5=1103, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert t200140_x1()
    elif call.Get() == 0:
...
def t200140_x21():
    """State 0,2"""
    call = t200140_x19(z5=1102, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t200140_x22():
    """State 0,1"""
    assert t200140_x19(z5=1001, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t200140_x24():
    """State 0,1"""
    assert t200140_x19(z5=1100, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t200140_x25(actionbutton1=7001401, flag13=6000, flag14=6001, val6=1000000, val7=1000000, val8=1000000,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t200140_x19(z5=2000, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert (t200140_x0(actionbutton1=actionbutton1, flag14=flag14, flag18=6000, flag19=6000, flag20=6000,
...
def t200140_x27():
    """State 0,1"""
    assert t200140_x19(z5=1002, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t200140_x28(actionbutton1=7001401, flag14=6001, flag18=6000, flag19=6000, flag20=6000, flag21=6000,
...
def t200140_x29(text5=14901000, text6=14901010, text7=14901050, text8=14901150, text9=14901300, text10=14901310,
    ...
    if GetEventStatus(flag7) == 1:
        ...
        if not GetEventStatus(50006990):
            ...
            Label('L0')
            """State 57"""
            assert t200140_x5(text5=text9, flag22=0, mode11=1)
            """State 48"""
            ...
            Label('L1')
            """State 63"""
            assert t200140_x5(text5=text10, flag22=0, mode11=1)
            """State 23"""
                ...
                if GetEventStatus(flag5) == 1:
                    ...
                    if not GetEventStatus(flag6):
                        ...
                        if not GetEventStatus(70004000):
                            """State 3,55"""
                            assert t200140_x5(text5=text5, flag22=0, mode11=1)
                        else:
                            """State 4,56"""
                            assert t200140_x5(text5=text6, flag22=0, mode11=1)
                    else:
                        """State 52,64"""
                        assert t200140_x5(text5=text7, flag22=0, mode11=1)
                    """State 51"""
    ...
    # goods:9502:Rot Essence: Black Hat
    ...
    """State 59"""
    Label('L12')
    assert t200140_x5(text5=text12, flag22=0, mode11=1)
    Goto('L6')
    """State 60"""
    Label('L13')
    assert t200140_x5(text5=text11, flag22=0, mode11=1)
    Goto('L9')
    """State 61"""
    Label('L14')
    assert t200140_x5(text5=text8, flag22=0, mode11=1)
    Goto('L4')
    """State 62"""
    Label('L15')
    assert t200140_x5(text5=text13, flag22=0, mode11=1)
    Goto('L11')
...
def t200140_x30(text1=14160000, flag1=71110346, text2=14160100, flag2=71110347, text3=_, flag3=71110348,
    ...
    if not text1 == -1 and not GetEventStatus(flag1):
        """State 4"""
        assert t200140_x3(text1=text1, flag1=flag1, flag24=1, mode13=1)
    elif not text2 == -1 and not GetEventStatus(flag2):
        """State 5"""
        assert t200140_x3(text1=text2, flag1=flag2, flag24=1, mode13=1)
    elif not text3 == -1 and not GetEventStatus(flag3):
        """State 6"""
        assert t200140_x3(text1=text3, flag1=flag3, flag24=1, mode13=1)
    else:
        """State 7"""
        assert t200140_x3(text1=text4, flag1=flag4, flag24=1, mode13=1)
    """State 8"""
    return 0
...
def t200140_x31():
    ...
    if not GetEventStatus(72000202):
        ...
        assert t200140_x4(text14=14200500, z6=72000202, flag23=0, mode12=1)
    else:
        """State 3,5"""
        # talk:14200600:"Well... That takes care of my business here. I owe you one."
        assert t200140_x5(text5=14200600, flag22=0, mode11=1)
    """State 6"""
    return 0
...
def t200140_x32():
    ...
    if GetEventStatus(72000203) == 1:
        ...
        """State 35"""
        # talk:14210000:"........."
        assert t200140_x5(text5=14210000, flag22=0, mode11=1)
        """State 20"""
        Label('L1')
        ...
        assert t200140_x5(text5=14210100, flag22=0, mode11=1)
        Goto('L1')
    else:
        """State 1"""
        if GetEventStatus(12000290) == 1:
            ...
            if not GetEventStatus(72000200):
                ...
                if not GetEventStatus(71110300):
                    ...
                    assert t200140_x5(text5=14200070, flag22=0, mode11=1)
                    """State 31"""
                    SetEventState(71110300, 1)
                else:
                    """State 29,41"""
                    # talk:14200060:"Huh? So you made it out this way, too."
                    assert t200140_x5(text5=14200060, flag22=0, mode11=1)
                """State 30"""
                ...
                if not GetEventStatus(72000201):
                    ...
                    assert t200140_x4(text14=14200200, z6=72000201, flag23=0, mode12=1)
                    Goto('L4')
                else:
                    """State 22,38"""
                    # talk:14200300:"Heheh... That Puppeteer Technique of yours really is something."
                    assert t200140_x5(text5=14200300, flag22=0, mode11=1)
                    Goto('L4')
            """State 9"""
            Label('L3')
            SetEventState(72000200, 1)
            ...
            if not GetEventStatus(72000200):
                ...
                if not GetEventStatus(71110300):
                    ...
                    assert t200140_x5(text5=14200030, flag22=0, mode11=1)
                    """State 23"""
                    SetEventState(71110300, 1)
                    Goto('L3')
                else:
                    ...
                    assert t200140_x5(text5=14200000, flag22=0, mode11=1)
                    Goto('L3')
            else:
                """State 6,34"""
                # talk:14200100:"You see over there...?\nI'm tryin to figure a way to get to the other side..."
                assert t200140_x5(text5=14200100, flag22=0, mode11=1)
                """State 11"""
                def ExitPause():
                    MainBonfireMenuFlag()
                """State 10"""
    ...
    """Unused"""
    """State 24,39"""
    # talk:14200400:"Huh...? What're you doing?"
    assert t200140_x5(text5=14200400, flag22=0, mode11=1)
    Goto('L4')
