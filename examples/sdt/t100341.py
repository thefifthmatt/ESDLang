...
def t100341_1():
    ...
    t100341_x6(flag1=1539, flag2=11005801, flag3=6000, val1=5, val2=60, val3=60, val4=10, val5=12, flag4=6001,
               actionbutton1=7001801, flag5=6000, flag6=6001, flag7=6000, flag8=6000, mode1=1, val6=1000000,
...
def t100341_1001():
    ...
    if GetEventStatus(11005802) == 1:
        ...
        assert t100341_x4(text1=34060500, flag14=1, mode7=1)
    else:
        """State 4"""
        pass
    """State 1"""
...
def t100341_1102():
    ...
    while True:
        ...
        assert t100341_x3(text6=34061200, z3=71000253, flag15=1, mode12=1)
        """State 4"""
        Label('L1')
        assert GetCurrentStateElapsedTime() > 1
        """State 6"""
        # talk:34060200:"Now we're having fun, boy...", talk:34060400:"Oh, don't mind me.  I'll be watching from up here."
        call = t100341_x25(text1=34060200, text2=34060400, text3=-1, text4=-1, text5=-1, flag14=1, mode7=1)
        if call.Done():
            """State 3"""
    ...
    assert t100341_x4(text1=34060300, flag14=1, mode7=1)
    Goto('L0')
    """Unused"""
    """State 1"""
    def WhilePaused():
    ...
    Quit()
    """State 5"""
    # talk:34061250:"In that case..."
    call = t100341_x3(text6=34061250, z3=71000253, flag15=1, mode12=1)
    assert DoesSelfHaveSpEffect(5038) == 1
    """State 8"""
    # talk:34061270:"Lose yourself in my illusions."
    assert t100341_x4(text1=34061270, flag14=1, mode7=1)
    Goto('L1')
...
def t100341_1103():
    ...
    call = t100341_x4(text1=34061100, flag14=1, mode7=1)
    assert DoesSelfHaveSpEffect(30004) == 1
    """State 5"""
    # talk:34061300:"You've...gotten stronger...Wolf..."
    assert t100341_x4(text1=34061300, flag14=1, mode7=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()

def t100341_x0(actionbutton1=7001801, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
               actionbutton2=0, flag5=6000, val6=1000000, val7=1000000, val8=1000000, val9=1000000, val10=1000000):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t100341_x28(actionbutton1=actionbutton1, flag6=flag6, flag10=flag10, flag11=flag11, flag12=flag12,
...
def t100341_x3(text6=_, z3=71000253, flag15=1, mode12=1):
    """State 0,7"""
...
def t100341_x4(text1=_, flag14=1, mode7=1):
    """State 0,6"""
    assert t100341_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag14:
...
def t100341_x6(flag1=1539, flag2=11005801, flag3=6000, val1=5, val2=60, val3=60, val4=10, val5=12, flag4=6001,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t100341_x7(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag4=flag4, actionbutton1=actionbutton1,
...
def t100341_x7(val1=5, val2=60, val3=60, val4=10, val5=12, flag4=6001, actionbutton1=7001801, flag5=6000,
    ...
    while True:
        """State 4"""
        call = t100341_x24(actionbutton1=actionbutton1, flag5=flag5, flag6=flag6, val6=val6, val7=val7,
...
def t100341_x16():
    """State 0,1"""
    assert t100341_x18(z1=1101, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0
...
def t100341_x17(mode2=1, mode4=0):
    ...
    if f116(10000) == 1:
        ...
        assert t100341_x18(z1=1000, mode8=0, mode9=0, mode10=0, mode11=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t100341_x18(z1=_, mode8=0, mode9=0, mode10=0, mode11=0):
    """State 0,4"""
    if f118(z1) == 1:
        """State 2"""
...
def t100341_x19():
    """State 0,1"""
    call = t100341_x18(z1=1103, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """State 2"""
        assert t100341_x1()
    elif call.Get() == 0:
...
def t100341_x20():
    """State 0,2"""
    call = t100341_x18(z1=1102, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t100341_x21():
    """State 0,1"""
    assert t100341_x18(z1=1001, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0
...
def t100341_x23():
    """State 0,1"""
    assert t100341_x18(z1=1100, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0

def t100341_x24(actionbutton1=7001801, flag5=6000, flag6=6001, val6=1000000, val7=1000000, val8=1000000,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t100341_x18(z1=2000, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """State 2"""
        assert (t100341_x0(actionbutton1=actionbutton1, flag6=flag6, flag10=6000, flag11=6000, flag12=6000,
...
def t100341_x25(text1=34060200, text2=34060400, text3=-1, text4=-1, text5=-1, flag14=1, mode7=1):
    """State 0,3"""
    if not text5 == -1:
        """State 4,17"""
        ...
        if call.Done() and CompareRNGValue(0, 0) == 1:
            ...
            Label('L0')
            """State 13"""
            assert t100341_x4(text1=text1, flag14=flag14, mode7=mode7)
        elif call.Done() and CompareRNGValue(0, 1) == 1:
            """State 9"""
            Label('L1')
            """State 18"""
            assert t100341_x4(text1=text2, flag14=flag14, mode7=mode7)
        elif call.Done() and CompareRNGValue(0, 2) == 1:
            """State 10"""
            Label('L2')
            """State 19"""
            assert t100341_x4(text1=text3, flag14=flag14, mode7=mode7)
        elif call.Done() and CompareRNGValue(0, 3) == 1:
            """State 11"""
            Label('L3')
            """State 20"""
            assert t100341_x4(text1=text4, flag14=flag14, mode7=mode7)
        elif call.Done():
            """State 12,21"""
            assert t100341_x4(text1=text5, flag14=flag14, mode7=mode7)
    elif not text4 == -1:
        """State 5,16"""
...
def t100341_x27():
    """State 0,1"""
    assert t100341_x18(z1=1002, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0

def t100341_x28(actionbutton1=7001801, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
