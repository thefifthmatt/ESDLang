...
def t111290_x3():
    """State 0,1"""
    # talk:29030400:"    "
    assert t111290_x13(text1=29030400, flag21=1, mode12=1)
    """State 2"""
    return 0
...
def t111290_x5():
    ...
    if f116(10000) == 1:
        ...
        assert t111290_x6(mode11=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t111290_x6(mode11=_):
    """State 0,11"""
    if mode11 == 1:
        """State 13"""
        if GetEventStatus(71110136) == 1:
            ...
            if not GetEventStatus(50006290):
                ...
                assert t111290_x13(text1=29001100, flag21=0, mode12=1)
                """State 26"""
                ...
                if not GetEventStatus(50006291) and GetEventStatus(71110137) == 1:
                    ...
                    assert t111290_x13(text1=29001201, flag21=0, mode12=1)
                    """State 25"""
                    Label('L2')
                    ...
                    if not GetEventStatus(50006292) and GetEventStatus(71110138) == 1:
                        ...
                        assert t111290_x13(text1=29001301, flag21=0, mode12=1)
                        """State 24"""
                        Label('L4')
                        ...
                        assert t111290_x13(text1=29001350, flag21=0, mode12=1)
                        Goto('L9')
                    else:
                        Goto('L9')
                else:
            ...
            if not GetEventStatus(50006291):
                ...
                assert t111290_x13(text1=29001200, flag21=0, mode12=1)
                Goto('L2')
            elif GetEventStatus(71110138) == 1 and not GetEventStatus(50006292):
                Goto('L3')
            elif GetEventStatus(71110138) == 1 and GetEventStatus(50006292) == 1:
            ...
            if not GetEventStatus(50006292):
                ...
                assert t111290_x13(text1=29001300, flag21=0, mode12=1)
                Goto('L4')
            else:
                Goto('L5')
            ...
            assert t111290_x13(text1=29001400, flag21=0, mode12=1)
            Goto('L9')
        else:
            pass
        """State 18"""
...
def t111290_x8(actionbutton1=7002900, flag10=6001, flag14=6000, flag15=6000, flag16=6000, flag17=6000,
               actionbutton2=0, flag9=6000, val6=1000000, val7=1000000, val8=1000000, val9=1000000, val10=1000000):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t111290_x37(actionbutton1=actionbutton1, flag10=flag10, flag14=flag14, flag15=flag15,
...
def t111290_x11(text10=_, flag18=_, flag23=1, mode14=1):
    """State 0,7"""
...
def t111290_x12(text14=_, z6=_, flag22=0, mode13=1):
    """State 0,7"""
    assert t111290_x10() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 5"""
    if not flag22:
...
def t111290_x13(text1=_, flag21=_, mode12=1):
    """State 0,6"""
    assert t111290_x10() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag21:
...
def t111290_x15(flag5=1379, flag6=1375, flag7=1376, val1=5, val2=10, val3=12, val4=10, val5=12, flag8=6000,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t111290_x16(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag8=flag8, actionbutton1=actionbutton1,
...
def t111290_x16(val1=5, val2=10, val3=12, val4=10, val5=12, flag8=6000, actionbutton1=7002900, flag9=6000,
    ...
    while True:
        """State 4"""
        call = t111290_x33(actionbutton1=actionbutton1, flag9=flag9, flag10=flag10, val6=val6, val7=val7,
...
def t111290_x25():
    """State 0,1"""
    assert t111290_x27(z5=1101, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t111290_x26(mode2=1, mode4=0):
    ...
    if f116(10000) == 1:
        ...
        assert t111290_x27(z5=1000, mode7=0, mode8=0, mode9=0, mode10=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t111290_x27(z5=_, mode7=0, mode8=0, mode9=0, mode10=0):
    """State 0,4"""
    if f118(z5) == 1:
        """State 2"""
...
def t111290_x28():
    """State 0,1"""
    call = t111290_x27(z5=1103, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert t111290_x9()
    elif call.Get() == 0:
...
def t111290_x29():
    """State 0,2"""
    call = t111290_x27(z5=1102, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t111290_x30():
    """State 0,1"""
    assert t111290_x27(z5=1001, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t111290_x32():
    """State 0,1"""
    assert t111290_x27(z5=1100, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t111290_x33(actionbutton1=7002900, flag9=6000, flag10=6001, val6=1000000, val7=1000000, val8=1000000,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t111290_x27(z5=2000, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert (t111290_x8(actionbutton1=actionbutton1, flag10=flag10, flag14=6000, flag15=6000, flag16=6000,
...
def t111290_x34(text10=29030000, flag18=71110140, text11=29030100, flag19=71110141, text12=29030200,
    ...
    if not text10 == -1 and not GetEventStatus(flag18):
        """State 3"""
        assert t111290_x11(text10=text10, flag18=flag18, flag23=1, mode14=1)
    elif not text11 == -1 and not GetEventStatus(flag19):
        """State 4"""
        assert t111290_x11(text10=text11, flag18=flag19, flag23=1, mode14=1)
    elif not text12 == -1 and not GetEventStatus(flag20):
        """State 5"""
        assert t111290_x11(text10=text12, flag18=flag20, flag23=1, mode14=1)
    else:
        """State 2"""
        ...
        """State 6"""
        assert t111290_x13(text1=text13, flag21=1, mode12=1)
    """State 7"""
    return 0
...
def t111290_x36():
    """State 0,1"""
    assert t111290_x27(z5=1002, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t111290_x37(actionbutton1=7002900, flag10=6001, flag14=6000, flag15=6000, flag16=6000, flag17=6000,
...
def t111290_x38(text1=29900000, text2=29900100, text3=29900150, text4=29910003, text5=29900700, text6=29900750,
    ...
    if GetEventStatus(flag3) == 1:
        ...
        if not GetEventStatus(50006990):
            ...
            Label('L0')
            """State 57"""
            assert t111290_x13(text1=text5, flag21=0, mode12=1)
            """State 48"""
            ...
            Label('L1')
            """State 63"""
            assert t111290_x13(text1=text6, flag21=0, mode12=1)
            """State 23"""
                ...
                if GetEventStatus(flag1) == 1:
                    ...
                    if not GetEventStatus(flag2):
                        ...
                        if not GetEventStatus(70004000):
                            """State 3,55"""
                            assert t111290_x13(text1=text1, flag21=0, mode12=1)
                        else:
                            """State 4,56"""
                            assert t111290_x13(text1=text2, flag21=0, mode12=1)
                    else:
                        """State 52,64"""
                        assert t111290_x13(text1=text3, flag21=0, mode12=1)
                    """State 51"""
    ...
    """State 59"""
    Label('L12')
    assert t111290_x13(text1=text8, flag21=0, mode12=1)
    Goto('L6')
    """State 60"""
    Label('L13')
    assert t111290_x13(text1=text7, flag21=0, mode12=1)
    Goto('L9')
    """State 61"""
    Label('L14')
    assert t111290_x13(text1=text4, flag21=0, mode12=1)
    Goto('L4')
    """State 62"""
    Label('L15')
    assert t111290_x13(text1=text9, flag21=0, mode12=1)
    Goto('L11')
