...
def t100200_1():
    ...
    t100200_x6(flag1=1319, flag2=1315, flag3=1316, val1=12, val2=10, val3=12, val4=10, val5=12, flag4=6001,
               actionbutton1=7002000, flag5=6000, flag6=6001, flag7=6000, flag8=6000, mode1=1, val6=1000000,
...
def t100200_1000():
    ...
    if GetEventStatus(50006200) == 1 and not GetEventStatus(71000301):
        ...
        if not GetEventStatus(50006200):
            ...
            assert t100200_x4(text1=20000100, flag16=0, mode12=1)
    """State 4"""
    def WhilePaused():
        c1_119(0)
    Quit()

def t100200_x0(actionbutton1=7002000, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
               actionbutton2=0, flag5=6000, val6=1000000, val7=1000000, val8=1000000, val9=1000000, val10=1000000):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t100200_x28(actionbutton1=actionbutton1, flag6=flag6, flag10=flag10, flag11=flag11, flag12=flag12,
...
def t100200_x3(text2=20000010, flag15=71000301, flag17=0, mode13=1):
    """State 0,7"""
...
def t100200_x4(text1=_, flag16=0, mode12=1):
    """State 0,6"""
    assert t100200_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag16:
...
def t100200_x6(flag1=1319, flag2=1315, flag3=1316, val1=12, val2=10, val3=12, val4=10, val5=12, flag4=6001,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t100200_x7(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag4=flag4, actionbutton1=actionbutton1,
...
def t100200_x7(val1=12, val2=10, val3=12, val4=10, val5=12, flag4=6001, actionbutton1=7002000, flag5=6000,
    ...
    while True:
        """State 4"""
        call = t100200_x24(actionbutton1=actionbutton1, flag5=flag5, flag6=flag6, val6=val6, val7=val7,
...
def t100200_x16():
    """State 0,1"""
    assert t100200_x18(z1=1101, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0
...
def t100200_x17(mode2=1, mode4=0):
    ...
    if f116(10000) == 1:
        ...
        assert t100200_x18(z1=1000, mode8=0, mode9=0, mode10=0, mode11=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t100200_x18(z1=_, mode8=0, mode9=0, mode10=0, mode11=0):
    """State 0,4"""
    if f118(z1) == 1:
        """State 2"""
...
def t100200_x19():
    """State 0,1"""
    call = t100200_x18(z1=1103, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """State 2"""
        assert t100200_x1()
    elif call.Get() == 0:
...
def t100200_x20():
    """State 0,2"""
    call = t100200_x18(z1=1102, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t100200_x21():
    """State 0,1"""
    assert t100200_x18(z1=1001, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0
...
def t100200_x23():
    """State 0,1"""
    assert t100200_x18(z1=1100, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0

def t100200_x24(actionbutton1=7002000, flag5=6000, flag6=6001, val6=1000000, val7=1000000, val8=1000000,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t100200_x18(z1=2000, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """State 2"""
        assert (t100200_x0(actionbutton1=actionbutton1, flag6=flag6, flag10=6000, flag11=6000, flag12=6000,
...
def t100200_x26():
    """State 0,1"""
    assert t100200_x18(z1=1002, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0

def t100200_x27(text1=20000001, text2=20000010, lot1=62000, flag14=71000300, flag15=71000301, mode7=_):
    """State 0,3"""
    if not mode7:
        """State 4,8"""
        assert t100200_x4(text1=text1, flag16=0, mode12=1)
        """State 2"""
        ...
        if GetEventStatus(flag14) == 1 and not GetEventStatus(flag15):
            ...
            return 1
    """State 1,9"""
    assert t100200_x3(text2=text2, flag15=flag15, flag17=0, mode13=1)
    """State 11"""
    return 0

def t100200_x28(actionbutton1=7002000, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
