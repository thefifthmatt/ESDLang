...
def t111140_1():
    ...
    t111140_x8(flag11=1399, flag12=1395, flag13=1396, val1=5, val2=10, val3=12, val4=10, val5=12, flag14=6001,
               actionbutton1=7001400, flag15=6000, flag16=6001, flag17=6000, flag18=6000, mode4=1, val6=1000000,
               val7=1000000, val8=1000000, mode5=1, mode6=1, mode7=0, val9=1000000, val10=1000000, mode8=0,
...
def t111140_1000():
    ...
    if GetEventStatus(1380) == 1:
        """State 4"""
        def WhilePaused():
            c5_117(GetEventStatus(70002045) == 1, 1136002, -1)
        assert t111140_x38()
...
def t111140_1001():
    ...
    assert t111140_x6(text5=14160500, flag24=1, mode15=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()
...
def t111140_1102():
    ...
    if not GetEventStatus(71110343):
        ...
        assert t111140_x4(text1=14160400, flag1=71110343, flag26=1, mode17=1)
        """State 1"""
        def WhilePaused():
            c1_119(0)
        Quit()
...
def t111140_1103():
    ...
    if GetEventStatus(71110309) == 1:
        ...
        assert t111140_x6(text5=14160600, flag24=1, mode15=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()
...
def t111140_2000():
    ...
    while True:
        """State 3"""
        call = t111140_x1(actionbutton1=7001400, flag16=6001, flag20=6000, flag21=6000, flag22=6000,
                          flag23=6000, actionbutton2=0, flag15=71110309, val6=1000000, val7=1000000,
                          val8=1000000, val9=1000000, val10=1000000)
        if call.Done():
            break
        ...
        Quit()
    """State 2"""
    SetEventStateIf(not GetEventStatus(70002045) and GetEventStatus(71110300) == 1, 72000206, 1)
    Goto('L0')
...
def t111140_x1(actionbutton1=7001400, flag16=6001, flag20=6000, flag21=6000, flag22=6000, flag23=6000,
               actionbutton2=0, flag15=_, val6=1000000, val7=1000000, val8=1000000, val9=1000000, val10=1000000):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t111140_x31(actionbutton1=actionbutton1, flag16=flag16, flag20=flag20, flag21=flag21,
...
def t111140_x4(text1=_, flag1=_, flag26=1, mode17=1):
    """State 0,7"""
...
def t111140_x5(text15=_, z12=_, flag25=0, mode16=1):
    """State 0,7"""
    assert t111140_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 5"""
    if not flag25:
...
def t111140_x6(text5=_, flag24=_, mode15=1):
    """State 0,6"""
    assert t111140_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag24:
...
def t111140_x8(flag11=1399, flag12=1395, flag13=1396, val1=5, val2=10, val3=12, val4=10, val5=12, flag14=6001,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t111140_x9(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag14=flag14, actionbutton1=actionbutton1,
                          flag15=flag15, flag16=flag16, flag17=flag17, flag18=flag18, mode4=mode4, val6=val6,
...
def t111140_x9(val1=5, val2=10, val3=12, val4=10, val5=12, flag14=6001, actionbutton1=7001400, flag15=6000,
               flag16=6001, flag17=6000, flag18=6000, mode4=1, val6=1000000, val7=1000000, val8=1000000,
               mode5=1, mode6=1, mode7=0, val9=1000000, val10=1000000, mode8=0, mode9=0):
    """State 0"""
    while True:
        """State 4"""
        call = t111140_x26(actionbutton1=actionbutton1, flag15=flag15, flag16=flag16, val6=val6, val7=val7,
...
def t111140_x18():
    """State 0,1"""
    assert t111140_x20(z11=1101, mode11=0, mode12=0, mode13=0, mode14=0)
    """State 2"""
    return 0
...
def t111140_x19(mode5=1, mode7=0):
    ...
    if f116(10000) == 1:
        ...
        assert t111140_x20(z11=1000, mode11=0, mode12=0, mode13=0, mode14=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t111140_x20(z11=_, mode11=0, mode12=0, mode13=0, mode14=0):
    """State 0,4"""
    if f118(z11) == 1:
        """State 2"""
...
def t111140_x21():
    """State 0,1"""
    call = t111140_x20(z11=1103, mode11=0, mode12=0, mode13=0, mode14=0)
    if call.Get() == 1:
        """State 2"""
        assert t111140_x2()
    elif call.Get() == 0:
...
def t111140_x22():
    """State 0,2"""
    call = t111140_x20(z11=1102, mode11=0, mode12=0, mode13=0, mode14=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t111140_x23():
    """State 0,1"""
    assert t111140_x20(z11=1001, mode11=0, mode12=0, mode13=0, mode14=0)
    """State 2"""
    return 0
...
def t111140_x25():
    """State 0,1"""
    assert t111140_x20(z11=1100, mode11=0, mode12=0, mode13=0, mode14=0)
    """State 2"""
    return 0

def t111140_x26(actionbutton1=7001400, flag15=6000, flag16=6001, val6=1000000, val7=1000000, val8=1000000,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t111140_x20(z11=2000, mode11=0, mode12=0, mode13=0, mode14=0)
    if call.Get() == 1:
        """State 2"""
        assert (t111140_x1(actionbutton1=actionbutton1, flag16=flag16, flag20=6000, flag21=6000, flag22=6000,
...
def t111140_x27(z9=-1, z10=1136001, val11=1136001, mode10=1, val12=5):
    """State 0,1"""
    def WhilePaused():
        c1_117(z10, z9)
    if f116(z9) == val11 and mode10 == 1:
        """State 2"""
        return 0
...
def t111140_x29():
    """State 0,1"""
    assert t111140_x20(z11=1002, mode11=0, mode12=0, mode13=0, mode14=0)
    """State 2"""
    return 0
...
def t111140_x31(actionbutton1=7001400, flag16=6001, flag20=6000, flag21=6000, flag22=6000, flag23=6000,
                actionbutton2=0, flag15=_):
    """State 0"""
    while Loop('mainloop'):
        """State 1"""
...
def t111140_x32(text10=14901000, text11=14901010, text12=14901050, text13=14901150, text14=14901400,
    ...
    if not GetEventStatus(flag10):
        ...
        if not GetEventStatus(70004000):
            """State 3,13"""
            assert t111140_x6(text5=text10, flag24=0, mode15=1)
        else:
            """State 4,14"""
            assert t111140_x6(text5=text11, flag24=0, mode15=1)
    else:
        """State 11,5,17"""
        assert t111140_x6(text5=text12, flag24=0, mode15=1)
    """State 12"""
    Label('L0')
    ...
    """State 15"""
    Label('L3')
    assert t111140_x6(text5=text13, flag24=0, mode15=1)
    Goto('L0')
    """State 16"""
    Label('L4')
    assert t111140_x6(text5=text14, flag24=0, mode15=1)
    Goto('L2')
    """State 19"""
    Label('L5')
    return 1
...
def t111140_x34(text8=14901300, text9=14901310, flag6=71110332, mode3=_):
    ...
    if mode3 == 1:
        ...
        """State 2,7"""
        assert t111140_x6(text5=text8, flag24=0, mode15=1)
        """State 4"""
        SetEventState(flag6, 1)
        """State 8"""
        assert t111140_x7(lot1=69900)
    """State 5,9"""
    assert t111140_x6(text5=text9, flag24=0, mode15=1)
    """State 6"""
...
def t111140_x35(text6=14901200, text7=14901100, z1=71110331, z2=71110330, z3=71110333, mode2=_, z4=9502):
    ...
    if ComparePlayerInventoryNumber(3, 9550, 0, 0, 0) == 1:
        ...
        if call.Get() == 0:
            ...
            SetEventState(z2, 1)
            """State 4,15"""
            assert t111140_x6(text5=text7, flag24=0, mode15=1)
            """State 10"""
            SetEventState(z2, 0)
        elif call.Done():
            """State 11"""
            SetEventState(z1, 1)
            """State 12,16"""
            assert t111140_x6(text5=text6, flag24=0, mode15=1)
            """State 13"""
            SetEventState(z1, 0)
    """State 17"""
    return 0
...
def t111140_x36(text5=14900200, flag5=70002045):
    ...
    if GetEventStatus(flag5) == 1:
        """State 3,4"""
        assert t111140_x6(text5=text5, flag24=0, mode15=1)
        """State 5"""
        return 0
    else:
        """State 2,6"""
...
def t111140_x37(text1=14160000, flag1=71110346, text2=14160100, flag2=71110347, text3=_, flag3=71110348,
    ...
    if not text1 == -1 and not GetEventStatus(flag1):
        """State 4"""
        assert t111140_x4(text1=text1, flag1=flag1, flag26=1, mode17=1)
    elif not text2 == -1 and not GetEventStatus(flag2):
        """State 5"""
        assert t111140_x4(text1=text2, flag1=flag2, flag26=1, mode17=1)
    elif not text3 == -1 and not GetEventStatus(flag3):
        """State 6"""
        assert t111140_x4(text1=text3, flag1=flag3, flag26=1, mode17=1)
    else:
        """State 7"""
        assert t111140_x4(text1=text4, flag1=flag4, flag26=1, mode17=1)
    """State 8"""
    return 0
            ...
            if call.Get() == 1:
                ...
                if call.Get() == 2:
                    ...
                    if GetEventStatus(71110312) == 1:
                        ...
                        assert t111140_x5(text15=14120500, z12=71110308, flag25=0, mode16=1)
                        """State 3"""
...
def t111140_x39(mode1=_):
    ...
    if mode1 == 1:
        ...
        if GetEventStatus(71110306) == 1:
            ...
            assert t111140_x6(text5=14110220, flag24=0, mode15=1)
        elif GetEventStatus(71110307) == 1:
            """State 9"""
            Label('L1')
            """State 18"""
            # talk:14110210:"I hadn't heard."
            assert t111140_x6(text5=14110210, flag24=0, mode15=1)
        else:
            """State 22"""
            return 2
    else:
        ...
        if not GetEventStatus(71111500):
            ...
            assert t111140_x6(text5=14110100, flag24=0, mode15=1)
        else:
            """State 3,17"""
            # talk:14110200:"Heheh. You hear about this one?"
            assert t111140_x6(text5=14110200, flag24=0, mode15=1)
            """State 5"""
            ClearTalkListData()
            """State 6"""
...
def t111140_x40():
    ...
    """State 12"""
    # talk:14901200:".........", talk:14901100:"Drink..."
    assert (t111140_x35(text6=14901200, text7=14901100, z1=71110331, z2=71110330, z3=71110333, mode2=0,
            z4=9502))
    Goto('L0')
...
def t111140_x41():
    ...
    def WhilePaused():
        c1_117(1136000, -1)
    assert t111140_x5(text15=14100600, z12=71110309, flag25=0, mode16=1)
    """State 2"""
    assert t111140_x27(z9=-1, z10=1136001, val11=1136001, mode10=1, val12=5)
    """State 3"""
    return 0
...
def t111140_x42():
    ...
    if GetEventStatus(71110308) == 1:
        ...
        assert t111140_x6(text5=14100500, flag24=0, mode15=1)
    else:
        """State 4"""
        if not GetEventStatus(71110300):
            """State 1,8"""
            # talk:14100200:"... Told those morons to give it a rest."
            assert t111140_x5(text15=14100200, z12=71110300, flag25=0, mode16=1)
        elif not GetEventStatus(71110301):
            """State 3,10"""
            # talk:14100300:"Heheh... This here dive ain't half bad."
            assert t111140_x5(text15=14100300, z12=71110301, flag25=0, mode16=1)
        else:
            """State 2,7"""
            # talk:14100400:"Ohh, well look who it is."
            assert t111140_x6(text5=14100400, flag24=0, mode15=1)
    """State 11"""
    return 0
...
def t111140_x43():
    ...
    if GetEventStatus(71111500) == 1 and GetEventStatus(71110200) == 1:
        ...
        if not GetEventStatus(71110308):
            ...
            assert t111140_x6(text5=14120600, flag24=0, mode15=1)
    else:
        """State 3"""
        if not GetEventStatus(71110302):
            """State 4,10"""
            # talk:14120300:"Well, I'll be here.  Raking in the profits."
            assert t111140_x5(text15=14120300, z12=71110302, flag25=0, mode16=1)
        else:
            """State 5,11"""
            # talk:14120400:"So long."
            assert t111140_x6(text5=14120400, flag24=0, mode15=1)
    """State 14"""
    return 0
