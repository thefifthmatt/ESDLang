...
def t111002_x2(gesture1=17, z2=9019, flag3=6067):
    """State 0,1"""
...
def t111002_x3(actionbutton1=_, flag1=6001, flag2=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t111002_x7():
    ...
    if CompareBonfireLevel(5, 0) == 1:
        ...
        """State 17"""
        Label('L1')
        assert t111002_x3(actionbutton1=6101, flag1=6001, flag2=6000)
        """State 13"""
        ...
        """State 3,18"""
        call = t111002_x3(actionbutton1=6100, flag1=6001, flag2=6000)
        if call.Done():
            """State 5"""
            ClearPlayerDamageInfo()
            """State 6"""
...
def t111002_x11():
    ...
    Goto('L0')
    """State 32"""
    t111002_x2(gesture1=17, z2=9019, flag3=6067)
    Quit()
    """State 33"""
    Label('L6')
    # action:10010780:"You need to rest in order to select Recovery Tools.\nDo you want to rest?"
    call = t111002_x0(action3=10010780)
    if call.Get() == 0:
        Goto('L4')
    elif call.Get() == 1:
        Goto('L5')
