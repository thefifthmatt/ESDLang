...
def t100121_1():
    ...
    t100121_x6(flag1=1259, flag2=11005901, flag3=11005743, val1=65, val2=60, val3=65, val4=60, val5=65,
               flag4=6000, actionbutton1=7001201, flag5=6000, flag6=6001, flag7=6000, flag8=6000, mode1=1,
               val6=1000000, val7=1506000, val8=1000000, mode2=1, mode3=1, mode4=0, val9=1000000, val10=1000000,
...
def t100121_1001():
    ...
    assert t100121_x5(text1=12030500, flag14=1, mode11=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()
...
def t100121_1102():
    ...
    while True:
        ...
        if GetEventStatus(11005743) == 1 and not GetEventStatus(71000134):
            ...
            assert t100121_x3(text3=12160900, z3=71000134, flag16=1, mode13=1)
            continue
        ...
        assert t100121_x3(text3=12030200, z3=71000132, flag16=1, mode13=1)
    """Unused"""
    """State 1"""
    def WhilePaused():
        c1_119(0)
...
def t100121_1103():
    ...
    assert t100121_x3(text3=12030400, z3=71000133, flag16=1, mode13=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()
...
def t100121_2000():
    ...
    while True:
        """State 2"""
        call = t100121_x0(actionbutton1=7001202, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
                          actionbutton2=0, flag5=11005901, val6=1000000, val7=1000000, val8=1000000,
                          val9=-1, val10=-1)
        if call.Done():
            break
        elif not GetEventStatus(71000136):
            """State 3"""
            call = t100121_x0(actionbutton1=7001204, flag6=6001, flag10=6000, flag11=6000, flag12=6000,
                              flag13=6000, actionbutton2=0, flag5=11005901, val6=1000000, val7=1000000,
...
def t100121_x0(actionbutton1=_, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000, actionbutton2=0,
               flag5=_, val6=1000000, val7=_, val8=1000000, val9=_, val10=_):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t100121_x27(actionbutton1=actionbutton1, flag6=flag6, flag10=flag10, flag11=flag11, flag12=flag12,
...
def t100121_x3(text3=_, z3=_, flag16=1, mode13=1):
    """State 0,7"""
...
def t100121_x4(text2=12030000, z2=71000130, flag15=0, mode12=1):
    """State 0,7"""
    assert t100121_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 5"""
    if not flag15:
...
def t100121_x5(text1=12030500, flag14=1, mode11=1):
    """State 0,6"""
    assert t100121_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag14:
...
def t100121_x6(flag1=1259, flag2=11005901, flag3=11005743, val1=65, val2=60, val3=65, val4=60, val5=65,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t100121_x7(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag4=flag4, actionbutton1=actionbutton1,
...
def t100121_x7(val1=65, val2=60, val3=65, val4=60, val5=65, flag4=6000, actionbutton1=7001201, flag5=6000,
               flag6=6001, flag7=6000, flag8=6000, mode1=1, val6=1000000, val7=1506000, val8=1000000,
               mode2=1, mode3=1, mode4=0, val9=1000000, val10=1000000, mode5=0, mode6=0):
    """State 0"""
    while True:
        """State 4"""
        call = t100121_x24(actionbutton1=actionbutton1, flag5=flag5, flag6=flag6, val6=val6, val7=val7,
...
def t100121_x16():
    """State 0,1"""
    assert t100121_x18(z1=1101, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t100121_x17(mode2=1, mode4=0):
    ...
    if f116(10000) == 1:
        ...
        assert t100121_x18(z1=1000, mode7=0, mode8=0, mode9=0, mode10=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t100121_x18(z1=_, mode7=0, mode8=0, mode9=0, mode10=0):
    """State 0,4"""
    if f118(z1) == 1:
        """State 2"""
...
def t100121_x19():
    """State 0,1"""
    call = t100121_x18(z1=1103, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert t100121_x1()
    elif call.Get() == 0:
...
def t100121_x20():
    """State 0,2"""
    call = t100121_x18(z1=1102, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t100121_x21():
    """State 0,1"""
    assert t100121_x18(z1=1001, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t100121_x23():
    """State 0,1"""
    assert t100121_x18(z1=1100, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t100121_x24(actionbutton1=7001201, flag5=6000, flag6=6001, val6=1000000, val7=1506000, val8=1000000,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t100121_x18(z1=2000, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert (t100121_x0(actionbutton1=actionbutton1, flag6=flag6, flag10=6000, flag11=6000, flag12=6000,
...
def t100121_x26():
    """State 0,1"""
    assert t100121_x18(z1=1002, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t100121_x27(actionbutton1=_, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000, actionbutton2=0,
                flag5=_):
    """State 0"""
    while Loop('mainloop'):
        """State 1"""
...
def t100121_x28():
    ...
    assert t100121_x4(text2=12030000, z2=71000130, flag15=0, mode12=1)
    """State 2"""
    return 0
...
def t100121_x29():
    ...
    if not f120() - f121():
        """State 2"""
        # talk:12030100:"Hmm..."
        call = t100121_x3(text3=12030100, z3=71000131, flag16=1, mode13=1)
        if call.Done():
            pass
        elif f120() - f121() == 1:
            """State 4"""
