...
def t111120_1():
    ...
    t111120_x6(flag1=1359, flag2=11115851, flag3=6000, val1=5, val2=40, val3=45, val4=10, val5=12, flag4=6001,
               actionbutton1=7001200, flag5=6000, flag6=6001, flag7=6000, flag8=6000, mode2=1, val6=1000000,
               val7=1506002, val8=1506004, mode3=1, mode4=1, mode5=0, val9=1000000, val10=1000000, mode6=0,
               flag9=6000, mode7=0)
    Quit()
...
def t111120_1001():
    ...
    if DoesSelfHaveSpEffect(3506080) == 1:
        ...
        call = t111120_x5(text1=12130500, flag14=1, mode13=1)
        if call.Done():
            pass
...
def t111120_1002():
    ...
    if DoesSelfHaveSpEffect(3506080) == 1:
        ...
        if not GetEventStatus(71110032):
            """State 3,8"""
            # talk:12130200:"One...!"
            call = t111120_x3(text3=12130200, z5=71110032, flag16=1, mode15=1)
            if call.Done():
                pass
            elif DoesSelfHaveSpEffect(3506080) == 1:
                """State 11"""
            ...
            """State 4,9"""
            # talk:12130300:"Two...!"
            call = t111120_x3(text3=12130300, z5=71110033, flag16=1, mode15=1)
            if call.Done():
                pass
            elif DoesSelfHaveSpEffect(3506080) == 1:
                Goto('L0')
            ...
            """State 5,10"""
            # talk:12130400:"Three...!"
            call = t111120_x3(text3=12130400, z5=71110034, flag16=1, mode15=1)
            if call.Done():
                pass
            elif DoesSelfHaveSpEffect(3506080) == 1:
                Goto('L0')
...
def t111120_1103():
    ...
    assert t111120_x5(text1=12161000, flag14=1, mode13=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()
...
def t111120_2000():
    """State 0,6"""
    assert (t111120_x0(actionbutton1=7001200, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
            actionbutton2=0, flag5=6000, val6=1000000, val7=1506002, val8=1506004, val9=-1, val10=-1))
    """State 3"""
    if (not GetEventStatus(8300) and not GetEventStatus(71110049) and not GetEventStatus(71110006) and
        ...
        """State 7"""
        assert t111120_x25(z1=-1, z2=1506003, val11=1506003, mode8=1, val12=3)
    elif f116(-1) == 1000000:
        """State 2"""
...
def t111120_x0(actionbutton1=7001200, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
               actionbutton2=0, flag5=6000, val6=1000000, val7=1506002, val8=1506004, val9=_, val10=_):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t111120_x28(actionbutton1=actionbutton1, flag6=flag6, flag10=flag10, flag11=flag11, flag12=flag12,
...
def t111120_x3(text3=_, z5=_, flag16=1, mode15=1):
    """State 0,7"""
...
def t111120_x4(text2=_, z4=_, flag15=0, mode14=1):
    """State 0,7"""
    assert t111120_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 5"""
    if not flag15:
...
def t111120_x5(text1=_, flag14=_, mode13=1):
    """State 0,6"""
    assert t111120_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag14:
...
def t111120_x6(flag1=1359, flag2=11115851, flag3=6000, val1=5, val2=40, val3=45, val4=10, val5=12, flag4=6001,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t111120_x7(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag4=flag4, actionbutton1=actionbutton1,
                          flag5=flag5, flag6=flag6, flag7=flag7, flag8=flag8, mode2=mode2, val6=val6,
...
def t111120_x7(val1=5, val2=40, val3=45, val4=10, val5=12, flag4=6001, actionbutton1=7001200, flag5=6000,
               flag6=6001, flag7=6000, flag8=6000, mode2=1, val6=1000000, val7=1506002, val8=1506004,
               mode3=1, mode4=1, mode5=0, val9=1000000, val10=1000000, mode6=0, mode7=0):
    """State 0"""
    while True:
        """State 4"""
        call = t111120_x24(actionbutton1=actionbutton1, flag5=flag5, flag6=flag6, val6=val6, val7=val7,
...
def t111120_x16():
    """State 0,1"""
    assert t111120_x18(z3=1101, mode9=0, mode10=0, mode11=0, mode12=0)
    """State 2"""
    return 0
...
def t111120_x17(mode3=1, mode5=0):
    ...
    if f116(10000) == 1:
        ...
        assert t111120_x18(z3=1000, mode9=0, mode10=0, mode11=0, mode12=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t111120_x18(z3=_, mode9=0, mode10=0, mode11=0, mode12=0):
    """State 0,4"""
    if f118(z3) == 1:
        """State 2"""
...
def t111120_x19():
    """State 0,1"""
    call = t111120_x18(z3=1103, mode9=0, mode10=0, mode11=0, mode12=0)
    if call.Get() == 1:
        """State 2"""
        assert t111120_x1()
    elif call.Get() == 0:
...
def t111120_x20():
    """State 0,2"""
    call = t111120_x18(z3=1102, mode9=0, mode10=0, mode11=0, mode12=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t111120_x21():
    """State 0,1"""
    assert t111120_x18(z3=1001, mode9=0, mode10=0, mode11=0, mode12=0)
    """State 2"""
    return 0
...
def t111120_x23():
    """State 0,1"""
    assert t111120_x18(z3=1100, mode9=0, mode10=0, mode11=0, mode12=0)
    """State 2"""
    return 0

def t111120_x24(actionbutton1=7001200, flag5=6000, flag6=6001, val6=1000000, val7=1506002, val8=1506004,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t111120_x18(z3=2000, mode9=0, mode10=0, mode11=0, mode12=0)
    if call.Get() == 1:
        """State 2"""
        assert (t111120_x0(actionbutton1=actionbutton1, flag6=flag6, flag10=6000, flag11=6000, flag12=6000,
...
def t111120_x25(z1=-1, z2=1506003, val11=1506003, mode8=1, val12=3):
    """State 0,1"""
    def WhilePaused():
        c1_117(z2, z1)
    if f116(z1) == val11 and mode8 == 1:
        """State 2"""
        return 0
...
def t111120_x27():
    """State 0,1"""
    assert t111120_x18(z3=1002, mode9=0, mode10=0, mode11=0, mode12=0)
    """State 2"""
    return 0

def t111120_x28(actionbutton1=7001200, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
...
def t111120_x29(mode1=_):
    ...
    if not mode1:
        ...
        if GetTalkListEntryResult() == 1:
            ...
            assert t111120_x5(text1=12100200, flag14=0, mode13=1)
            """State 10"""
            MainBonfireMenuFlag()
            ClearTalkListData()
            """State 8"""
            ...
            if GetTalkListEntryResult() == 1:
                ...
                assert t111120_x4(text2=12100500, z4=8300, flag15=0, mode14=1)
                """State 27"""
                ...
                if not f116(-1) == 1506004:
                    ...
                    assert t111120_x4(text2=12100700, z4=71110049, flag15=0, mode14=1)
                else:
                    """State 35"""
                    # talk:12100703:"Ugh..."
                    assert t111120_x4(text2=12100703, z4=71110049, flag15=0, mode14=1)
                """State 28"""
            ...
            if not f116(-1) == 1506004:
                ...
                assert t111120_x4(text2=12100300, z4=71110049, flag15=0, mode14=1)
            else:
                """State 34"""
                # talk:12100303:"Ugh..."
                assert t111120_x4(text2=12100303, z4=71110049, flag15=0, mode14=1)
            """State 29"""
            SetEventState(71110021, 1)
        elif not (CheckSpecificPersonMenuIsOpen(-1, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0)):
            """State 5"""
...
def t111120_x30():
    ...
    while True:
        ...
        if not GetEventStatus(71110030):
            ...
            call = t111120_x3(text3=12130000, z5=71110030, flag16=1, mode15=1)
            if call.Done():
                continue
                ...
                call = t111120_x3(text3=12160000, z5=71110035, flag16=1, mode15=1)
                if call.Done():
                    continue
                    ...
                    assert t111120_x3(text3=12130100, z5=71110031, flag16=1, mode15=1)
                    continue
                elif DoesSelfHaveSpEffect(30005) == 1 and not GetEventStatus(71110037):
                    """State 11"""
                    Label('L2')
                    # talk:12160800:"   "
                    assert t111120_x3(text3=12160800, z5=71110037, flag16=1, mode15=1)
                    continue
        elif DoesSelfHaveSpEffect(30001) == 1 and not GetEventStatus(71110035):
            """State 4"""
            Goto('L0')
        ...
        assert t111120_x3(text3=12160200, z5=71110036, flag16=1, mode15=1)
    """Unused"""
    """State 12"""
    return 0
...
def t111120_x31():
    ...
    if not GetEventStatus(71110049) and not GetEventStatus(8300):
        ...
        if call.Get() == 1:
            ...
            assert t111120_x5(text1=12100000, flag14=0, mode13=1)
            """State 13"""
        ...
        if GetEventStatus(8300) == 1:
            ...
            assert t111120_x4(text2=12100550, z4=71110020, flag15=0, mode14=1)
        else:
            """State 7,16"""
            # talk:12100350:"Unthinkable... such a miserable display."
            assert t111120_x4(text2=12100350, z4=71110021, flag15=0, mode14=1)
    """State 17"""
    return 0
