...
def t110350_1():
    ...
    t110350_x6(flag1=1559, flag2=11105803, flag3=6000, val1=5, val2=65, val3=68, val4=10, val5=12, flag4=6000,
               actionbutton1=-1, flag5=6000, flag6=6000, flag7=6000, flag8=6000, mode1=1, val6=1000000,
...
def t110350_1001():
    ...
    assert t110350_x4(text1=35060600, flag14=1, mode7=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()
...
def t110350_1103():
    ...
    assert t110350_x4(text1=35060700, flag14=1, mode7=1) and DoesSelfHaveSpEffect(30003) == 1
    """State 4"""
    # talk:35060710:"Genichiro... forgive... me..."
    assert t110350_x4(text1=35060710, flag14=1, mode7=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()

def t110350_x0(actionbutton1=-1, flag6=6000, flag10=6000, flag11=6000, flag12=6000, flag13=6000, actionbutton2=0,
               flag5=6000, val6=1000000, val7=1000000, val8=1000000, val9=1000000, val10=1000000):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t110350_x28(actionbutton1=actionbutton1, flag6=flag6, flag10=flag10, flag11=flag11, flag12=flag12,
...
def t110350_x3(text6=_, z3=_, flag15=1, mode12=1):
    """State 0,7"""
...
def t110350_x4(text1=_, flag14=1, mode7=1):
    """State 0,6"""
    assert t110350_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag14:
...
def t110350_x6(flag1=1559, flag2=11105803, flag3=6000, val1=5, val2=65, val3=68, val4=10, val5=12, flag4=6000,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t110350_x7(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag4=flag4, actionbutton1=actionbutton1,
...
def t110350_x7(val1=5, val2=65, val3=68, val4=10, val5=12, flag4=6000, actionbutton1=-1, flag5=6000,
               flag6=6000, flag7=6000, flag8=6000, mode1=1, val6=1000000, val7=1000000, val8=1000000,
               mode2=1, mode3=1, mode4=0, val9=1000000, val10=1000000, mode5=0, mode6=0):
    """State 0"""
    while True:
        """State 4"""
        call = t110350_x24(actionbutton1=actionbutton1, flag5=flag5, flag6=flag6, val6=val6, val7=val7,
...
def t110350_x16():
    """State 0,1"""
    assert t110350_x18(z1=1101, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0
...
def t110350_x17(mode2=1, mode4=0):
    ...
    if f116(10000) == 1:
        ...
        assert t110350_x18(z1=1000, mode8=0, mode9=0, mode10=0, mode11=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t110350_x18(z1=_, mode8=0, mode9=0, mode10=0, mode11=0):
    """State 0,4"""
    if f118(z1) == 1:
        """State 2"""
...
def t110350_x19():
    """State 0,1"""
    call = t110350_x18(z1=1103, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """State 2"""
        assert t110350_x1()
    elif call.Get() == 0:
...
def t110350_x20():
    """State 0,2"""
    call = t110350_x18(z1=1102, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t110350_x21():
    """State 0,1"""
    assert t110350_x18(z1=1001, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0
...
def t110350_x23():
    """State 0,1"""
    assert t110350_x18(z1=1100, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0

def t110350_x24(actionbutton1=-1, flag5=6000, flag6=6000, val6=1000000, val7=1000000, val8=1000000, val9=1000000,
                val10=1000000):
    """State 0,1"""
    call = t110350_x18(z1=2000, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """State 2"""
        assert (t110350_x0(actionbutton1=actionbutton1, flag6=flag6, flag10=6000, flag11=6000, flag12=6000,
...
def t110350_x25(text1=35030200, text2=35030300, text3=-1, text4=-1, text5=-1, flag14=1, mode7=1):
    """State 0,3"""
    if not text5 == -1:
        """State 4,17"""
        ...
        if call.Done() and CompareRNGValue(0, 0) == 1:
            ...
            Label('L0')
            """State 13"""
            assert t110350_x4(text1=text1, flag14=flag14, mode7=mode7)
        elif call.Done() and CompareRNGValue(0, 1) == 1:
            """State 9"""
            Label('L1')
            """State 18"""
            assert t110350_x4(text1=text2, flag14=flag14, mode7=mode7)
        elif call.Done() and CompareRNGValue(0, 2) == 1:
            """State 10"""
            Label('L2')
            """State 19"""
            assert t110350_x4(text1=text3, flag14=flag14, mode7=mode7)
        elif call.Done() and CompareRNGValue(0, 3) == 1:
            """State 11"""
            Label('L3')
            """State 20"""
            assert t110350_x4(text1=text4, flag14=flag14, mode7=mode7)
        elif call.Done():
            """State 12,21"""
            assert t110350_x4(text1=text5, flag14=flag14, mode7=mode7)
    elif not text4 == -1:
        """State 5,16"""
...
def t110350_x27():
    """State 0,1"""
    assert t110350_x18(z1=1002, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0

def t110350_x28(actionbutton1=-1, flag6=6000, flag10=6000, flag11=6000, flag12=6000, flag13=6000, actionbutton2=0,
                flag5=6000):
    """State 0"""
    while Loop('mainloop'):
        """State 1"""
...
def t110350_x29():
    ...
    if not GetEventStatus(71100451):
        ...
        assert t110350_x3(text6=35060800, z3=71100451, flag15=1, mode12=1)
    elif not GetEventStatus(71100452):
        """State 4"""
        # talk:35060100:"Boy, allow me to show you the wrath of a man..."
        assert t110350_x3(text6=35060100, z3=71100452, flag15=1, mode12=1)
    else:
        """State 2"""
        pass
    """State 5"""
...
def t110350_x30():
    ...
    if call.Done():
        ...
        assert t110350_x25(text1=35030200, text2=35030300, text3=-1, text4=-1, text5=-1, flag14=1, mode7=1)
    """State 5"""
    return 0
...
def t110350_x31():
    ...
    call = t110350_x3(text6=35060000, z3=71100450, flag15=1, mode12=1)
    def WhilePaused():
        SetWorkValueIf(DoesSelfHaveSpEffect(30000) == 1, 0, 1)
    if call.Done() and GetWorkValue(0) > 1:
        """State 1"""
        # talk:35060010:"As I breathe, you will not pass the castle gate!"
        assert t110350_x4(text1=35060010, flag14=1, mode7=1)
