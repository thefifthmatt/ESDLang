...
def t111600_1():
    ...
    t111600_x7(actionbutton1=7009100, z1=71118000, text1=60002600)
    Quit()

def t111600_x0(actionbutton1=7009100, flag1=6001, flag2=6001, flag3=6001, flag4=6001, flag5=6001, actionbutton2=0,
               flag6=6000, val1=-1, val2=-1, val3=-1, val4=-1, val5=-1):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t111600_x10(actionbutton1=actionbutton1, flag1=flag1, flag2=flag2, flag3=flag3, flag4=flag4,
...
def t111600_x3(text1=60002600, z1=71118000, flag7=0, mode1=1):
    """State 0,7"""
...
def t111600_x5(actionbutton1=7009100, z1=71118000, text1=60002600):
    """State 0"""
    while True:
        """State 1"""
        call = t111600_x6(actionbutton1=actionbutton1, z1=z1, text1=text1)
        assert not f114(2)
        """State 2"""
...
def t111600_x6(actionbutton1=7009100, z1=71118000, text1=60002600):
    """State 0"""
    while True:
        """State 1,3"""
        assert (t111600_x0(actionbutton1=actionbutton1, flag1=6001, flag2=6001, flag3=6001, flag4=6001,
...
def t111600_x7(actionbutton1=7009100, z1=71118000, text1=60002600):
    """State 0"""
    while True:
        """State 3"""
        ...
        if GetCurrentStateElapsedTime() > 1:
            """State 2"""
            call = t111600_x5(actionbutton1=actionbutton1, z1=z1, text1=text1)
            def WhilePaused():
                c1_116()
...
def t111600_x9(text1=60002600, z1=71118000):
    ...
    if f116(10000) == 10:
        """State 3"""
        call = t111600_x3(text1=text1, z1=z1, flag7=0, mode1=1)
        if call.Done():
            pass
...
def t111600_x10(actionbutton1=7009100, flag1=6001, flag2=6001, flag3=6001, flag4=6001, flag5=6001, actionbutton2=0,
                flag6=6000):
    """State 0"""
    while Loop('mainloop'):
        """State 1"""
