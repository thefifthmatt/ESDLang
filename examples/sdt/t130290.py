...
def t130290_1():
    ...
    t130290_x9(flag1=70009149, flag2=1375, flag3=1376, val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6000,
               actionbutton1=7002904, flag5=6000, flag6=6001, flag7=6000, flag8=6000, mode1=1, val6=1000000,
...
def t130290_x0():
    ...
    assert t130290_x7(text5=29200000, z2=72000110, flag18=0, mode12=1)
    """State 2"""
    return 0
...
def t130290_x2():
    """State 0,1"""
    # talk:29030400:"    "
    assert t130290_x8(text4=29030400, flag17=1, mode11=1)
    """State 2"""
    return 0

def t130290_x3(actionbutton1=7002904, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
               actionbutton2=0, flag5=6000, val6=1000000, val7=1000000, val8=1000000, val9=1000000, val10=1000000):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t130290_x31(actionbutton1=actionbutton1, flag6=flag6, flag10=flag10, flag11=flag11, flag12=flag12,
...
def t130290_x6(text1=_, flag14=_, flag19=1, mode13=1):
    """State 0,7"""
...
def t130290_x7(text5=29200000, z2=72000110, flag18=0, mode12=1):
    """State 0,7"""
    assert t130290_x5() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 5"""
    if not flag18:
...
def t130290_x8(text4=_, flag17=1, mode11=1):
    """State 0,6"""
    assert t130290_x5() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag17:
...
def t130290_x9(flag1=70009149, flag2=1375, flag3=1376, val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6000,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t130290_x10(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag4=flag4, actionbutton1=actionbutton1,
...
def t130290_x10(val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6000, actionbutton1=7002904, flag5=6000,
    ...
    while True:
        """State 4"""
        call = t130290_x27(actionbutton1=actionbutton1, flag5=flag5, flag6=flag6, val6=val6, val7=val7,
...
def t130290_x19():
    """State 0,1"""
    assert t130290_x21(z1=1101, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t130290_x20(mode2=1, mode4=0):
    ...
    if f116(10000) == 1:
        ...
        assert t130290_x21(z1=1000, mode7=0, mode8=0, mode9=0, mode10=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t130290_x21(z1=_, mode7=0, mode8=0, mode9=0, mode10=0):
    """State 0,4"""
    if f118(z1) == 1:
        """State 2"""
...
def t130290_x22():
    """State 0,1"""
    call = t130290_x21(z1=1103, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert t130290_x4()
    elif call.Get() == 0:
...
def t130290_x23():
    """State 0,2"""
    call = t130290_x21(z1=1102, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t130290_x24():
    """State 0,1"""
    assert t130290_x21(z1=1001, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t130290_x26():
    """State 0,1"""
    assert t130290_x21(z1=1100, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t130290_x27(actionbutton1=7002904, flag5=6000, flag6=6001, val6=1000000, val7=1000000, val8=1000000,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t130290_x21(z1=2000, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert (t130290_x3(actionbutton1=actionbutton1, flag6=flag6, flag10=6000, flag11=6000, flag12=6000,
...
def t130290_x28(text1=29030000, flag14=71110140, text2=29030100, flag15=71110141, text3=29030200, flag16=71110142,
    ...
    if not text1 == -1 and not GetEventStatus(flag14):
        """State 3"""
        assert t130290_x6(text1=text1, flag14=flag14, flag19=1, mode13=1)
    elif not text2 == -1 and not GetEventStatus(flag15):
        """State 4"""
        assert t130290_x6(text1=text2, flag14=flag15, flag19=1, mode13=1)
    elif not text3 == -1 and not GetEventStatus(flag16):
        """State 5"""
        assert t130290_x6(text1=text3, flag14=flag16, flag19=1, mode13=1)
    else:
        """State 2"""
        ...
        """State 6"""
        assert t130290_x8(text4=text4, flag17=1, mode11=1)
    """State 7"""
    return 0
...
def t130290_x30():
    """State 0,1"""
    assert t130290_x21(z1=1002, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t130290_x31(actionbutton1=7002904, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
