...
def t110400_1():
    ...
    t110400_x5(flag1=1799, flag2=1795, flag3=1796, val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001,
               actionbutton1=7004000, flag5=6000, flag6=6001, flag7=6000, flag8=6000, mode1=1, val6=1000000,
...
def t110400_2000():
    """State 0,3"""
    assert (t110400_x0(actionbutton1=7004000, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
...
def t110400_x0(actionbutton1=7004000, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
               actionbutton2=0, flag5=6000, val6=1000000, val7=1000000, val8=1000000, val9=1000000, val10=1000000):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t110400_x26(actionbutton1=actionbutton1, flag6=flag6, flag10=flag10, flag11=flag11, flag12=flag12,
...
def t110400_x3(text1=_, z2=_, flag15=0, mode12=1):
    """State 0,7"""
...
def t110400_x4(text3=_, flag14=0, mode11=1):
    """State 0,6"""
    assert t110400_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag14:
...
def t110400_x5(flag1=1799, flag2=1795, flag3=1796, val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t110400_x6(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag4=flag4, actionbutton1=actionbutton1,
...
def t110400_x6(val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001, actionbutton1=7004000, flag5=6000,
    ...
    while True:
        """State 4"""
        call = t110400_x23(actionbutton1=actionbutton1, flag5=flag5, flag6=flag6, val6=val6, val7=val7,
...
def t110400_x15():
    """State 0,1"""
    assert t110400_x17(z1=1101, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t110400_x16(mode2=1, mode4=0):
    ...
    if f116(10000) == 1:
        ...
        assert t110400_x17(z1=1000, mode7=0, mode8=0, mode9=0, mode10=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t110400_x17(z1=_, mode7=0, mode8=0, mode9=0, mode10=0):
    """State 0,4"""
    if f118(z1) == 1:
        """State 2"""
...
def t110400_x18():
    """State 0,1"""
    call = t110400_x17(z1=1103, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert t110400_x1()
    elif call.Get() == 0:
...
def t110400_x19():
    """State 0,2"""
    call = t110400_x17(z1=1102, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t110400_x20():
    """State 0,1"""
    assert t110400_x17(z1=1001, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t110400_x22():
    """State 0,1"""
    assert t110400_x17(z1=1100, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t110400_x23(actionbutton1=7004000, flag5=6000, flag6=6001, val6=1000000, val7=1000000, val8=1000000,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t110400_x17(z1=2000, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert (t110400_x0(actionbutton1=actionbutton1, flag6=flag6, flag10=6000, flag11=6000, flag12=6000,
...
def t110400_x25():
    """State 0,1"""
    assert t110400_x17(z1=1002, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t110400_x26(actionbutton1=7004000, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
...
def t110400_x27():
    ...
    if not GetEventStatus(71100700):
        ...
        assert t110400_x3(text1=40000000, z2=71100700, flag15=0, mode12=1)
    else:
        """State 3"""
        # talk:40000100:"Now then, be gone already."
        assert t110400_x4(text3=40000100, flag14=0, mode11=1)
    """State 4"""
    return 0
...
def t110400_x28():
    ...
    if not GetEventStatus(71100701):
        ...
        assert t110400_x3(text1=40000200, z2=71100701, flag15=0, mode12=1)
    else:
        """State 3"""
        # talk:40000300:"Now then, be gone already."
        assert t110400_x4(text3=40000300, flag14=0, mode11=1)
    """State 4"""
    return 0
...
def t110400_x29():
    ...
    if GetEventStatus(71100700) == 1:
        ...
        if not GetEventStatus(71100702):
            ...
            assert t110400_x3(text1=40000500, z2=71100703, flag15=0, mode12=1)
        else:
            """State 10"""
            # talk:40000600:"Now then, be gone already."
            assert t110400_x4(text3=40000600, flag14=0, mode11=1)
    else:
        """State 3,1"""
        if not GetEventStatus(71100702):
            """State 6"""
...
def t110400_x30(text1=_, text2=_):
    ...
    if GetEventStatus(71100111) == 1:
        """State 2"""
        assert t110400_x3(text1=text1, z2=71100702, flag15=0, mode12=1)
    else:
        """State 3"""
        assert t110400_x3(text1=text2, z2=71100702, flag15=0, mode12=1)
    """State 4"""
    return 0
