...
def t170700_1():
    ...
    t170700_x4(flag1=70009069, flag2=70009065, flag3=70009066, val1=5, val2=10, val3=12, val4=10, val5=12,
               flag4=6001, actionbutton1=7007020, flag5=6000, flag6=6001, flag7=6000, flag8=6000, mode1=1,
               val6=1000000, val7=1000000, val8=1000000, mode2=1, mode3=1, mode4=0, val9=1000000, val10=1000000,
               mode5=0, flag9=71709000, mode6=0)
    Quit()
...
def t170700_1000():
    ...
    def WhilePaused():
        c1_117(1136000, -1)
    assert t170700_x3(text1=70030000, z4=71709000, flag14=0, mode12=1)
    """State 3"""
    assert t170700_x23(z1=-1, z2=1136001, val11=1136001, mode7=1, val12=5)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()

def t170700_x0(actionbutton1=7007020, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
               actionbutton2=0, flag5=6000, val6=1000000, val7=1000000, val8=1000000, val9=1000000, val10=1000000):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t170700_x26(actionbutton1=actionbutton1, flag6=flag6, flag10=flag10, flag11=flag11, flag12=flag12,
...
def t170700_x3(text1=70030000, z4=71709000, flag14=0, mode12=1):
    """State 0,7"""
...
def t170700_x4(flag1=70009069, flag2=70009065, flag3=70009066, val1=5, val2=10, val3=12, val4=10, val5=12,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t170700_x5(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag4=flag4, actionbutton1=actionbutton1,
...
def t170700_x5(val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001, actionbutton1=7007020, flag5=6000,
    ...
    while True:
        """State 4"""
        call = t170700_x22(actionbutton1=actionbutton1, flag5=flag5, flag6=flag6, val6=val6, val7=val7,
...
def t170700_x14():
    """State 0,1"""
    assert t170700_x16(z3=1101, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0
...
def t170700_x15(mode2=1, mode4=0):
    ...
    if f116(10000) == 1:
        ...
        assert t170700_x16(z3=1000, mode8=0, mode9=0, mode10=0, mode11=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t170700_x16(z3=_, mode8=0, mode9=0, mode10=0, mode11=0):
    """State 0,4"""
    if f118(z3) == 1:
        """State 2"""
...
def t170700_x17():
    """State 0,1"""
    call = t170700_x16(z3=1103, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """State 2"""
        assert t170700_x1()
    elif call.Get() == 0:
...
def t170700_x18():
    """State 0,2"""
    call = t170700_x16(z3=1102, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t170700_x19():
    """State 0,1"""
    assert t170700_x16(z3=1001, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0
...
def t170700_x21():
    """State 0,1"""
    assert t170700_x16(z3=1100, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0

def t170700_x22(actionbutton1=7007020, flag5=6000, flag6=6001, val6=1000000, val7=1000000, val8=1000000,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t170700_x16(z3=2000, mode8=0, mode9=0, mode10=0, mode11=0)
    if call.Get() == 1:
        """State 2"""
        assert (t170700_x0(actionbutton1=actionbutton1, flag6=flag6, flag10=6000, flag11=6000, flag12=6000,
...
def t170700_x23(z1=-1, z2=1136001, val11=1136001, mode7=1, val12=5):
    """State 0,1"""
    def WhilePaused():
        c1_117(z2, z1)
...
def t170700_x25():
    """State 0,1"""
    assert t170700_x16(z3=1002, mode8=0, mode9=0, mode10=0, mode11=0)
    """State 2"""
    return 0

def t170700_x26(actionbutton1=7007020, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
