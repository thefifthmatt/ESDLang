...
def t200320_1():
    ...
    t200320_x7(flag1=1499, flag2=1495, flag3=1496, val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001,
               actionbutton1=7003200, flag5=6000, flag6=6001, flag7=6000, flag8=6000, mode2=1, val6=1000000,
               val7=1000000, val8=1000000, mode3=1, mode4=1, mode5=0, val9=1000000, val10=1000000, mode6=0,
               flag9=6000, mode7=0)
    Quit()
        ...
        if call.Get() == 1:
            ...
            if not GetEventStatus(72000052):
                ...
                if not GetEventStatus(72000051) and GetEventStatus(71110100) == 1:
                    ...
                    assert t200320_x5(text1=32000300, flag19=0, mode13=1)
        elif call.Done():
            pass
    else:
        """State 8,12"""
        # talk:32000500:"........."
        assert t200320_x5(text1=32000500, flag19=0, mode13=1)
    """State 1"""
    def WhilePaused():
        c1_119(0)
    Quit()
...
def t200320_x0(actionbutton1=7003200, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
               actionbutton2=0, flag5=6000, val6=1000000, val7=1000000, val8=1000000, val9=1000000, val10=1000000):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t200320_x30(actionbutton1=actionbutton1, flag6=flag6, flag10=flag10, flag11=flag11, flag12=flag12,
...
def t200320_x3(text3=_, flag16=_, flag21=1, mode15=1):
    """State 0,7"""
...
def t200320_x4(text2=32010050, flag15=72000051, flag20=0, mode14=1):
    """State 0,7"""
    assert t200320_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 5"""
    if not flag20:
...
def t200320_x5(text1=_, flag19=_, mode13=1):
    """State 0,6"""
    assert t200320_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag19:
...
def t200320_x7(flag1=1499, flag2=1495, flag3=1496, val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t200320_x8(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag4=flag4, actionbutton1=actionbutton1,
...
def t200320_x8(val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001, actionbutton1=7003200, flag5=6000,
               flag6=6001, flag7=6000, flag8=6000, mode2=1, val6=1000000, val7=1000000, val8=1000000,
               mode3=1, mode4=1, mode5=0, val9=1000000, val10=1000000, mode6=0, mode7=0):
    """State 0"""
    while True:
        """State 4"""
        call = t200320_x25(actionbutton1=actionbutton1, flag5=flag5, flag6=flag6, val6=val6, val7=val7,
...
def t200320_x17():
    """State 0,1"""
    assert t200320_x19(z1=1101, mode9=0, mode10=0, mode11=0, mode12=0)
    """State 2"""
    return 0
...
def t200320_x18(mode3=1, mode5=0):
    ...
    if f116(10000) == 1:
        ...
        assert t200320_x19(z1=1000, mode9=0, mode10=0, mode11=0, mode12=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t200320_x19(z1=_, mode9=0, mode10=0, mode11=0, mode12=0):
    """State 0,4"""
    if f118(z1) == 1:
        """State 2"""
...
def t200320_x20():
    """State 0,1"""
    call = t200320_x19(z1=1103, mode9=0, mode10=0, mode11=0, mode12=0)
    if call.Get() == 1:
        """State 2"""
        assert t200320_x1()
    elif call.Get() == 0:
...
def t200320_x21():
    """State 0,2"""
    call = t200320_x19(z1=1102, mode9=0, mode10=0, mode11=0, mode12=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t200320_x22():
    """State 0,1"""
    assert t200320_x19(z1=1001, mode9=0, mode10=0, mode11=0, mode12=0)
    """State 2"""
    return 0
...
def t200320_x24():
    """State 0,1"""
    assert t200320_x19(z1=1100, mode9=0, mode10=0, mode11=0, mode12=0)
    """State 2"""
    return 0

def t200320_x25(actionbutton1=7003200, flag5=6000, flag6=6001, val6=1000000, val7=1000000, val8=1000000,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t200320_x19(z1=2000, mode9=0, mode10=0, mode11=0, mode12=0)
    if call.Get() == 1:
        """State 2"""
        assert (t200320_x0(actionbutton1=actionbutton1, flag6=flag6, flag10=6000, flag11=6000, flag12=6000,
...
def t200320_x26(text3=32030000, flag16=72000055, text4=32030100, flag17=72000056, text5=32030200, flag18=72000057,
    ...
    if not text3 == -1 and not GetEventStatus(flag16):
        """State 3"""
        assert t200320_x3(text3=text3, flag16=flag16, flag21=1, mode15=1)
    elif not text4 == -1 and not GetEventStatus(flag17):
        """State 4"""
        assert t200320_x3(text3=text4, flag16=flag17, flag21=1, mode15=1)
    elif not text5 == -1 and not GetEventStatus(flag18):
        """State 5"""
        assert t200320_x3(text3=text5, flag16=flag18, flag21=1, mode15=1)
    else:
        """State 2"""
        ...
        """State 6"""
        assert t200320_x5(text1=text6, flag19=1, mode13=1)
    """State 7"""
    return 0
...
def t200320_x28():
    """State 0,1"""
    assert t200320_x19(z1=1002, mode9=0, mode10=0, mode11=0, mode12=0)
    """State 2"""
    return 0

def t200320_x29(text1=32010000, text2=32010050, lot1=63200, flag14=72000050, flag15=72000051, mode8=_):
    """State 0,3"""
    if not mode8:
        """State 4,8"""
        assert t200320_x5(text1=text1, flag19=0, mode13=1)
        """State 2"""
        ...
        if GetEventStatus(flag14) == 1 and not GetEventStatus(flag15):
            ...
            return 1
    """State 1,9"""
    assert t200320_x4(text2=text2, flag15=flag15, flag20=0, mode14=1)
    """State 11"""
    return 0

def t200320_x30(actionbutton1=7003200, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
...
def t200320_x31(mode1=_):
    ...
    if not mode1:
        ...
        if not GetEventStatus(72000052):
            ...
            assert t200320_x5(text1=32000200, flag19=0, mode13=1)
        else:
            """State 19,25"""
            # talk:32000350:"Is there...something else?"
            assert t200320_x5(text1=32000350, flag19=0, mode13=1)
        """State 1"""
        ClearTalkListData()
        MainBonfireMenuFlag()
        """State 2"""
        ...
        if GetTalkListEntryResult() == 1:
            ...
            if not GetEventStatus(72000052):
                """State 16,23"""
                # talk:32010100:"........."
                assert t200320_x5(text1=32010100, flag19=0, mode13=1)
                Goto('L1')
            else:
                """State 17,24"""
                # talk:32010100:"........."
