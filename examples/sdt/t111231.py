...
def t111231_x0():
    ...
    while True:
        ...
        if not GetEventStatus(71100425):
            ...
            assert t111231_x6(text2=23060300, z2=71100425, flag15=1, mode12=1)
        elif not GetEventStatus(71100426) and GetSelfHP() < 50:
            """State 3,5"""
            # talk:23060400:"Not... yet..."
            assert t111231_x6(text2=23060400, z2=71100426, flag15=1, mode12=1)
    """Unused"""
    """State 6"""
    return 0
...
def t111231_x1():
    ...
    assert t111231_x7(text1=23060600, flag14=1, mode11=1)
    """State 4"""
    return 0
...
def t111231_x2():
    ...
    assert t111231_x7(text1=23060500, flag14=1, mode11=1)
    """State 2"""
    return 0

def t111231_x3(actionbutton1=7002301, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
               actionbutton2=0, flag5=6000, val6=1000000, val7=1000000, val8=1000000, val9=1000000, val10=1000000):
    """State 0"""
    while Loop('mainloop'):
        """State 3"""
        call = t111231_x29(actionbutton1=actionbutton1, flag6=flag6, flag10=flag10, flag11=flag11, flag12=flag12,
...
def t111231_x6(text2=_, z2=_, flag15=1, mode12=1):
    """State 0,7"""
...
def t111231_x7(text1=_, flag14=1, mode11=1):
    """State 0,6"""
    assert t111231_x5() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 4"""
    if not flag14:
...
def t111231_x8(flag1=1279, flag2=11115901, flag3=6000, val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001,
    ...
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t111231_x9(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, flag4=flag4, actionbutton1=actionbutton1,
...
def t111231_x9(val1=5, val2=10, val3=12, val4=10, val5=12, flag4=6001, actionbutton1=7002301, flag5=6000,
    ...
    while True:
        """State 4"""
        call = t111231_x26(actionbutton1=actionbutton1, flag5=flag5, flag6=flag6, val6=val6, val7=val7,
...
def t111231_x18():
    """State 0,1"""
    assert t111231_x20(z1=1101, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t111231_x19(mode2=1, mode4=0):
    ...
    if f116(10000) == 1:
        ...
        assert t111231_x20(z1=1000, mode7=0, mode8=0, mode9=0, mode10=0)
    elif GetCurrentStateElapsedTime() > 5:
        pass
    """State 5"""
    return 0

def t111231_x20(z1=_, mode7=0, mode8=0, mode9=0, mode10=0):
    """State 0,4"""
    if f118(z1) == 1:
        """State 2"""
...
def t111231_x21():
    """State 0,1"""
    call = t111231_x20(z1=1103, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert t111231_x4()
    elif call.Get() == 0:
...
def t111231_x22():
    """State 0,2"""
    call = t111231_x20(z1=1102, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t111231_x23():
    """State 0,1"""
    assert t111231_x20(z1=1001, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0
...
def t111231_x25():
    """State 0,1"""
    assert t111231_x20(z1=1100, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t111231_x26(actionbutton1=7002301, flag5=6000, flag6=6001, val6=1000000, val7=1000000, val8=1000000,
                val9=1000000, val10=1000000):
    """State 0,1"""
    call = t111231_x20(z1=2000, mode7=0, mode8=0, mode9=0, mode10=0)
    if call.Get() == 1:
        """State 2"""
        assert (t111231_x3(actionbutton1=actionbutton1, flag6=flag6, flag10=6000, flag11=6000, flag12=6000,
...
def t111231_x28():
    """State 0,1"""
    assert t111231_x20(z1=1002, mode7=0, mode8=0, mode9=0, mode10=0)
    """State 2"""
    return 0

def t111231_x29(actionbutton1=7002301, flag6=6001, flag10=6000, flag11=6000, flag12=6000, flag13=6000,
